...
tags: [authentication, gitlab, dotnet-core-blazor-webassembly, c#, social-sign-in, sign-in, login]
title: How to build GitLab sign-in with .NET Core (Blazor WebAssembly)
