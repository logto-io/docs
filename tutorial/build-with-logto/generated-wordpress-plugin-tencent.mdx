---
slug: how-to-build-tencent-sign-in-with-wordpress-plugin-and-logto
tags: [authentication, tencent, wordpress-plugin, php, passwordless-sign-in, sign-in, login]
title: How to build Tencent SMS passwordless sign-in with WordPress plugin
