...
tags: [authentication, aliyun-direct-mail, php, php, passwordless-sign-in, sign-in, login]
title: How to build Aliyun Direct Mail Email passwordless sign-in with PHP
sdk: PHP
