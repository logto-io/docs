---
slug: how-to-build-microsoft-sign-in-with-java-spring-boot-and-logto
tags: [authentication, microsoft, java-spring-boot, java, social-sign-in, sign-in, login]
title: How to build Microsoft sign-in with Java Spring Boot
