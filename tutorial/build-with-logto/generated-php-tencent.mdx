---
slug: how-to-build-tencent-sign-in-with-php-and-logto
tags: [authentication, tencent, php, php, passwordless-sign-in, sign-in, login]
title: How to build Tencent SMS passwordless sign-in with PHP
sdk: PHP
connector: Tencent
---
