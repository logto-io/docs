---
slug: how-to-build-microsoft-sign-in-with-next-app-router-and-logto
tags: [authentication, microsoft, next-app-router, js, social-sign-in, sign-in, login]
title: How to build Microsoft sign-in with Next.js (App Router)
...
## Add Microsoft connector \{#add-connector-connector}

<AddSocialConnector connector={connector} framework="Next.js (App Router)" />

## Set up Microsoft \{#set-up-connectorconfigname}
...
## Enable Microsoft connector in Sign-in Experience \{#enable-connector-connector-in-sign-in-experience}
