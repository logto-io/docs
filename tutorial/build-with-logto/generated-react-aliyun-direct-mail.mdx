...
tags: [authentication, aliyun-direct-mail, react, js, passwordless-sign-in, sign-in, login]
title: How to build Aliyun Direct Mail Email passwordless sign-in with React
sdk: React
...
import FrameworkGuide from '@site/docs/quick-starts/framework/react/_for-tutorial.mdx';
...
## Integrate React with Logto \{#integrate-with-logto}
