...
tags: [authentication, alipay-web, dotnet-core-blazor-server, c#, social-sign-in, sign-in, login]
title: How to build Alipay (Web) sign-in with .NET Core (Blazor Server)
