---
slug: how-to-build-aliyun-sign-in-with-android-and-logto
tags: [authentication, aliyun, android, kotlin/java, passwordless-sign-in, sign-in, login]
title: How to build Aliyun SMS passwordless sign-in with Android (Kotlin / Java)
