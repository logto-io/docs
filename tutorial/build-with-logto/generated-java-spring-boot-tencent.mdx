---
slug: how-to-build-tencent-sign-in-with-java-spring-boot-and-logto
tags: [authentication, tencent, java-spring-boot, java, passwordless-sign-in, sign-in, login]
title: How to build Tencent SMS passwordless sign-in with Java Spring Boot
