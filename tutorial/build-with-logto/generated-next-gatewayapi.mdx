---
slug: how-to-build-gatewayapi-sign-in-with-next-and-logto
tags: [authentication, gatewayapi, next, js, passwordless-sign-in, sign-in, login]
title: How to build GatewayAPI SMS passwordless sign-in with Next.js (Pages Router)
