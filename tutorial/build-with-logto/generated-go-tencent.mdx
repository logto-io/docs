---
slug: how-to-build-tencent-sign-in-with-go-and-logto
tags: [authentication, tencent, go, go, passwordless-sign-in, sign-in, login]
title: How to build Tencent SMS passwordless sign-in with Go
sdk: Go
connector: Tencent
---
