---
slug: how-to-build-aliyun-sign-in-with-dotnet-core-blazor-server-and-logto
tags: [authentication, aliyun, dotnet-core-blazor-server, c#, passwordless-sign-in, sign-in, login]
title: How to build Aliyun SMS passwordless sign-in with .NET Core (Blazor Server)
