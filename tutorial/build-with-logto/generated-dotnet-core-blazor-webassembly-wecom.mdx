...
tags: [authentication, wecom, dotnet-core-blazor-webassembly, c#, social-sign-in, sign-in, login]
title: How to build WeCom sign-in with .NET Core (Blazor WebAssembly)
