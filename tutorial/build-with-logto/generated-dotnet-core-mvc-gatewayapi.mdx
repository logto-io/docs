---
slug: how-to-build-gatewayapi-sign-in-with-dotnet-core-mvc-and-logto
tags: [authentication, gatewayapi, dotnet-core-mvc, c#, passwordless-sign-in, sign-in, login]
title: How to build GatewayAPI SMS passwordless sign-in with .NET Core (MVC)
sdk: .NET Core (MVC)
