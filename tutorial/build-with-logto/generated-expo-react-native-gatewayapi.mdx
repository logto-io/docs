---
slug: how-to-build-gatewayapi-sign-in-with-expo-react-native-and-logto
tags: [authentication, gatewayapi, expo-react-native, js, passwordless-sign-in, sign-in, login]
title: How to build GatewayAPI SMS passwordless sign-in with Expo (React Native)
