...
tags: [authentication, xiaomi, dotnet-core-blazor-webassembly, c#, social-sign-in, sign-in, login]
title: How to build Xiaomi sign-in with .NET Core (Blazor WebAssembly)
