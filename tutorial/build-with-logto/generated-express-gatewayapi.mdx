---
slug: how-to-build-gatewayapi-sign-in-with-express-and-logto
tags: [authentication, gatewayapi, express, js, passwordless-sign-in, sign-in, login]
title: How to build GatewayAPI SMS passwordless sign-in with Express
sdk: Express
