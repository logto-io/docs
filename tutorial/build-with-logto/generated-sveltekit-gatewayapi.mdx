---
slug: how-to-build-gatewayapi-sign-in-with-sveltekit-and-logto
tags: [authentication, gatewayapi, sveltekit, js, passwordless-sign-in, sign-in, login]
title: How to build GatewayAPI SMS passwordless sign-in with SvelteKit
sdk: SvelteKit
