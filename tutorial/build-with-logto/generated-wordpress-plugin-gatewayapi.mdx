---
slug: how-to-build-gatewayapi-sign-in-with-wordpress-plugin-and-logto
tags: [authentication, gatewayapi, wordpress-plugin, php, passwordless-sign-in, sign-in, login]
title: How to build GatewayAPI SMS passwordless sign-in with WordPress plugin
