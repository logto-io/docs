---
slug: how-to-build-gatewayapi-sign-in-with-php-and-logto
tags: [authentication, gatewayapi, php, php, passwordless-sign-in, sign-in, login]
title: How to build GatewayAPI SMS passwordless sign-in with PHP
sdk: PHP
