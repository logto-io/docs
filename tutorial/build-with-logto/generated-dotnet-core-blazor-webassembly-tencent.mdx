---
slug: how-to-build-tencent-sign-in-with-dotnet-core-blazor-webassembly-and-logto
tags: [authentication, tencent, dotnet-core-blazor-webassembly, c#, passwordless-sign-in, sign-in, login]
title: How to build Tencent SMS passwordless sign-in with .NET Core (Blazor WebAssembly)
