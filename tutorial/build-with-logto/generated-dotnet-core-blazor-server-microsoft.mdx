---
slug: how-to-build-microsoft-sign-in-with-dotnet-core-blazor-server-and-logto
tags: [authentication, microsoft, dotnet-core-blazor-server, c#, social-sign-in, sign-in, login]
title: How to build Microsoft sign-in with .NET Core (Blazor Server)
