---
slug: how-to-build-aliyun-sign-in-with-dotnet-core-mvc-and-logto
tags: [authentication, aliyun, dotnet-core-mvc, c#, passwordless-sign-in, sign-in, login]
title: How to build Aliyun SMS passwordless sign-in with .NET Core (MVC)
sdk: .NET Core (MVC)
connector: Aliyun
---
