---
slug: how-to-build-microsoft-sign-in-with-dotnet-core-mvc-and-logto
tags: [authentication, microsoft, dotnet-core-mvc, c#, social-sign-in, sign-in, login]
title: How to build Microsoft sign-in with .NET Core (MVC)
sdk: .NET Core (MVC)
connector: Microsoft
---
