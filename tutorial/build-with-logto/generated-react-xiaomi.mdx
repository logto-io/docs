...
tags: [authentication, xiaomi, react, js, social-sign-in, sign-in, login]
title: How to build Xiaomi sign-in with React
sdk: React
connector: Xiaomi
---
...
## Add Xiaomi connector \{#add-connector-connector}

<AddSocialConnector connector={connector} framework="React" />

## Set up Xiaomi OAuth app \{#set-up-connectorconfigname}
...
## Enable Xiaomi connector in Sign-in Experience \{#enable-connector-connector-in-sign-in-experience}
