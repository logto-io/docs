---
slug: how-to-build-microsoft-sign-in-with-php-and-logto
tags: [authentication, microsoft, php, php, social-sign-in, sign-in, login]
title: How to build Microsoft sign-in with PHP
sdk: PHP
connector: Microsoft
---
