---
slug: how-to-build-microsoft-sign-in-with-next-and-logto
tags: [authentication, microsoft, next, js, social-sign-in, sign-in, login]
title: How to build Microsoft sign-in with Next.js (Pages Router)
