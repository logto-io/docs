---
slug: how-to-build-vonage-sign-in-with-wordpress-plugin-and-logto
tags: [authentication, vonage, wordpress-plugin, php, passwordless-sign-in, sign-in, login]
title: How to build Vonage SMS passwordless sign-in with WordPress plugin
