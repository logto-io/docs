---
slug: how-to-build-gatewayapi-sign-in-with-dotnet-core-blazor-server-and-logto
tags: [authentication, gatewayapi, dotnet-core-blazor-server, c#, passwordless-sign-in, sign-in, login]
title: How to build GatewayAPI SMS passwordless sign-in with .NET Core (Blazor Server)
