---
slug: how-to-build-vonage-sign-in-with-expo-react-native-and-logto
tags: [authentication, vonage, expo-react-native, js, passwordless-sign-in, sign-in, login]
title: How to build Vonage SMS passwordless sign-in with Expo (React Native)
