---
slug: how-to-build-gatewayapi-sign-in-with-ios-swift-and-logto
tags: [authentication, gatewayapi, ios-swift, swift, passwordless-sign-in, sign-in, login]
title: How to build GatewayAPI SMS passwordless sign-in with iOS (Swift)
sdk: iOS (Swift)
