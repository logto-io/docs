...
<p>Select "None" for the "Sign-up identifier" to provide minimum sign-up effort for {props.connector} sign-in, which may increase your conversion rate.</p>

<p>In the "Social sign-in" section, add "Add Social Connector" and choose "{props.connector}". Then you should be able to see a button with text "Continue with {props.connector}" in the preview section.</p>
