...
<p>In this article, we will go through the steps to quickly build the {props.connector} sign-in experience (user authentication) with <a href={props.link} target="_blank">{props.sdk}</a> and <a href="https://logto.io" target="_blank">Logto</a>.</p>

**Prerequisites**

- A running Logto instance. Check out the [get started page](/docs/tutorials/get-started/) if you don't have one.
- <span>Basic knowledge of <a href={props.link} target="_blank">{props.sdk}</a>.</span>
