---
slug: how-to-build-aliyun-sign-in-with-next-and-logto
tags: [authentication, aliyun, next, js, passwordless-sign-in, sign-in, login]
title: How to build Aliyun SMS passwordless sign-in with Next.js (Pages Router)
