---
slug: how-to-build-aliyun-sign-in-with-java-spring-boot-and-logto
tags: [authentication, aliyun, java-spring-boot, java, passwordless-sign-in, sign-in, login]
title: How to build Aliyun SMS passwordless sign-in with Java Spring Boot
