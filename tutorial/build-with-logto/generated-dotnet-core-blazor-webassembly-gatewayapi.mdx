---
slug: how-to-build-gatewayapi-sign-in-with-dotnet-core-blazor-webassembly-and-logto
tags: [authentication, gatewayapi, dotnet-core-blazor-webassembly, c#, passwordless-sign-in, sign-in, login]
title: How to build GatewayAPI SMS passwordless sign-in with .NET Core (Blazor WebAssembly)
