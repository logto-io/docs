---
slug: how-to-build-microsoft-sign-in-with-ios-swift-and-logto
tags: [authentication, microsoft, ios-swift, swift, social-sign-in, sign-in, login]
title: How to build Microsoft sign-in with iOS (Swift)
sdk: iOS (Swift)
connector: Microsoft
---
