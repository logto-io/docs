...
tags: [authentication, wechat-native, dotnet-core-blazor-webassembly, c#, social-sign-in, sign-in, login]
title: How to build WeChat (Native) sign-in with .NET Core (Blazor WebAssembly)
