---
slug: how-to-build-gatewayapi-sign-in-with-vanilla-js-and-logto
tags: [authentication, gatewayapi, vanilla-js, js, passwordless-sign-in, sign-in, login]
title: How to build GatewayAPI SMS passwordless sign-in with Vanilla JS
sdk: Vanilla JS
