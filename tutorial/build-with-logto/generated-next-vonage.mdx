---
slug: how-to-build-vonage-sign-in-with-next-and-logto
tags: [authentication, vonage, next, js, passwordless-sign-in, sign-in, login]
title: How to build Vonage SMS passwordless sign-in with Next.js (Pages Router)
