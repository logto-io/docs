---
slug: how-to-build-tencent-sign-in-with-next-and-logto
tags: [authentication, tencent, next, js, passwordless-sign-in, sign-in, login]
title: How to build Tencent SMS passwordless sign-in with Next.js (Pages Router)
