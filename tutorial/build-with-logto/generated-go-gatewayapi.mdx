---
slug: how-to-build-gatewayapi-sign-in-with-go-and-logto
tags: [authentication, gatewayapi, go, go, passwordless-sign-in, sign-in, login]
title: How to build GatewayAPI SMS passwordless sign-in with Go
sdk: Go
