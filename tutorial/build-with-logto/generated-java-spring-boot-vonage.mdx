---
slug: how-to-build-vonage-sign-in-with-java-spring-boot-and-logto
tags: [authentication, vonage, java-spring-boot, java, passwordless-sign-in, sign-in, login]
title: How to build Vonage SMS passwordless sign-in with Java Spring Boot
