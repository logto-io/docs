...
tags: [authentication, sms-aero, android, kotlin/java, passwordless-sign-in, sign-in, login]
title: How to build SMS Aero SMS passwordless sign-in with Android (Kotlin / Java)
