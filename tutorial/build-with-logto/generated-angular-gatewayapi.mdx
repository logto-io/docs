---
slug: how-to-build-gatewayapi-sign-in-with-angular-and-logto
tags: [authentication, gatewayapi, angular, js, passwordless-sign-in, sign-in, login]
title: How to build GatewayAPI SMS passwordless sign-in with Angular
sdk: Angular
