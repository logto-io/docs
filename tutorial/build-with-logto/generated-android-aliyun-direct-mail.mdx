...
tags: [authentication, aliyun-direct-mail, android, kotlin/java, passwordless-sign-in, sign-in, login]
title: How to build Aliyun Direct Mail Email passwordless sign-in with Android (Kotlin / Java)
