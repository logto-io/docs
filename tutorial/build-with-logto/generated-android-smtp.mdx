...
tags: [authentication, smtp, android, kotlin/java, passwordless-sign-in, sign-in, login]
title: How to build SMTP Email passwordless sign-in with Android (Kotlin / Java)
