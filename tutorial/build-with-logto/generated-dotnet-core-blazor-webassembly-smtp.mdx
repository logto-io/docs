...
tags: [authentication, smtp, dotnet-core-blazor-webassembly, c#, passwordless-sign-in, sign-in, login]
title: How to build SMTP Email passwordless sign-in with .NET Core (Blazor WebAssembly)
