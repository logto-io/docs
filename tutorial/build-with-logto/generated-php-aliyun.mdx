---
slug: how-to-build-aliyun-sign-in-with-php-and-logto
tags: [authentication, aliyun, php, php, passwordless-sign-in, sign-in, login]
title: How to build Aliyun SMS passwordless sign-in with PHP
sdk: PHP
connector: Aliyun
---
