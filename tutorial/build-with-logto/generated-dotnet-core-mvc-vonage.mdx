---
slug: how-to-build-vonage-sign-in-with-dotnet-core-mvc-and-logto
tags: [authentication, vonage, dotnet-core-mvc, c#, passwordless-sign-in, sign-in, login]
title: How to build Vonage SMS passwordless sign-in with .NET Core (MVC)
sdk: .NET Core (MVC)
connector: Vonage
---
