...
tags: [authentication, aliyun-direct-mail, go, go, passwordless-sign-in, sign-in, login]
title: How to build Aliyun Direct Mail Email passwordless sign-in with Go
sdk: Go
