---
slug: how-to-build-tencent-sign-in-with-expo-react-native-and-logto
tags: [authentication, tencent, expo-react-native, js, passwordless-sign-in, sign-in, login]
title: How to build Tencent SMS passwordless sign-in with Expo (React Native)
