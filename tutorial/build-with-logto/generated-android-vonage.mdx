---
slug: how-to-build-vonage-sign-in-with-android-and-logto
tags: [authentication, vonage, android, kotlin/java, passwordless-sign-in, sign-in, login]
title: How to build Vonage SMS passwordless sign-in with Android (Kotlin / Java)
