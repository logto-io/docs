---
slug: how-to-build-microsoft-sign-in-with-python-and-logto
tags: [authentication, microsoft, python, python, social-sign-in, sign-in, login]
title: How to build Microsoft sign-in with Python
sdk: Python
connector: Microsoft
---
