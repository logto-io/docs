---
slug: how-to-build-gatewayapi-sign-in-with-android-and-logto
tags: [authentication, gatewayapi, android, kotlin/java, passwordless-sign-in, sign-in, login]
title: How to build GatewayAPI SMS passwordless sign-in with Android (Kotlin / Java)
