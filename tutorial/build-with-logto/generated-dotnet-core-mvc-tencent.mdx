---
slug: how-to-build-tencent-sign-in-with-dotnet-core-mvc-and-logto
tags: [authentication, tencent, dotnet-core-mvc, c#, passwordless-sign-in, sign-in, login]
title: How to build Tencent SMS passwordless sign-in with .NET Core (MVC)
sdk: .NET Core (MVC)
connector: Tencent
---
