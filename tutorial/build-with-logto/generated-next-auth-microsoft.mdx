---
slug: how-to-build-microsoft-sign-in-with-next-auth-and-logto
tags: [authentication, microsoft, next-auth, js, social-sign-in, sign-in, login]
title: How to build Microsoft sign-in with Auth.js (Next Auth)
