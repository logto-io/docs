---
slug: how-to-build-microsoft-sign-in-with-go-and-logto
tags: [authentication, microsoft, go, go, social-sign-in, sign-in, login]
title: How to build Microsoft sign-in with Go
sdk: Go
connector: Microsoft
---
