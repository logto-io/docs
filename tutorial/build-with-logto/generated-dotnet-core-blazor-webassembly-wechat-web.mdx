...
tags: [authentication, wechat-web, dotnet-core-blazor-webassembly, c#, social-sign-in, sign-in, login]
title: How to build WeChat (Web) sign-in with .NET Core (Blazor WebAssembly)
