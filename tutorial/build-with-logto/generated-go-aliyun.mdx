---
slug: how-to-build-aliyun-sign-in-with-go-and-logto
tags: [authentication, aliyun, go, go, passwordless-sign-in, sign-in, login]
title: How to build Aliyun SMS passwordless sign-in with Go
sdk: Go
connector: Aliyun
---
