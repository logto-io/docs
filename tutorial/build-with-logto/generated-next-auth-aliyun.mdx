---
slug: how-to-build-aliyun-sign-in-with-next-auth-and-logto
tags: [authentication, aliyun, next-auth, js, passwordless-sign-in, sign-in, login]
title: How to build Aliyun SMS passwordless sign-in with Auth.js (Next Auth)
