---
slug: how-to-build-microsoft-sign-in-with-wordpress-plugin-and-logto
tags: [authentication, microsoft, wordpress-plugin, php, social-sign-in, sign-in, login]
title: How to build Microsoft sign-in with WordPress plugin
