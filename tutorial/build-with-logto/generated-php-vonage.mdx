---
slug: how-to-build-vonage-sign-in-with-php-and-logto
tags: [authentication, vonage, php, php, passwordless-sign-in, sign-in, login]
title: How to build Vonage SMS passwordless sign-in with PHP
sdk: PHP
connector: Vonage
---
