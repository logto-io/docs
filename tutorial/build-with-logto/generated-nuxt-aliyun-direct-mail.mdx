...
tags: [authentication, aliyun-direct-mail, nuxt, js, passwordless-sign-in, sign-in, login]
title: How to build Aliyun Direct Mail Email passwordless sign-in with Nuxt
sdk: Nuxt
...
import FrameworkGuide from '@site/docs/quick-starts/framework/nuxt/_for-tutorial.mdx';
...
<CreateApplication type="Traditional web" framework="Nuxt" />

## Integrate Nuxt with Logto \{#integrate-with-logto}
