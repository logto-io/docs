...
tags: [authentication, smtp, dotnet-core-razor-pages, c#, passwordless-sign-in, sign-in, login]
title: How to build SMTP Email passwordless sign-in with .NET Core (Razor Pages)
