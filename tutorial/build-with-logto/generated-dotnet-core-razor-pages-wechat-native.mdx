...
tags: [authentication, wechat-native, dotnet-core-razor-pages, c#, social-sign-in, sign-in, login]
title: How to build WeChat (Native) sign-in with .NET Core (Razor Pages)
