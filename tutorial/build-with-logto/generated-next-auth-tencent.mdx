---
slug: how-to-build-tencent-sign-in-with-next-auth-and-logto
tags: [authentication, tencent, next-auth, js, passwordless-sign-in, sign-in, login]
title: How to build Tencent SMS passwordless sign-in with Auth.js (Next Auth)
