---
slug: how-to-build-vonage-sign-in-with-dotnet-core-blazor-server-and-logto
tags: [authentication, vonage, dotnet-core-blazor-server, c#, passwordless-sign-in, sign-in, login]
title: How to build Vonage SMS passwordless sign-in with .NET Core (Blazor Server)
