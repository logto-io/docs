...
tags: [authentication, kook, react, js, social-sign-in, sign-in, login]
title: How to build KOOK sign-in with React
sdk: React
connector: KOOK
---
...
## Add KOOK connector \{#add-connector-connector}

<AddSocialConnector connector={connector} framework="React" />

## Set up KOOK OAuth app \{#set-up-connectorconfigname}
...
## Enable KOOK connector in Sign-in Experience \{#enable-connector-connector-in-sign-in-experience}
