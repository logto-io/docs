---
slug: how-to-build-vonage-sign-in-with-next-auth-and-logto
tags: [authentication, vonage, next-auth, js, passwordless-sign-in, sign-in, login]
title: How to build Vonage SMS passwordless sign-in with Auth.js (Next Auth)
