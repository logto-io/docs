...
import AddSdk from '../../docs/sdk/vanilla-js/_add_sdk.mdx';
import HandleRedirect from '../../docs/sdk/vanilla-js/_handle_redirect.mdx';
import ImplementSignIn from '../../docs/sdk/vanilla-js/_implement_sign_in.mdx';
import InitClient from '../../docs/sdk/vanilla-js/_init_client.mdx';
