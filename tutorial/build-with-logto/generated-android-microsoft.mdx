---
slug: how-to-build-microsoft-sign-in-with-android-and-logto
tags: [authentication, microsoft, android, kotlin/java, social-sign-in, sign-in, login]
title: How to build Microsoft sign-in with Android (Kotlin / Java)
