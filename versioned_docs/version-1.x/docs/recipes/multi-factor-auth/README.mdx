...
Learn more about the usage and user flow for each verification factor, including [Authenticator app OTP](./authenticator-app-otp), [WebAuthn (Passkeys)](./webauthn), and [Backup codess](./backup-code) in our dedicated resources.
