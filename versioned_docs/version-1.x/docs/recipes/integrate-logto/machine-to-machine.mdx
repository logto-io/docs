...
This recipe assumes you have already created a machine-to-machine app in Logto. If not, see [Create and integrate the first application](../../tutorials/get-started/create-and-integrate-the-first-app.mdx) for details.
...
If you want to use this app for accessing [Management API](/docs/references/core/#management-api), remember to create a role with the Management API access and assign the role to the app. See [Manage permissions and roles](../rbac/manage-permissions-and-roles.md) to learn more.
