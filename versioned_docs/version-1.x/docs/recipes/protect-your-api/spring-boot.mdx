...
If you prefer to use `RSA`, feel free to rotate the signing algorithm in the Logto Admin Console. Please refer to [Signing keys](/docs/recipes/signing-keys-rotation) for more details.
:::
