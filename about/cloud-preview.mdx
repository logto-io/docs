...
These limitations may not apply to the production version of Logto Cloud. Please stay tuned by [joining our Discord server](https://discord.com/invite/UEPaF3j5e6) or [subscribing to our newsletter](https://logto.io/subscribe).
