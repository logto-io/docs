...
If you want to create a sperate tenant for **Production** (Prod) env or a new project, click your current tenant name in the top-left corner of the top bar. In this menu, you can switch between tenants or create a new one.
