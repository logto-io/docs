...
Dev tenant limits are **hard limits**, sized for development workloads. If you need a production-like environment, you can [convert the tenant to Pro](/logto-cloud/tenant-settings#tenant-types-dev-vs-prod).
