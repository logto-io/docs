...
| **Category**              | **Feature**                 | Pro        |
| ------------------------- | --------------------------- | ---------- |
| **Basics**                | Tokens (only access tokens) | 10M tokens |
| **Applications**          | Total applications          | 100        |
|                           | Machine-to-machine apps     | 100        |
|                           | OIDC/OAuth 3rd party apps   | 100        |
|                           | SAML apps                   | 100        |
|                           | API resources               | 1000       |
|                           | Permission per resource     | 1000       |
| **User Authentication**   | Social connectors           | 100        |
|                           | Enterprise SSO (add-on)     | 100        |
| **User Management**       | User roles                  | 1,000      |
|                           | M2M roles                   | 100        |
| **Organizations**         | Organization count          | 100k       |
|                           | Users per organization      | 100k       |
|                           | Organization roles          | 1000       |
|                           | Organization m2m roles      | 100        |
|                           | Organization permissions    | 1000       |
| **Developers & Platform** | Webhooks                    | 10         |
|                           | Audit log retention         | 14 days    |
|                           | Custom domains              | 10         |
|                           | Tenant members              | 100        |
