...
| logto-signature-sha-256 |              | the signature of the request body, refer to [Securing your webhooks](https://docs.logto.io/docs/recipes/webhooks/securing-your-webhooks/). |

You can overwrite customizable headers by [customizing request](https://docs.logto.io/docs/recipes/webhooks/configure-webhooks-in-console/#secure-webhook) headers with the same key.
...
See [Users](https://docs.logto.io/docs/references/users/) and [Applications](https://docs.logto.io/docs/references/applications/) reference for detailed field explanations.
