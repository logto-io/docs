...
| logto-signature-sha-256 |              | the signature of the request body, refer to [securing your webhooks](/developer/webhooks/secure-webhooks). |

You can overwrite customizable headers by [customizing request](/developer/webhooks/configure-webhooks/#secure-webhook) headers with the same key.
...
See [Users](/user-management/user-data) and [Applications](/concepts/application-data-structure) reference for detailed field explanations.
