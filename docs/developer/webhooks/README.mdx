...
See <Url type="inline" href="/authorization/role-based-access-control/protect-api-resources-with-rbac/#optional-handle-user-permission-change">Manage user permission change</Url> guide.
