...
You'll need to get the signing key from [the Admin Console](https://docs.logto.io/docs/recipes/webhooks/configure-webhooks-in-console/#secure-webhook) to verify the signature.
