...
<img src={azureAdDefaultAttributeMappingImage} alt="Azure AD default attribute mapping" />
...
<img src={azureAdLogtoAttributeMappingImage} alt="Azure AD_Logto attribute mapping" />
