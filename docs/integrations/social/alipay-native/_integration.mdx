...
We assume you have integrated <MainSiteUrl href="/quick-starts/swift">Logto iOS SDK</MainSiteUrl> in your app. In this case, things are pretty simple, and you don't even need to read the Alipay SDK doc:
...
We assume you have integrated <MainSiteUrl href="/quick-starts/android">Logto Android SDK</MainSiteUrl> in your app. In this case, things are pretty simple, and you don't even need to read the Alipay SDK doc:
