...
You can also [take the app live](https://developers.facebook.com/docs/development/build-and-test/app-modes#live-mode) directly so that any Facebook user can sign in with the app.
