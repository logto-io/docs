...
If you don't know the concept of the connector or don't know how to add this connector to your Sign-in & account > Sign-up and sign-in, please see [Logto tutorial](/connectors/social-connectors).
...
That's it. The Apple connector should be available in both web and native apps. Don't forget to [Enable social connector in Sign-up and sign-in](/connectors/social-connectors/#enable-social-sign-in).
