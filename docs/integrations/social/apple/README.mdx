...
That's it. The Apple connector should be available in both web and native apps. Don't forget to <MainSiteUrl href="/connectors/social-connectors#enable-social-sign-in">Enable social connector in sign-in experience</MainSiteUrl>.
