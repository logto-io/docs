...
That's it. The KOOK connector should be available now. Don't forget to [Enable connector in Sign-up and sign-in](https://docs.logto.io/docs/recipes/configure-connectors/social-connector/enable-social-sign-in/).
