...
Unlike OAuth Apps where you configure scopes in the Logto connector, GitHub App permissions are managed entirely in the GitHub dashboard. You can leave the `Scope` field empty in your Logto GitHub App connector — it's not needed because GitHub Apps don't use traditional OAuth scopes.
...
## Step 4: General settings \{#step-5-general-settings}
...
## Step 5: Test your integration (Optional) \{#step-6-test-your-integration-optional}
