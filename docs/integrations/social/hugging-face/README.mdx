...
That's it. The Hugging Face connector should be available now. Don't forget to <MainSiteUrl href="/connectors/social-connectors#enable-social-sign-in">Enable social connector in sign-in experience</MainSiteUrl>.
