...
That's it. Don't forget to <MainSiteUrl href="/connectors/sms-connectors/#enable-phone-number-for-end-user-flows">Enable connector in Sign-up and sign-in</MainSiteUrl>.
