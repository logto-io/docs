...
That's it. Don't forget to <MainSiteUrl href="/connectors/email-connectors/#enable-email-address-for-end-user-flows">Enable connector in Sign-up and sign-in</MainSiteUrl>.
