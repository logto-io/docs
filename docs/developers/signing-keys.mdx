...
1. Navigate to <CloudLink to="/tenant-settings/oidc-configs">Console > OIDC configs</CloudLink>. From there, you can manage both OIDC private keys and OIDC cookie keys.
