...
<img src={auditLogSuccessDetailsPageImage} alt="Audit log success details page" />
...
<img src={auditLogsRelatedToSpecificUserImage} alt="Audit logs related to specific user" />
...
### I'm using self-hosted Logto and it takes seconds to get the audit logs, how can I improve the performance? \{#im-using-self-hosted-logto-and-it-takes-seconds-to-get-the-audit-logs-how-can-i-improve-the-performance}
