...
- Type of event (full list of audit log events can be found [here](/developers/audit-logs/README/event-types))
...
<img src="/img/assets/audit-log-success-details-page.png" alt="Audit log success details page" />
...
<img
  ...
  alt="Audit logs related to specific user"
/>
