...
- [Design strategy](/developers/sdk-conventions/design-strategy)
- [Core SDK convention](/developers/sdk-conventions/core-sdk-convention)
- [Platform SDK convention](/developers/sdk-conventions/platform-sdk-convention)
