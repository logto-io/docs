...
| Organization.Membership.Updated | Users or applications are added to or removed from an organization. Payload includes [membership delta fields](/developers/webhooks/request#organizationmembershipupdated-payload). |
