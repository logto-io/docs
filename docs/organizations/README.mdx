...
<DocCardList
  items={[
    {
      type: 'link',
      label: 'Organization end-user experience',
      href: '/introduction/plan-your-architecture',
      description:
    ...
    },
    {
      ...
      href: '/authorization/org-template',
      description:
        'Organization level access control. This guide helps you leverage organizations to design access control in your multi-tenant app.',
      customProps: {
    ...
    },
    {
      ...
      description:
        'This guide shows you how to quickly manage and set up organizations using the Logto console and Management API.',
      customProps: {
        icon: <GearIcon />,
      },
    },
    {
      ...
      href: './just-in-time-provisioning',
      description:
