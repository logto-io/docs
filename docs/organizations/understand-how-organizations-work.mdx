...
Organization templates is designed for access control needs in multi-tenant apps. It includes organization roles and organization permissions. Check out this [organization template](/authorization/org-template) to learn more about the access control design in organization.
