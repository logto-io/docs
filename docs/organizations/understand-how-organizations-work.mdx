...
To get a comprehensive view of understanding, it's important to understand the entities involved in organization features and these are the fundamentals to integrate organizations into your app.
...
Organization templates is designed for access control needs in multi-tenant apps. It includes organization roles and organization permissions. Check out this [section](/authorization/organization-template) to learn more about the access control design in organization.

The following guides provide step-by-step instructions to integrate organizations into your app and tell you how to create a complete self-serve experience at the organization level.
