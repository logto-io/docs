...
In the <CloudLink to="/user-management"> User management </CloudLink> -> user details page, you can see which organizations the user belongs to and what organization roles they have.
...
In the <CloudLink to="/applications"> Applications </CloudLink> -> application details page, you can see which organizations the application associates with and what organization roles it has.
