...
_isStandard_ is an OPTIONAL boolean attribute to identify whether the social connector is a "standard" connector.
...
_id_ is an randomly generated string-typed key to identify connector in DB.
