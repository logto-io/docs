...
| OIDC_PRIVATE_KEYS      | N/A                        | <code>string &#124; undefined</code> | The comma-separated string list of the private key content in base64 format for [OIDC JWT signing](https://openid.net/specs/openid-connect-core-1_0.html#Signing).                                                                        |
