...
<head>
  <link rel="canonical" href="https://docs.logto.io/logto-oss/using-cli/rotate-signing-keys/" />
</head>
...
:::info
If you're using Logto Cloud, you can rotate signing keys in the Console UI, please refer to [this tutorial](/docs/docs/references/openid-connect/signing-keys-rotation/README.mdx#rotate-signing-keys-from-console-ui).
:::
