...
Here is a list of the flows and UI elements we supported up to our Sign-in Experience 2.0. Based on those elements, you can use Logto straight out of the box or modify it to suit your own company requirements.

![Sign-in Experience 2.0 Flows](./assets/sie_methods.png)

Join forces with the Admin Console to set up an end-to-end sign-in experience for your customers.

![Sign-in Experience 2.0 dashboard](./assets/sie_screen_shot.png)

## Sign-up method

### Sign-up identifier

The sign-up identification is the handle used to identify who you are and what information is required to register for the product. It is required information for account creation and must be included in the sign-in process. We offer four types of identifiers in Sign-in Experience V2,
