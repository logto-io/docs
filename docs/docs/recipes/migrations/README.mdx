...
<head>
  <link rel="canonical" href="https://docs.logto.io/user-management/user-migration/" />
</head>
...
You'll need to setup a tenant in Logto. You can use either Logto Cloud or Logto OSS. If you haven't done this yet, please refer to the [Get started](../../get-started/) guide.
