...
<head>
  <link
    rel="canonical"
    href="https://docs.logto.io/end-user-flows/account-settings/by-account-api/"
  />
</head>

# 👤 Interact with Account API
...
To learn more about the APIs that are available, please visit [Logto Account API Reference](https://openapi.logto.io/operation/operation-getprofile) and [Logto Verification API Reference](https://openapi.logto.io/operation/operation-createverificationbypassword).

## How to enable Acount API

By default, the Account API is disabled. To enable it, you need to use the [Management API](../interact-with-management-api/README.md) to update the global settings.
...
:::note
To use this method, you need to [configure the email connector](../configure-connectors/email-connector/configure-popular-email-service.md) or [SMS connector](../configure-connectors/sms-connector/configure-sms-connector.md), and make sure the `UserPermissionValidation` template is configured.
:::
...
:::note
To use this method, you need to [configure the email connector](../configure-connectors/email-connector/configure-popular-email-service.md), and make sure the `BindNewIdentifier` template is configured.
:::
...
:::note
To use this method, you need to [configure the SMS connector](../configure-connectors/sms-connector/configure-sms-connector.md), and make sure the `BindNewIdentifier` template is configured.
:::
...
- `connectorId`: The ID of the [social connector](../configure-connectors).
