...
Let's switch to the Application details page of Admin Console in this section. Add a Redirect URI `logto://callback` and click "Save Changes".

<img alt="Redirect URI in Admin Console" src={redirectUriFigure} width="50%" />
