...
The implementation in Java varies depending on the framework you are using.
The following Java code snippets are based on [Servlet](https://docs.oracle.com/javaee/5/tutorial/doc/bnafe.html).
If you use Spring framework, please refer to [Protect your API on Spring Boot](../spring-boot.mdx) since Spring Security has better built-in support.
