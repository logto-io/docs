...
For python developers, there is a handy library [authlib](https://github.com/lepture/authlib) that can easily helps you to validate the breaer token issued by Logto.
...
# We will get back to this validator customization on the following validation section
