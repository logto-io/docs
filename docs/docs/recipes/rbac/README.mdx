...
If no API Resource is provided, permission will be treated as for OIDC. Usually this is not what you want.
...
<img width="600" src={roleOrderAdmin} alt="Role order_admin" />
