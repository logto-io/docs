...
<head>
  <link
    rel="canonical"
    href="https://docs.logto.io/logto-oss/develop-your-connector/implement-connectors/"
  />
</head>
...
If you want to add connectors that have already been published to NPM or Logto official connectors, you may check out [Using Logto CLI - Manage connectors](../../../references/using-cli/manage-connectors.mdx#add-connectors).
