...
2. Follow the guide [Machine-to-machine: Auth with Logto](../../../quick-start/generic/machine-to-machine/README.mdx) to fetch an Access Token for the API identifier `https://[your-tenant-id].logto.app/api` (indicates Management API) and scope `all` (all permissions).
