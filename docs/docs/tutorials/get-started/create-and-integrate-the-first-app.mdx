...
import createApplicationModal from './assets/create-application-modal.png';
...
<img src={createApplicationModal} alt="Create Application modal" width="600px" />
...
<Columns
  columns={[
    ...
    {
      title: 'Tranditional Web App',
      items: [{ key: 'Traditional Web', link: '/docs/recipes/integrate-logto/traditional' }],
    },
  ]}
/>
