...
- Also, you need to set `X-Forward-Proto` header to `https` in your server config. See [Trusting TLS offloading proxies](https://github.com/panva/node-oidc-provider/blob/main/docs/README.md#trusting-tls-offloading-proxies) for details.
