...
Prepend `https://gitpod.io/#` to the Logto repo URL (or <a href="https://gitpod.io/#https://github.com/logto-io/demo" target="_blank" rel="noopener">click here</a>) and access it. Wait a few moment, you'll see the message like:
