...
<summary>What is this again? Error: Invalid id token</summary>
...
There are some nuanced differences in creating an account to access the admin console between the Open-source and Cloud Preview versions.
