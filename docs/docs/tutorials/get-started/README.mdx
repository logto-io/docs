...
Prepend `https://gitpod.io/#` to the Logto repo URL (or click here) and access it. Wait a few moment, you'll see the message like:

<img src={gitpodRunning} alt="GitPod Running" width="600px" />

Press Cmd (or Ctrl) and click the link starts with `https://3001-...` to continue your Logto journey. Enjoy!
