...
import orgPermissionImage from '../assets/org-permissions.webp';
...
# Understand organization templates
...
<img src={orgPermissionImage} width="100%" alt="Organization Permissions" />
...
You can use both organization template and user/system-level RBAC in Logto, allowing a more robust approach to meet your specific business and product requirements. To understand RBAC, refer to this [section](../role-based-access-control/).
