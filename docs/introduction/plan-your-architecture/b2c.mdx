...
{/* TODO: @charles update links in the last column */}

| Users                  | Goal                                                                                        | Logto product and API                                                                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Developers**         | Manage and safeguard the user identity system and work directly with the identity database. | [Logto console](https://cloud.logto.io)<br />[Logto management API](https://bump.sh/logto/doc/logto-management-api)                                                     |
| **End user/Consumers** | Manage their own authentication and personal information.                                   | [End-user experience](/end-user-flows)<br />[Logto management API](https://bump.sh/logto/doc/logto-management-api)<br />[Account API](https://openapi.logto.io/account) |
