...
| End user/Consumers | Manage their own authentication and personal information.                                   | <ul><li>[End-user experience](/end-user-flows)</li><li>[Logto Management API](https://openapi.logto.io/)</li><li>[Account API](https://openapi.logto.io/operation/operation-getaccountcentersettings)</li></ul> |
