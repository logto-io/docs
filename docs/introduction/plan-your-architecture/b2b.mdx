...
| ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Developers                   | Manage and safeguard the user identity pool and work directly with the identity database.                                                                                                                                                                                                                                                                                                                                                                                                            | <ul><li>[Logto Console](https://cloud.logto.io)</li><li>[Logto Management API](https://bump.sh/logto/doc/logto-management-api)</li></ul>                                                        |
...
| End user/Organization member | Manage their own system-level authentication and personal information.                                                                                                                                                                                                                                                                                                                                                                                                                               | <ul><li>[End-user experience](/end-user-flows)</li><li>[Logto Management API](https://bump.sh/logto/doc/logto-management-api)</li><li>[Account API](https://openapi.logto.io/account)</li></ul> |
