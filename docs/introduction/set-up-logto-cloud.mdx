...
Check out the tenant settings and [learn more](../logto-cloud/tenant-settings.mdx) about Logto cloud service.
...
If you’re working on an existing project and need to switch auth providers, Logto supports user migration from other platforms. You can migrate basic data, custom data, social identities, and password hashes. For details, see the [Migrate to Logto](../user-management/user-migration.mdx) guide.
