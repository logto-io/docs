...
Some advanced features are currently exclusive to the Logto Cloud version, including [Logto Protected App](/integrate-logto/protected-app), [free email service](/connectors/email-connectors/built-in-email-service), [IdP-initiated SSO](/end-user-flows/enterprise-sso/idp-initiated-sso), and [SAML IdP](/integrate-logto/third-party-applications).
