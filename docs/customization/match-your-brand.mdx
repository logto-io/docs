...
By default, the out-of-the-box sign-in experience pages display "Powered by Logto" at the bottom. Enable this option to remove the Logto branding and create a clean, professional sign-in experience that exclusively showcases your own brand identity.
