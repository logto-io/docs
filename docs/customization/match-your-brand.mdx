...
If your multi-app business needs app-level sign-in experiences, you can configure this in the application details page. Navigate to <CloudLink to="/application">Console > Applications</CloudLink>.
