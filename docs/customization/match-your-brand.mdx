...
By switching on "Organization-level sign-in experience", like the app-level branding, you can also set up specific branding logos, colors, and [custom CSS](/customization/custom-css) for each organization.
