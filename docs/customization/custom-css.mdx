...
3. Saving changes.
4. Don’t forget to click the “Live Preview” button to check the changes on all pages.
...
#app main[class*='main'] > div[class*='wrapper'] > div[class*='terms'] > i[class*='divider']::after {
