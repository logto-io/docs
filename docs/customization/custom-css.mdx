...
:::note
You can also set application-level and organization-level custom CSS in the application details page and organization settings page respectively. The precedence order is:

Organization-level custom CSS -> Application-level custom CSS -> Omni sign-in experience custom CSS
:::
...
## Custom CSS by Management API \{#custom-css-by-management-api}
