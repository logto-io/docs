...
You can use the Management API [PUT /api/custom-phrases/\{languageTag\}](https://bump.sh/logto/doc/logto-management-api/operation/operation-replacecustomphrase) to customize language translations. The API request body is a partical locale object like:
...
You can also use the [PATCH /api/sign-in-exp](https://bump.sh/logto/doc/logto-management-api/group/endpoint-sign-in-experience) API to to control the [language detection policies](https://bump.sh/logto/doc/logto-management-api/operation/operation-getsigninexp#operation-getsigninexp-200-body-application-json-languageinfo).
