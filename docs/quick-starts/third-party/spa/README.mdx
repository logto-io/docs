---
slug: /quick-starts/third-party-spa
sidebar_label: Third-party app (Single page app)
sidebar_custom_props:
  description: Integrate a third-party single page application using OIDC / OAuth protocol with PKCE.
  logoFilename: 'spa.svg'
---
...
## Create a third-party SPA in Logto \{#create-a-third-party-spa-in-logto}
