...
## Create an third-party OIDC application in Logto \{#create-an-third-party-oidc-application-in-logto}
...
## Setup the OIDC configurations \{#setup-the-oidc-configurations}
...
<Url href="/integrate-logto/third-party-applications">OIDC / OAuth third-party applications</Url>
