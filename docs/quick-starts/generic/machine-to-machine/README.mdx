...
:::info
To learn our current RBAC and the difference between user role and M2M role, see [Manage permissions and roles](/docs/recipes/rbac/manage-permissions-and-roles/) to learn more
:::
...
If you are protecting your own API Resources other than Logto Management API, remember to implement the authentication for your resource. See [Protect your API](/docs/recipes/protect-your-api#validate-the-api-requests-authorization-token) for details.
