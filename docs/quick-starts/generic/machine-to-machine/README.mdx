...
:::info
To learn our current RBAC and the difference between user role and M2M role, see [Configure roles](/authorization/role-based-access-control/configure-roles) to learn more.
:::
...
In your API Resource list, find the API identifier that the app needs to access. If you haven't added the API Resource in Logto or don't know what API Resource is, see [API Resource](/authorization/api-resources).
...
If you are protecting your own API Resources other than Logto Management API, remember to implement the authentication for your resource. See [Protect your API](/authorization/api-resources/protect-your-api/#validate-authorization-tokens-for-api-requests) for details.
