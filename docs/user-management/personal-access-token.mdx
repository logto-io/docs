...
After setting up the [Management API](/integrate-logto/management-api/), you can use the [API endpoints](https://openapi.logto.io/operation/operation-listuserpersonalaccesstokens) to create, list, and delete personal access tokens.
