...
- **Authorization flow**: You can use PAT tokens for [organization permissions](/authorization/organization-permissions) and [organization-level API resources](/authorization/organization-level-api-resources)
...
PAT tokens fully support organization contexts and permissions. For organization-specific use cases:

- **[Organization permissions](/authorization/organization-permissions)**: Use PAT tokens to access organization-specific features and workflows
- **[Organization-level API resources](/authorization/organization-level-api-resources)**: Use PAT tokens to call organization-scoped APIs with proper permissions
