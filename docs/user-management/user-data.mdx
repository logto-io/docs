...
You can update the user's _custom_data_ using [Admin Console](../manage-users/#view-and-update-the-user-profile) or [Logto Management API](../manage-users/#manage-via-logto-management-api), such as [`PATCH /api/users/:userId`](https://openapi.logto.io/operation/operation-patch-api-users-parameter).
