...
Please check out [app-specific branding](/customization/match-your-brand/#app-specific-branding) and [organization-specific logos](/customization/match-your-brand/#organization-specific-logos) for related configurations.
