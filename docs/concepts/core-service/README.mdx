...
{/* TODO @charles: replace SDK convention reference link */}
:::note
_Core Service_ and _SDK core_ are two separate concepts. See [SDK convention](/developer) for the differences.
:::
...
{/* TODO @charles */}
To access the API programmatically, see [Interact with Management API](/integrate-logto/management-api).
