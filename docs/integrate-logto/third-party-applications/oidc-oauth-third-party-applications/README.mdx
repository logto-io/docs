...
:::note
Before setting up the OIDC configurations, please ensure you've [created an OIDC third-party application](/integrate-logto/third-party-applications/#create-an-third-party-application-in-logto).
:::
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      href: '/integrate-logto/third-party-applications/oidc-oauth-third-party-applications/consent-page-branding',
      description:
