...
Permissions outside this set are ignored, both in authorization requests and when refreshing tokens. Users still consent only to permissions they have through their [roles](/authorization/role-based-access-control).
