...
[Organization permissions](/authorization/org-template/#organization-permission) are the scopes that defined exclusively for Logto organizations. They are used for accessing organization information and resources.
...
You can define your own organization scopes under the organization template settings page. Please see [Configure org template](/authorization/org-template/configure-org-template/) for more details.
