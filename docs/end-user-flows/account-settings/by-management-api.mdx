...
# Implement account settings by management API
...
Check the [management API](#) section to learn how to integrate the management APIs with Server-side application-side application.

### User data schema

Check the [User data and custom data](#) section to learn more about the user schema in Logto.
