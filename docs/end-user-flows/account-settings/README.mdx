...
Learn more about how to use the [user Management APIs](/end-user-flows/account-settings/by-management-api) to build your own account settings page.
...
Learn more about how to use the [account APIs](/end-user-flows/account-settings/by-account-api) to build your own account settings page.
