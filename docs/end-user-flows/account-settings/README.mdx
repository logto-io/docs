...
- **Full functionality**: Supports managing user profile (name, avatar, custom profile fields), updating email, phone, username, password, MFA settings, and sessions.
...
| **Supported features** | View and update: user profile (name, avatar, custom profile fields), email, phone, username, password, MFA (TOTP, passkeys, backup codes), social accounts, sessions, authorized apps | View, update, and delete: username, email, phone, password, social accounts, MFA, profile, sessions | All basic settings + Delete/suspend/restore account, Personal access tokens, user impersonation, connect OAuth apps, session, etc.  |
| **UI customization**   | Inherits sign-in experience branding; supports custom CSS                                                                                                                             | Full customization (build your own UI)                                                              | Full customization (build your own UI)                                                                                              |
