...
2. **Create enterprise connectors** for your different clients
   ...
   Next, you need to integrate each enterprise identity provider for your clients. Similar to social sign-in, create a new enterprise connector in Logto and configure the required settings. Navigate to the Console > Enterprise SSO, click the "Add enterprise connector" button, and follow the instructions to set up the connector. Refer to the [enterprise SSO connector setup](/connectors/enterprise-connectors/).
