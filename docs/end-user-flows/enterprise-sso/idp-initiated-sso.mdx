...
Before configuring IdP-initiated SSO, you need to create a SAML connector first. Navigate to the <CloudLink to="/enterprise-sso" /> and follow the step-by-step guide to set up a [SAML](/integrations/saml-sso/) connector with your IdP.
