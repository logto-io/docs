...
Manually create your organizations through Logto Console UI. Go to "Logto Console → Organizations" to create organization, assign members and roles, and customize organization sign-in experience UI.
...
<Url href="/integrate-logto/management-api">Interact with Management API</Url>
...
{/* TODO @charles: Update the following links */}

<Url href="/authorization/protect-organization-resource">Verify organization tokens</Url>
<Url href="/authorization">Protect your API</Url>
