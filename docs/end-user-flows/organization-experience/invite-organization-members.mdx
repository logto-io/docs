...
Make sure you have integrated organization with your app. Check out the [integration guide](/authorization/org-template/protect-org-resources) for more details.
...
Learn more about [issuing an organization token](/authorization/org-template/protect-org-resources/#fetch-the-organization-token)
