...
You can have both the admin and member users to invite others into the organization. Check [this documentation](../invite-organization-members) for details about inviting member.
