...
<img src={autoAgreeToTermsImage} alt="Agree to terms automatically" />
...
<img src={signUpOnlyAgreeToTermsImage} alt="Agree to terms on sign-up only" />
...
<img src={signInAgreeToTermsImage} alt="Agree to terms on sign-in and sign-up" />
