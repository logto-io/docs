...
1. Navigate to the <CloudLink to="/sign-in-experience/sign-up-and-sign-in" /> page.
...
1. Disable user registration in the Logto console.
2. Manually create user accounts in the Logto console <CloudLink to="/users" /> or via the Management API.
