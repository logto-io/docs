...
Continue to learn more about the sign-in experience [setup](sign-up) and [customization](/customization) in Logto.
...
address, or region, you can use the [Custom token claims](/developer/custom-token-claims/) feature in Logto to
