...
<img src={signInExperienceSignUpImage} alt="sign-up setting" />
...
<img src={signUpUsernamePasswordImage} alt="Username and password sign-up" />
...
<img src={signUpEmailVerificationImage} alt="Email or phone number sign-up with verification" />
...
<img src={signUpEmailPasswordImage} alt="Email sign-up with verification and password creation" />
