...
Visit <CloudLink to="/sign-in-experience/sign-up-and-sign-in">Sign-in experience > Sign-up and sign-in</CloudLink> to start configuring the identifier sign-up flow.
...
Subscribe to the `User.Created` webhook event to trigger a welcome email to new users. Learn more about [webhook events](/developer/webhooks/webhooks-events/#data-mutation-hook-events).
