...
Subscribe to the `User.Created` webhook event to trigger a welcome email to new users. Learn more about [webhook events](/webhooks/webhooks-events/#data-mutation-hook-events).
