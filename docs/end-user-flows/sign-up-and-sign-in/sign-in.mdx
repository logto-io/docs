...
:::note
Note: For a custom sign-in flows, refer to the feature of [Bring your UI](#).
:::
...
Logto does not currently support headless API for sign-in and sign-up. However, you can use our [Bring your UI](#) feature to upload your custom sign-in form to Logto. We also support multiple sign-in parameters you can use to pre-fill the sign-in form with user identifier collected from your application or directly sign-in with a third-party social or enterprise SSO provider. Learn more at [Initiated sign-in](#).
