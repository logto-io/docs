...
### Can I assign users to specific roles using the magic link? \{#can-i-assign-users-to-specific-roles-using-the-magic-link}
...
### If I disable user registration in "Sign-up and sign-in", can I still use magic link to invite users? \{#if-i-disable-user-registration-in-sign-in-experience-can-i-still-use-magic-link-to-invite-users}

</summary>

Yes, you can still use magic link to invite users even if you disable user registration in "Sign-up and sing-in".
