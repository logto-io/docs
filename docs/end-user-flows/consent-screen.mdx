...
Learn more about setting up the [third-party application](/integrate-logto/third-party-application/) and configuring the [consent](/integrate-logto/third-party-application/oidc-third-party-application/consent-page-branding/) screen in Logto.
