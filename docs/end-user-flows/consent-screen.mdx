...
Learn more about setting up the [third-party application](/integrate-logto/third-party-applications/) and configuring the [consent](/integrate-logto/third-party-applications/oidc-oauth-third-party-applications/consent-page-branding/) screen in Logto.
