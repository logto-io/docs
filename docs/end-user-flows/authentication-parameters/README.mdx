...
Continue reading to learn more about the authentication parameters to customize the [first screen](first-screen) or enable a [direct sign-in](direct-sign-in) experience for your users.
