...
- [**Set up SMS for MFA**](/end-user-flows/mfa/sms-mfa): Go to <CloudLink to="/mfa">Multi-factor auth</CloudLink>. Enable "SMS verification code" as a second factor for enhanced security.
