...
Once you create a social connector successfully, you can enable it as a Social Sign-in button in <CloudLink to="/sign-in-experience/sign-up-and-sign-in">Sign-in Experience</CloudLink>.
