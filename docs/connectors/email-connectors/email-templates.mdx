...
You can add a new endpoint to your own web service to send emails, then use [the Logto HTTP email connector](https://github.com/logto-io/logto/tree/master/packages/connectors/connector-http-email) to call the endpoint you maintain.
