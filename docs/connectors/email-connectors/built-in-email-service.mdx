...
<img src={emailServiceTemplateSampleImage} alt="Logto built-in email service sample" />
...
### Is it possible to add custom CSS or HTML to Logto email service? \{#is-it-possible-to-add-custom-css-or-html-to-logto-email-service}
