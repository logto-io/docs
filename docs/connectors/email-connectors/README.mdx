...
## Enable email address for end-user flows \{#enable-email-address-for-end-user-flows}
...
- [**Set up email for MFA**](/end-user-flows/mfa/email-mfa): Go to <CloudLink to="/mfa">Multi-factor auth</CloudLink>. Enable "Email verification code" as a second factor for enhanced security.
