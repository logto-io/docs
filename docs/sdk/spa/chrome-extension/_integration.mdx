...
For other interactive pages in your extension, you just need to replace the `Extension popoup` participant with the page's name. In this tutorial, we will focus on the popup page.
