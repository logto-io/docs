...
Now that you have integrated Logto into your Flutter application, with the basic sign-in and sign-out functionality, you can test your application.

1. Run your application, you will see the sign-in button.
2. Click the sign-in button, the Logto SDK will lead you to the Logto sign-in page.
