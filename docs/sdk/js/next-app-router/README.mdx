...
import CheckIntegration from '../next/_check_integration.mdx';
...
# Next.js SDK for App Router tutorial

This tutorial will show you how to integrate Logto into your Next.js App Router application.
