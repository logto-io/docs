...
description: Learn how to efficiently build a multi-tenant SaaS application with robust authentication, organization management, and role-based access control in just a few hours.
---
...
Here's a useful trick: Our login page has both Sign in and Register buttons. The Register button leads directly to Logto's registration page. This works through Logto's [first screen](https://docs.logto.io/end-user-flows/authentication-parameters/first-screen) feature. It determines which step of the auth flow users see first.
...
For guidance, check out the [Interact with Management API](https://docs.logto.io/integrate-logto/interact-with-management-api) documentation to set up API communication with Logto.
...
2. **Accessing Logto Management API**:
   ...
   - Follow the [Interact with Management API](https://docs.logto.io/integrate-logto/interact-with-management-api) guide for setup
...
In Logto, we use Machine-to-Machine authentication for access tokens. See [Interact with Management API](https://docs.logto.io/integrate-logto/interact-with-management-api).
...
| **Features** | **Doc link** |
|----------------|----------------|
| Enterprise SSO Integration | https://docs.logto.io/end-user-flows/enterprise-sso |
| Just-in-Time (JIT) Provisioning | https://docs.logto.io/organizations/just-in-time-provisioning |
| Organization-Level Branding | https://docs.logto.io/customization/match-your-brand#organization-specific-branding |
| Organization-Level Multi-Factor Authentication (MFA) | https://docs.logto.io/organizations/organization-management#require-mfa-for-organization-members |
| Organization-Level Management: | https://docs.logto.io/end-user-flows/organization-experience/organization-management |
