...
description: Complete guide to Role-Based Access Control (RBAC) —— Master permission design, role management, and secure authorization with practical CMS implementation.
---
...
Before you start, you need to create a account in [Logto Cloud](https://cloud.logto.io), or you can also use an self-hosted Logto instance by using the [Logto OSS version](https://docs.logto.io/logto-oss).
...
:::note
For demonstration purposes, we create these resources and configurations through the Logto Console. In real projects, you can create these resources and configurations programmatically using the [Management API](https://docs.logto.io/integrate-logto/interact-with-management-api) provided by Logto.
:::
...
First, follow the [Logto Quick Starts](https://docs.logto.io/quick-starts) to integrate Logto into your application.

In our example, we use [React](https://docs.logto.io/quick-starts/react) for demonstration.
