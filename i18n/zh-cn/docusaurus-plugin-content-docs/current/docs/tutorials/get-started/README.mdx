...
在 Logto 仓库地址的前面添加 `https://gitpod.io/#`（或 <a href="https://gitpod.io/#https://github.com/logto-io/logto" target="_blank" rel="noreferrer">点按此处</a>）并访问该链接。稍等片刻，你会在屏幕下方的终端里看到类似如下信息：
