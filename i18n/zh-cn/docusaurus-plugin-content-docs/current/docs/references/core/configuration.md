...
| OIDC_PRIVATE_KEYS      | N/A                          | <code>string[] &#124; undefined</code> | [OIDC JWT 签名](https://openid.net/specs/openid-connect-core-1_0.html#Signing) 的 private key 内容的数组。<br/> 如果你想在 `.env` 中设置，你可以通过 [多行值](https://github.com/motdotla/dotenv#multiline-values) 来实现。 |
| OIDC_PRIVATE_KEY_PATHS | `['./oidc-private-key.pem']` | <code>string[] &#124; undefined</code> | [OIDC JWT 签名](https://openid.net/specs/openid-connect-core-1_0.html#Signing) 的 private key 文件路径数组。 <br/> 注意：如果 `OIDC_PRIVATE_KEYS` 非空，Logto 将 _忽略_ 该值。                                              |
