...
如果你还没有准备好，请在继续之前 [阅读此内容](./README.md#register-the-api-resources-through-logto-admin-console)。
...
如果你还没有准备好，请在继续之前 [阅读此内容](./README.md#integrate-the-resources-authorization-flow-into-your-client-application)。
