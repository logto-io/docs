---
slug: build-gatewayapi-sign-in-with-dotnet-core-mvc-and-logto
tags: [autenticación, gatewayapi, dotnet-core-mvc, c#, inicio-de-sesión-sin-contraseña, inicio-de-sesión, login]
title: Cómo construir GatewayAPI SMS inicio de sesión sin contraseña con .NET Core (MVC)
sdk: .NET Core (MVC)
