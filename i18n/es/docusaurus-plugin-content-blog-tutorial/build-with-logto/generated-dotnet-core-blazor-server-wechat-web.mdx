---
slug: build-wechat-web-sign-in-with-dotnet-core-blazor-server-and-logto
tags: [autenticación, wechat-web, dotnet-core-blazor-server, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Web) con .NET Core (Blazor Server)
