---
slug: build-oidc-enterprise-sso-sign-in-with-java-spring-boot-and-logto
tags: [SSO providers, oidc-enterprise-sso, java-spring-boot, java, SAML authentication, enterprise login, SSO login]
title: How to build OIDC enterprise SSO with Java Spring Boot
