---
slug: build-wechat-web-sign-in-with-ios-swift-and-logto
tags: [autenticación, wechat-web, ios-swift, swift, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Web) con iOS (Swift)
sdk: iOS (Swift)
