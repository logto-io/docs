---
slug: build-oidc-enterprise-sso-sign-in-with-next-app-router-and-logto
tags: [SSO providers, oidc-enterprise-sso, next-app-router, js, SAML authentication, enterprise login, SSO login]
title: How to build OIDC enterprise SSO with Next.js (App Router)
