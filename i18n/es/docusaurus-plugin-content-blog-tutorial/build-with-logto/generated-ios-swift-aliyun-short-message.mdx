---
slug: how-to-build-aliyun-short-message-sign-in-with-ios-swift-and-logto
tags: [autenticación, aliyun-short-message, ios-swift, swift, inicio-de-sesión-sin-contraseña, inicio-de-sesión, login]
title: Cómo construir Aliyun Short Message SMS inicio de sesión sin contraseña con iOS (Swift)
sdk: iOS (Swift)
