---
slug: how-to-build-tencent-short-message-sign-in-with-dotnet-core-blazor-server-and-logto
tags: [autenticación, tencent-short-message, dotnet-core-blazor-server, c#, inicio-de-sesión-sin-contraseña, inicio-de-sesión, login]
title: Cómo construir Tencent Short Message SMS inicio de sesión sin contraseña con .NET Core (Blazor Server)
