---
slug: how-to-build-tencent-short-message-sign-in-with-ios-swift-and-logto
tags: [autenticación, tencent-short-message, ios-swift, swift, inicio-de-sesión-sin-contraseña, inicio-de-sesión, login]
title: Cómo construir Tencent Short Message SMS inicio de sesión sin contraseña con iOS (Swift)
sdk: iOS (Swift)
