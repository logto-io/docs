---
slug: build-microsoft-sign-in-with-expo-react-native-and-logto
tags: [autenticación, microsoft, expo-react-native, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Microsoft con Expo (React Native)
