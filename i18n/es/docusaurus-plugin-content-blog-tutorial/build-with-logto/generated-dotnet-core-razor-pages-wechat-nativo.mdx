---
slug: how-to-build-wechat-nativo-sign-in-with-dotnet-core-razor-pages-and-logto
tags: [autenticación, wechat-nativo, dotnet-core-razor-pages, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Nativo) con .NET Core (Razor Pages)
