---
slug: build-feishu-sign-in-with-dotnet-core-blazor-server-and-logto
tags: [autenticación, feishu, dotnet-core-blazor-server, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Feishu con .NET Core (Blazor Server)
