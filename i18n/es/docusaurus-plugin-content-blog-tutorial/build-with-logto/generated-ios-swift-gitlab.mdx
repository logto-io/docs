---
slug: build-gitlab-sign-in-with-ios-swift-and-logto
tags: [autenticación, gitlab, ios-swift, swift, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de GitLab con iOS (Swift)
sdk: iOS (Swift)
connector: GitLab
---
