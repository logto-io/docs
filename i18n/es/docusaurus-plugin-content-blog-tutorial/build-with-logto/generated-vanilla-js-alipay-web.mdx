---
slug: build-alipay-web-sign-in-with-vanilla-js-and-logto
tags: [autenticación, alipay-web, vanilla-js, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Web) con Vanilla JS
sdk: Vanilla JS
