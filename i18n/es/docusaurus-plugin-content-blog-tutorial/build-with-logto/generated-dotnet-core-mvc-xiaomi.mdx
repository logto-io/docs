---
slug: build-xiaomi-sign-in-with-dotnet-core-mvc-and-logto
tags: [autenticación, xiaomi, dotnet-core-mvc, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Xiaomi con .NET Core (MVC)
sdk: .NET Core (MVC)
connector: Xiaomi
---
