---
slug: build-wechat-native-sign-in-with-dotnet-core-blazor-webassembly-and-logto
tags: [autenticación, wechat-native, dotnet-core-blazor-webassembly, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Native) con .NET Core (Blazor WebAssembly)
