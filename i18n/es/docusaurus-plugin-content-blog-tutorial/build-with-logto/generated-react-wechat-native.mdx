---
slug: build-wechat-native-sign-in-with-react-and-logto
tags: [autenticación, wechat-native, react, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Native) con React
sdk: React
