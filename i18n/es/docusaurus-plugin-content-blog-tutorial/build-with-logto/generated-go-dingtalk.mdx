---
slug: build-dingtalk-sign-in-with-go-and-logto
tags: [autenticación, dingtalk, go, go, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de DingTalk con Go
sdk: Go
connector: DingTalk
---
