---
slug: build-alipay-native-sign-in-with-dotnet-core-mvc-and-logto
tags: [autenticación, alipay-native, dotnet-core-mvc, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Native) con .NET Core (MVC)
sdk: .NET Core (MVC)
