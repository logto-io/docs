---
slug: build-patreon-sign-in-with-dotnet-core-mvc-and-logto
tags: [autenticación, patreon, dotnet-core-mvc, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Patreon con .NET Core (MVC)
sdk: .NET Core (MVC)
connector: Patreon
---
