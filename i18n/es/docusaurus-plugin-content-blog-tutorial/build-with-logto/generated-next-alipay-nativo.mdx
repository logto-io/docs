---
slug: how-to-build-alipay-nativo-sign-in-with-next-and-logto
tags: [autenticación, alipay-nativo, next, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Nativo) con Next.js (Pages Router)
