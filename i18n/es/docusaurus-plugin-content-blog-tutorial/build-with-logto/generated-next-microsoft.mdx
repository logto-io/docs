---
slug: build-microsoft-sign-in-with-next-and-logto
tags: [autenticación, microsoft, next, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Microsoft con Next.js (Pages Router)
