---
slug: build-alipay-web-sign-in-with-android-and-logto
tags: [autenticación, alipay-web, android, kotlin/java, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Web) con Android (Kotlin / Java)
