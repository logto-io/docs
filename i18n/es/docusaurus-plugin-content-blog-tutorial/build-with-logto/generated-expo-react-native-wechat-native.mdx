---
slug: build-wechat-native-sign-in-with-expo-react-native-and-logto
tags: [autenticación, wechat-native, expo-react-native, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Native) con Expo (React Native)
