---
slug: build-alipay-web-sign-in-with-dotnet-core-razor-pages-and-logto
tags: [autenticación, alipay-web, dotnet-core-razor-pages, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Web) con .NET Core (Razor Pages)
