---
slug: how-to-build-wechat-nativo-sign-in-with-next-and-logto
tags: [autenticación, wechat-nativo, next, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Nativo) con Next.js (Pages Router)
