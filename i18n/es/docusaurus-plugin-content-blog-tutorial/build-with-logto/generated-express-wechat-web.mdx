---
slug: build-wechat-web-sign-in-with-express-and-logto
tags: [autenticación, wechat-web, express, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Web) con Express
sdk: Express
