---
slug: build-wechat-native-sign-in-with-dotnet-core-razor-pages-and-logto
tags: [autenticación, wechat-native, dotnet-core-razor-pages, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Native) con .NET Core (Razor Pages)
