---
slug: build-aliyun-direct-mail-sign-in-with-dotnet-core-blazor-webassembly-and-logto
tags: [autenticación, aliyun-direct-mail, dotnet-core-blazor-webassembly, c#, inicio-de-sesión-sin-contraseña, inicio-de-sesión, login]
title: Cómo construir Aliyun Direct Mail Email inicio de sesión sin contraseña con .NET Core (Blazor WebAssembly)
