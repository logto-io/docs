---
slug: build-gitlab-sign-in-with-next-and-logto
tags: [autenticación, gitlab, next, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de GitLab con Next.js (Pages Router)
