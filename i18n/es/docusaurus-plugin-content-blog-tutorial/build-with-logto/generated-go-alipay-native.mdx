---
slug: build-alipay-native-sign-in-with-go-and-logto
tags: [autenticación, alipay-native, go, go, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Native) con Go
sdk: Go
