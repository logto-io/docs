---
slug: build-xiaomi-sign-in-with-next-and-logto
tags: [autenticación, xiaomi, next, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Xiaomi con Next.js (Pages Router)
