---
slug: build-gitlab-sign-in-with-go-and-logto
tags: [autenticación, gitlab, go, go, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de GitLab con Go
sdk: Go
connector: GitLab
---
