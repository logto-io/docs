---
slug: build-wechat-native-sign-in-with-next-and-logto
tags: [autenticación, wechat-native, next, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Native) con Next.js (Pages Router)
