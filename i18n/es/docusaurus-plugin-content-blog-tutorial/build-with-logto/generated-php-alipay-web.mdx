---
slug: build-alipay-web-sign-in-with-php-and-logto
tags: [autenticación, alipay-web, php, php, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Web) con PHP
sdk: PHP
