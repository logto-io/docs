---
slug: build-alipay-web-sign-in-with-react-and-logto
tags: [autenticación, alipay-web, react, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Web) con React
sdk: React
