---
slug: build-alipay-native-sign-in-with-next-and-logto
tags: [autenticación, alipay-native, next, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Native) con Next.js (Pages Router)
