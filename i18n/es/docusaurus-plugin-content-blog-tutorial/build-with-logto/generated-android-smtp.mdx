---
slug: build-smtp-sign-in-with-android-and-logto
tags: [autenticación, smtp, android, kotlin/java, inicio-de-sesión-sin-contraseña, inicio-de-sesión, login]
title: Cómo construir SMTP Email inicio de sesión sin contraseña con Android (Kotlin / Java)
