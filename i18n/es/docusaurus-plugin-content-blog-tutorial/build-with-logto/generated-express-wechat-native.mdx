---
slug: build-wechat-native-sign-in-with-express-and-logto
tags: [autenticación, wechat-native, express, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Native) con Express
sdk: Express
