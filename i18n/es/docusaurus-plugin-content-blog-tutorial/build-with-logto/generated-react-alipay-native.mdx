---
slug: build-alipay-native-sign-in-with-react-and-logto
tags: [autenticación, alipay-native, react, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Native) con React
sdk: React
