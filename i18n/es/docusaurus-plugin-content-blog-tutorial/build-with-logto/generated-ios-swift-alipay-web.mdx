---
slug: build-alipay-web-sign-in-with-ios-swift-and-logto
tags: [autenticación, alipay-web, ios-swift, swift, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Web) con iOS (Swift)
sdk: iOS (Swift)
