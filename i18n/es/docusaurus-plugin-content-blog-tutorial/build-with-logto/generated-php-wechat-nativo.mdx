---
slug: how-to-build-wechat-nativo-sign-in-with-php-and-logto
tags: [autenticación, wechat-nativo, php, php, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Nativo) con PHP
sdk: PHP
