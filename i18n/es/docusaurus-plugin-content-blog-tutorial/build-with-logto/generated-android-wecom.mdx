---
slug: build-wecom-sign-in-with-android-and-logto
tags: [autenticación, wecom, android, kotlin/java, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeCom con Android (Kotlin / Java)
