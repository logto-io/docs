---
slug: build-smtp-sign-in-with-next-and-logto
tags: [autenticación, smtp, next, js, inicio-de-sesión-sin-contraseña, inicio-de-sesión, login]
title: Cómo construir SMTP Email inicio de sesión sin contraseña con Next.js (Pages Router)
