---
slug: build-microsoft-entra-id-saml-enterprise-sso-sign-in-with-capacitor-js-and-logto
tags: [SSO providers, microsoft-entra-id-saml-enterprise-sso, capacitor-js, js, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID SAML enterprise SSO with Capacitor JS
sdk: Capacitor JS
