---
slug: how-to-build-alipay-nativo-sign-in-with-ios-swift-and-logto
tags: [autenticación, alipay-nativo, ios-swift, swift, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Nativo) con iOS (Swift)
sdk: iOS (Swift)
