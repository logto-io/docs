---
slug: build-gitlab-sign-in-with-react-and-logto
tags: [autenticación, gitlab, react, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de GitLab con React
sdk: React
connector: GitLab
---
