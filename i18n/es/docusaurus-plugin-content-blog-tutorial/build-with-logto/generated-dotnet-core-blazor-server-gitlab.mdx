---
slug: build-gitlab-sign-in-with-dotnet-core-blazor-server-and-logto
tags: [autenticación, gitlab, dotnet-core-blazor-server, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de GitLab con .NET Core (Blazor Server)
