---
slug: build-alipay-web-sign-in-with-dotnet-core-blazor-server-and-logto
tags: [autenticación, alipay-web, dotnet-core-blazor-server, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Web) con .NET Core (Blazor Server)
