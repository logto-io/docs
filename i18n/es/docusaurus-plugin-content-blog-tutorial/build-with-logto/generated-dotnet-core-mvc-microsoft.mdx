---
slug: build-microsoft-sign-in-with-dotnet-core-mvc-and-logto
tags: [autenticación, microsoft, dotnet-core-mvc, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Microsoft con .NET Core (MVC)
sdk: .NET Core (MVC)
connector: Microsoft
---
