---
slug: build-gitlab-sign-in-with-dotnet-core-mvc-and-logto
tags: [autenticación, gitlab, dotnet-core-mvc, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de GitLab con .NET Core (MVC)
sdk: .NET Core (MVC)
connector: GitLab
---
