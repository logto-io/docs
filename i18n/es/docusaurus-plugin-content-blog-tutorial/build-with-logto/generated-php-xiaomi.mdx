---
slug: build-xiaomi-sign-in-with-php-and-logto
tags: [autenticación, xiaomi, php, php, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Xiaomi con PHP
sdk: PHP
connector: Xiaomi
---
