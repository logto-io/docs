---
slug: how-to-build-wechat-nativo-sign-in-with-ios-swift-and-logto
tags: [autenticación, wechat-nativo, ios-swift, swift, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Nativo) con iOS (Swift)
sdk: iOS (Swift)
