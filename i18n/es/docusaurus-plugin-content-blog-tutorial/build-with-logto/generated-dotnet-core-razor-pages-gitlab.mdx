---
slug: build-gitlab-sign-in-with-dotnet-core-razor-pages-and-logto
tags: [autenticación, gitlab, dotnet-core-razor-pages, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de GitLab con .NET Core (Razor Pages)
