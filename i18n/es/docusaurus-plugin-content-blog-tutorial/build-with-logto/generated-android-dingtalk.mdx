---
slug: build-dingtalk-sign-in-with-android-and-logto
tags: [autenticación, dingtalk, android, kotlin/java, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de DingTalk con Android (Kotlin / Java)
