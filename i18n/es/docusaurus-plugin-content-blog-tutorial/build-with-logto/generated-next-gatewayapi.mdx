---
slug: build-gatewayapi-sign-in-with-next-and-logto
tags: [autenticación, gatewayapi, next, js, inicio-de-sesión-sin-contraseña, inicio-de-sesión, login]
title: Cómo construir GatewayAPI SMS inicio de sesión sin contraseña con Next.js (Pages Router)
