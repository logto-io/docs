---
slug: build-wechat-native-sign-in-with-ios-swift-and-logto
tags: [autenticación, wechat-native, ios-swift, swift, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Native) con iOS (Swift)
sdk: iOS (Swift)
