---
slug: how-to-build-tencent-short-message-sign-in-with-dotnet-core-blazor-webassembly-and-logto
tags: [autenticación, tencent-short-message, dotnet-core-blazor-webassembly, c#, inicio-de-sesión-sin-contraseña, inicio-de-sesión, login]
title: Cómo construir Tencent Short Message SMS inicio de sesión sin contraseña con .NET Core (Blazor WebAssembly)
