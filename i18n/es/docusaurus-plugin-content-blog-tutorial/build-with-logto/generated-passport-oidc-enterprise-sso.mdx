---
slug: build-oidc-enterprise-sso-sign-in-with-passport-and-logto
tags: [SSO providers, oidc-enterprise-sso, passport, js, SAML authentication, enterprise login, SSO login]
title: How to build OIDC enterprise SSO with Passport.js
sdk: Passport.js
