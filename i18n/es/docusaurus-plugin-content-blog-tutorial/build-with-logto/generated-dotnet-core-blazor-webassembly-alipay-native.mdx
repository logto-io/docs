---
slug: build-alipay-native-sign-in-with-dotnet-core-blazor-webassembly-and-logto
tags: [autenticación, alipay-native, dotnet-core-blazor-webassembly, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Native) con .NET Core (Blazor WebAssembly)
