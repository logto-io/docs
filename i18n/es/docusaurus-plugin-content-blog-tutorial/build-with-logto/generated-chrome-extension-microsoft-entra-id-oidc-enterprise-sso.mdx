---
slug: build-microsoft-entra-id-oidc-enterprise-sso-sign-in-with-chrome-extension-and-logto
tags: [SSO providers, microsoft-entra-id-oidc-enterprise-sso, chrome-extension, js, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID OIDC enterprise SSO with Extensión de Chrome
