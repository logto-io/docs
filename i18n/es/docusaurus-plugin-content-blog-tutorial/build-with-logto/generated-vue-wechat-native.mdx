---
slug: build-wechat-native-sign-in-with-vue-and-logto
tags: [autenticación, wechat-native, vue, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Native) con Vue
sdk: Vue
