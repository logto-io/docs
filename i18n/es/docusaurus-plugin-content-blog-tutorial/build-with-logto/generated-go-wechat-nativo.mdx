---
slug: how-to-build-wechat-nativo-sign-in-with-go-and-logto
tags: [autenticación, wechat-nativo, go, go, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Nativo) con Go
sdk: Go
