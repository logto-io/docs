---
slug: how-to-build-alipay-nativo-sign-in-with-php-and-logto
tags: [autenticación, alipay-nativo, php, php, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Nativo) con PHP
sdk: PHP
