---
slug: build-microsoft-entra-id-saml-enterprise-sso-sign-in-with-angular-and-logto
tags: [SSO providers, microsoft-entra-id-saml-enterprise-sso, angular, js, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID SAML enterprise SSO with Angular
sdk: Angular
...
## Integrate Angular SDK \{#integrate-framework-sdk}

<IntegrateSdk />

## Add Microsoft Entra ID SAML enterprise SSO connector \{#add-connector-connector}

<AddSsoConnector framework="Angular" />
