---
slug: build-feishu-sign-in-with-android-and-logto
tags: [autenticación, feishu, android, kotlin/java, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Feishu con Android (Kotlin / Java)
