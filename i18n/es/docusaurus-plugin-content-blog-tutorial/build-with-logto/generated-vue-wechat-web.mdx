---
slug: build-wechat-web-sign-in-with-vue-and-logto
tags: [autenticación, wechat-web, vue, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Web) con Vue
sdk: Vue
