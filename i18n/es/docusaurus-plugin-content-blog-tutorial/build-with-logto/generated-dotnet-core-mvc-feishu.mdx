---
slug: build-feishu-sign-in-with-dotnet-core-mvc-and-logto
tags: [autenticación, feishu, dotnet-core-mvc, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Feishu con .NET Core (MVC)
sdk: .NET Core (MVC)
connector: Feishu
---
