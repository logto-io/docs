---
slug: build-feishu-sign-in-with-go-and-logto
tags: [autenticación, feishu, go, go, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Feishu con Go
sdk: Go
connector: Feishu
---
