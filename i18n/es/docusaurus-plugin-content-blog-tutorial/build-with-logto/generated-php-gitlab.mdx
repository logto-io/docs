---
slug: build-gitlab-sign-in-with-php-and-logto
tags: [autenticación, gitlab, php, php, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de GitLab con PHP
sdk: PHP
connector: GitLab
---
