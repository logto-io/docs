---
slug: build-dingtalk-sign-in-with-dotnet-core-blazor-webassembly-and-logto
tags: [autenticación, dingtalk, dotnet-core-blazor-webassembly, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de DingTalk con .NET Core (Blazor WebAssembly)
