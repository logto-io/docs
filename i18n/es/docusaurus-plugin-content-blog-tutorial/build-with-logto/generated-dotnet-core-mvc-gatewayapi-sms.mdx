---
slug: how-to-build-gatewayapi-sms-sign-in-with-dotnet-core-mvc-and-logto
tags: [autenticación, gatewayapi-sms, dotnet-core-mvc, c#, inicio-de-sesión-sin-contraseña, inicio-de-sesión, login]
title: Cómo construir GatewayAPI SMS SMS inicio de sesión sin contraseña con .NET Core (MVC)
sdk: .NET Core (MVC)
