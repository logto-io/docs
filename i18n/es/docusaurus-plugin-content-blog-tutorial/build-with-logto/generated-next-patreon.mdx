---
slug: build-patreon-sign-in-with-next-and-logto
tags: [autenticación, patreon, next, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Patreon con Next.js (Pages Router)
