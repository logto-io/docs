---
slug: build-okta-enterprise-sso-sign-in-with-angular-and-logto
tags: [SSO providers, okta-enterprise-sso, angular, js, SAML authentication, enterprise login, SSO login]
title: How to build Okta enterprise SSO with Angular
sdk: Angular
