---
slug: build-alipay-native-sign-in-with-php-and-logto
tags: [autenticación, alipay-native, php, php, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Native) con PHP
sdk: PHP
