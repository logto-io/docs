---
slug: build-alipay-native-sign-in-with-express-and-logto
tags: [autenticación, alipay-native, express, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Native) con Express
sdk: Express
