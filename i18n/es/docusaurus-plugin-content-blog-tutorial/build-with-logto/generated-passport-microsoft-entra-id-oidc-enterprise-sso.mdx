---
slug: build-microsoft-entra-id-oidc-enterprise-sso-sign-in-with-passport-and-logto
tags: [SSO providers, microsoft-entra-id-oidc-enterprise-sso, passport, js, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID OIDC enterprise SSO with Passport.js
sdk: Passport.js
