---
slug: build-microsoft-entra-id-saml-enterprise-sso-sign-in-with-java-spring-boot-and-logto
tags: [SSO providers, microsoft-entra-id-saml-enterprise-sso, java-spring-boot, java, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID SAML enterprise SSO with Java Spring Boot
