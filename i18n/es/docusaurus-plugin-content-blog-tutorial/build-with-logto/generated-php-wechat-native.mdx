---
slug: build-wechat-native-sign-in-with-php-and-logto
tags: [autenticación, wechat-native, php, php, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Native) con PHP
sdk: PHP
