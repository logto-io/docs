---
slug: build-wechat-native-sign-in-with-go-and-logto
tags: [autenticación, wechat-native, go, go, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Native) con Go
sdk: Go
