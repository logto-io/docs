---
slug: build-kook-sign-in-with-go-and-logto
tags: [autenticación, kook, go, go, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de KOOK con Go
sdk: Go
connector: KOOK
---
