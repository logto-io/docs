---
slug: build-kook-sign-in-with-dotnet-core-mvc-and-logto
tags: [autenticación, kook, dotnet-core-mvc, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de KOOK con .NET Core (MVC)
sdk: .NET Core (MVC)
connector: KOOK
---
