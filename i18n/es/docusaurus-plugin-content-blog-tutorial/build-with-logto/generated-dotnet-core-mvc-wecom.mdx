---
slug: build-wecom-sign-in-with-dotnet-core-mvc-and-logto
tags: [autenticación, wecom, dotnet-core-mvc, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeCom con .NET Core (MVC)
sdk: .NET Core (MVC)
connector: WeCom
---
