---
slug: build-okta-enterprise-sso-sign-in-with-java-spring-boot-and-logto
tags: [SSO providers, okta-enterprise-sso, java-spring-boot, java, SAML authentication, enterprise login, SSO login]
title: How to build Okta enterprise SSO with Java Spring Boot
