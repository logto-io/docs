---
slug: build-microsoft-entra-id-saml-enterprise-sso-sign-in-with-next-app-router-and-logto
tags: [SSO providers, microsoft-entra-id-saml-enterprise-sso, next-app-router, js, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID SAML enterprise SSO with Next.js (App Router)
