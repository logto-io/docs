---
slug: build-wechat-web-sign-in-with-next-and-logto
tags: [autenticación, wechat-web, next, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Web) con Next.js (Pages Router)
