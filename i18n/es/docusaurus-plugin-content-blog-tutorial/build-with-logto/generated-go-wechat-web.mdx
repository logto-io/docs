---
slug: build-wechat-web-sign-in-with-go-and-logto
tags: [autenticación, wechat-web, go, go, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Web) con Go
sdk: Go
