---
slug: build-wechat-web-sign-in-with-dotnet-core-mvc-and-logto
tags: [autenticación, wechat-web, dotnet-core-mvc, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Web) con .NET Core (MVC)
sdk: .NET Core (MVC)
