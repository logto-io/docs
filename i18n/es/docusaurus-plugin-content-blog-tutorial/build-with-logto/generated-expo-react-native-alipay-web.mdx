---
slug: build-alipay-web-sign-in-with-expo-react-native-and-logto
tags: [autenticación, alipay-web, expo-react-native, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Web) con Expo (React Native)
