---
slug: build-gitlab-sign-in-with-expo-react-native-and-logto
tags: [autenticación, gitlab, expo-react-native, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de GitLab con Expo (React Native)
