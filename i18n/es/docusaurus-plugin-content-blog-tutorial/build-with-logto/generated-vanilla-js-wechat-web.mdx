---
slug: build-wechat-web-sign-in-with-vanilla-js-and-logto
tags: [autenticación, wechat-web, vanilla-js, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Web) con Vanilla JS
sdk: Vanilla JS
