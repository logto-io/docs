---
slug: build-microsoft-entra-id-oidc-enterprise-sso-sign-in-with-angular-and-logto
tags: [SSO providers, microsoft-entra-id-oidc-enterprise-sso, angular, js, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID OIDC enterprise SSO with Angular
sdk: Angular
