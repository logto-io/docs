---
slug: build-xiaomi-sign-in-with-go-and-logto
tags: [autenticación, xiaomi, go, go, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Xiaomi con Go
sdk: Go
connector: Xiaomi
---
