---
slug: build-kook-sign-in-with-next-and-logto
tags: [autenticación, kook, next, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de KOOK con Next.js (Pages Router)
