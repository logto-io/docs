---
slug: build-kook-sign-in-with-ios-swift-and-logto
tags: [autenticación, kook, ios-swift, swift, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de KOOK con iOS (Swift)
sdk: iOS (Swift)
connector: KOOK
---
