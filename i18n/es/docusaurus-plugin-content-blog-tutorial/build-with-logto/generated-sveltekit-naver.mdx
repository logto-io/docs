---
slug: build-naver-sign-in-with-sveltekit-and-logto
tags: [autenticación, naver, sveltekit, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Naver con SvelteKit
sdk: SvelteKit
connector: Naver
---
