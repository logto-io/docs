---
slug: build-wechat-web-sign-in-with-dotnet-core-razor-pages-and-logto
tags: [autenticación, wechat-web, dotnet-core-razor-pages, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Web) con .NET Core (Razor Pages)
