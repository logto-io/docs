---
slug: build-microsoft-sign-in-with-dotnet-core-blazor-server-and-logto
tags: [autenticación, microsoft, dotnet-core-blazor-server, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Microsoft con .NET Core (Blazor Server)
