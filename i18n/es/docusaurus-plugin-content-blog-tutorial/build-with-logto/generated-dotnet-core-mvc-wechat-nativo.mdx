---
slug: how-to-build-wechat-nativo-sign-in-with-dotnet-core-mvc-and-logto
tags: [autenticación, wechat-nativo, dotnet-core-mvc, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Nativo) con .NET Core (MVC)
sdk: .NET Core (MVC)
