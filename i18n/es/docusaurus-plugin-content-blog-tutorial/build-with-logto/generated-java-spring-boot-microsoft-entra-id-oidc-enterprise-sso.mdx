---
slug: build-microsoft-entra-id-oidc-enterprise-sso-sign-in-with-java-spring-boot-and-logto
tags: [SSO providers, microsoft-entra-id-oidc-enterprise-sso, java-spring-boot, java, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID OIDC enterprise SSO with Java Spring Boot
