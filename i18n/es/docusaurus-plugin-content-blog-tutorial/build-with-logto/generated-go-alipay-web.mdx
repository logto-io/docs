---
slug: build-alipay-web-sign-in-with-go-and-logto
tags: [autenticación, alipay-web, go, go, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Web) con Go
sdk: Go
