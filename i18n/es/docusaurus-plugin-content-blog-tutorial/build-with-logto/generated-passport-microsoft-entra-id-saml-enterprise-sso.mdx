---
slug: build-microsoft-entra-id-saml-enterprise-sso-sign-in-with-passport-and-logto
tags: [SSO providers, microsoft-entra-id-saml-enterprise-sso, passport, js, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID SAML enterprise SSO with Passport.js
sdk: Passport.js
...
## Integrate Passport.js SDK \{#integrate-framework-sdk}

<IntegrateSdk />

## Add Microsoft Entra ID SAML enterprise SSO connector \{#add-connector-connector}

<AddSsoConnector framework="Passport.js" />
