---
slug: build-wechat-web-sign-in-with-php-and-logto
tags: [autenticación, wechat-web, php, php, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Web) con PHP
sdk: PHP
