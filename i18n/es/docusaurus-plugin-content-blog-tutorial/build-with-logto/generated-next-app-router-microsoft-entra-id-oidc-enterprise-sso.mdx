---
slug: build-microsoft-entra-id-oidc-enterprise-sso-sign-in-with-next-app-router-and-logto
tags: [SSO providers, microsoft-entra-id-oidc-enterprise-sso, next-app-router, js, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID OIDC enterprise SSO with Next.js (App Router)
