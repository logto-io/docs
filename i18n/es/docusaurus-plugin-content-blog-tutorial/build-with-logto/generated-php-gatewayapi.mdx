---
slug: build-gatewayapi-sign-in-with-php-and-logto
tags: [autenticación, gatewayapi, php, php, inicio-de-sesión-sin-contraseña, inicio-de-sesión, login]
title: Cómo construir GatewayAPI SMS inicio de sesión sin contraseña con PHP
sdk: PHP
