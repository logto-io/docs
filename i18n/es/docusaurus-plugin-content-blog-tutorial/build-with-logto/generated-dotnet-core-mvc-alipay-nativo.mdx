---
slug: how-to-build-alipay-nativo-sign-in-with-dotnet-core-mvc-and-logto
tags: [autenticación, alipay-nativo, dotnet-core-mvc, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Alipay (Nativo) con .NET Core (MVC)
sdk: .NET Core (MVC)
