---
slug: build-kook-sign-in-with-php-and-logto
tags: [autenticación, kook, php, php, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de KOOK con PHP
sdk: PHP
connector: KOOK
---
