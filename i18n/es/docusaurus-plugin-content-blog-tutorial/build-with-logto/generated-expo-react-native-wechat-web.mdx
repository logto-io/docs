---
slug: build-wechat-web-sign-in-with-expo-react-native-and-logto
tags: [autenticación, wechat-web, expo-react-native, js, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de WeChat (Web) con Expo (React Native)
