---
slug: build-patreon-sign-in-with-dotnet-core-blazor-server-and-logto
tags: [autenticación, patreon, dotnet-core-blazor-server, c#, inicio-de-sesión-social, inicio-de-sesión, login]
title: Cómo construir el inicio de sesión de Patreon con .NET Core (Blazor Server)
