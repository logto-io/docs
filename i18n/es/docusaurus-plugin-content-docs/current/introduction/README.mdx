---
description: Lanza rápidamente tu sistema de gestión de identidad y acceso integrando Logto. Disfruta de autenticación (Autenticación), autorización (Autorización) y gestión multi-inquilino todo en uno.
---
...
¡Bienvenido a la documentación de Logto! Logto es una solución de gestión de identidad y acceso (IAM) diseñada para aplicaciones modernas y productos SaaS. Proporciona un sistema seguro, escalable y personalizable de autenticación (Autenticación) y autorización (Autorización) para tus aplicaciones.
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description:
        'El backend de Logto ofrece un conjunto de APIs para facilitar diversas funcionalidades de autenticación (Autenticación) y autorización (Autorización), incluyendo Logto Management API, Experience API y Account API.',
      customProps: {
        icon: <LogtoApiIcon />,
      },
    },
