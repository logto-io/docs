...
Una vez que crees un conector social con éxito, puedes habilitarlo como un botón de inicio de sesión social (por ejemplo, Continuar con Google) en el registro e inicio de sesión.
