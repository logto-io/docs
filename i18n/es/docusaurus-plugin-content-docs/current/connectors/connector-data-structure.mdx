...
## Almacenamiento local del conector: _ConnectorMetadata_
...
- _Social_: Conectores que pueden acceder a la información del usuario desde medios sociales de terceros arbitrarios con la autorización de los usuarios finales.
...
_description_ es también un objeto cuyas claves son códigos de país i18n y los valores son breves descripciones del conector.
...
## Almacenamiento remoto del conector: _Connector DB_
...
_createdAt_ es una cadena de marca de tiempo generada automáticamente para rastrear el momento en que un conector es creado en la base de datos.
