...
<img src="/img/assets/built-in-email-template-sample.jpeg" alt="Ejemplo de plantilla de correo electrónico incorporada" />
  ...
  <body>
    <div style="max-width: 698px; border-radius: 16px; border: 1px solid #E0E3E3;">
      <div style="padding: 0 24px;">
        <center>
          ...
          <p>
            Hemos recibido un intento de inicio de sesión con el siguiente código. Por favor, ingrésalo en la página que abriste para completar el proceso de inicio de sesión.
          </p>
          <div class="verification-code">000000</div>
          <p style="color: #747778;">
            Si no intentaste iniciar sesión pero recibiste este correo electrónico, por favor ignóralo. El código permanecerá activo durante 10 minutos.
          </p>
    ...
    <div class="footer">
      ...
      <p style="font-size: 14px; line-height: 20px; margin: 20px 0;">
        ...
        La mejor infraestructura de identidad para desarrolladores.
      </p>
