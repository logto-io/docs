...
Logto proporciona diferentes plantillas para personalizar el contenido del correo electrónico, que se categorizan según sus casos de uso.
...
Se necesita reservar un marcador de posición `{{code}}` en la plantilla. Al enviar un código de verificación, un código generado aleatoriamente reemplazará este marcador de posición antes de enviar el correo electrónico a los usuarios.
:::
...
![Muestra de plantilla de correo electrónico integrada](../assets/built-in-email-template-sample.jpeg)
...
<details>
<summary>¿Cómo usar servicios de plantillas de correo electrónico de terceros si las plantillas no están configuradas en Logto?</summary>
...
<details>
<summary>¿Hay alguna manera de usar el correo electrónico de Logto para enviar a nuestros usuarios un "correo de bienvenida" personalizado?</summary>

Ofrecemos funcionalidad de Webhook. Puedes implementar tu propio endpoint de API para recibir el evento `User.Created` enviado por el Webhook de Logto, y agregar lógica para enviar un correo de bienvenida personalizado dentro del manejador de webhook.
