...
### Paso 1: Comprueba si ya existe autorización \{#step-1-check-for-existing-authorization}
...
### Paso 2: Solicita autorización si es necesario \{#step-2-request-authorization-if-needed}
...
### Paso 3: Gestiona el callback de autorización \{#step-3-handle-the-authorization-callback}
