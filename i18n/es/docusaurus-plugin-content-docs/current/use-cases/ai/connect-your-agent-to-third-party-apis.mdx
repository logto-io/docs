...
sequenceDiagram
    ...
    rect rgba(200, 230, 200, 0.5)
        ...
        Usuario->>Agente: "Añade una reunión a mi calendario mañana a las 3pm"
    ...
    rect rgba(200, 200, 230, 0.5)
        Note over Usuario, Google: Ejecución de tarea del agente de IA
...
Antes de continuar, habilita la Account API en <CloudLink to="/sign-in-experience/account-center">Consola > Inicio de sesión y cuenta > Centro de cuentas</CloudLink>. Aprende más sobre [cómo habilitar la Account API](/end-user-flows/account-settings/by-account-api#how-to-enable-account-api).
:::
...
- **Mejor experiencia de usuario**: Los usuarios tienen más probabilidades de otorgar permisos cuando entienden por qué se necesitan en contexto.
- **Mayores tasas de conversión**: Menos permisos iniciales significan menos fricción.
- **Generación de confianza**: Los usuarios confían en aplicaciones que solo piden lo que necesitan.
