...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description:
        'Comprende la política de retención de usuarios por 90 días para tenants de desarrollo y cómo usar Logto dev tenant de manera efectiva.',
      customProps: {
        icon: <Developer />,
      },
    },
    ...
    {
      type: 'link',
      label: 'Automatiza la gestión de tenants',
