...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description:
        'Comprende la política de retención de usuarios por 90 días para el inquilino de desarrollo y cómo usar eficazmente el inquilino de desarrollo de Logto.',
      customProps: {
        icon: <Developer />,
      },
    },
    ...
    },
    {
      ...
      description:
        'Utiliza tu propio dominio para tu inquilino de Logto y mantén la coherencia de la marca en la experiencia de inicio de sesión.',
      customProps: {
        icon: <CustomDomains />,
      },
    },
