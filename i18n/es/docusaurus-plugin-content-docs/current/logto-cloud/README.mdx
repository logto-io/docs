...
[Logto Cloud](https://cloud.logto.io) ofrece una variedad de servicios de gestión y operación para ayudarte a administrar identidades y recursos de manera fluida y sencilla. Alojado por Logto, incluye características como [soporte multirregión](/logto-cloud/tenant-settings#tenant-region), gestión de inquilinos, [facturación y precios](/logto-cloud/billing-and-pricing), [gestión de miembros](/logto-cloud/tenant-member-management) y control de acceso basado en roles en la consola.

Si tienes alguna pregunta sobre los servicios en la nube y necesitas soporte adicional, por favor contáctanos.

## Funcionalidades del servicio en la nube \{#features-for-cloud-service}
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description:
        'Comprende la política de retención de usuarios por 90 días para inquilinos de desarrollo y cómo usar Logto dev tenant de manera efectiva.',
      customProps: {
        icon: <Developer />,
      },
    },
    ...
    },
    {
      ...
      description:
        'Utiliza tu propio dominio para tu inquilino de Logto y mantén la coherencia de marca en tu experiencia de inicio de sesión.',
      customProps: {
        icon: <CustomDomains />,
      },
    },
    ...
    },
    {
      ...
      description:
        'Comprende los límites del sistema y la protección de tasas para inquilinos Dev, Pro y Enterprise.',
      customProps: {
        icon: <SystemLimit />,
      },
    },
