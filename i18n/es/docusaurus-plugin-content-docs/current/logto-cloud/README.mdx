  ...
  items={[
    {
      ...
      description:
        'Actualiza o cambia el nombre del inquilino, consulta las regiones y elimina o abandona el inquilino.',
      customProps: {
        icon: <TenantSettings />,
      },
    },
    {
      ...
      description:
        'Comprende la política de retención de usuarios de 90 días para inquilinos de desarrollo y cómo usar Logto dev tenant de manera efectiva.',
      customProps: {
        icon: <Developer />,
      },
    },
    ...
    },
    {
      ...
      description:
        'Utiliza tu propio dominio para tu inquilino de Logto y mantén la coherencia de marca en la experiencia de usuario final.',
      customProps: {
        icon: <CustomDomains />,
      },
    },
