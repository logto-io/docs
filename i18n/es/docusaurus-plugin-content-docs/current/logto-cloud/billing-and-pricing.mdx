...
En Logto, nuestro plan Pro es completamente autoservicio, diseñado para la transparencia para que puedas entender y gestionar fácilmente tu facturación.
...
Por ejemplo, si estás en el plan Pro y tienes 2 servicios de SSO en uso, tu factura permanecerá consistente mientras no realices ningún cambio.

```math
\text{Tu próxima factura} = \$ 16 + \$ 48 \times 2 = \$ 112
```

### Ejemplo 2: Agregar complementos o realizar cambios afectará tus próximas facturas
...
Si tu suscripción se renueva el 5 de cada mes y agregas un SSO empresarial el 20, lo usarás durante 15 días ese mes. Si eliminas el SSO empresarial el 30, significa que solo lo usaste durante 10 días.
...
1. El 5, agregaste 4 recursos más.
2. El 15, eliminaste 2 de esos recursos.
...
### Actualización del plan gratuito al Pro
...
### Actualización del plan Pro al Enterprise

Si el plan Pro no satisface tus necesidades y estás buscando soporte completo a nivel empresarial, por favor contáctanos para discutir un plan empresarial personalizado.

### Degradación del plan Pro al plan gratuito
...
## Cambio futuro del plan de precios
