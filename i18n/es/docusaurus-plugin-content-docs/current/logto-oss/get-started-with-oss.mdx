---
description: Guías de inicio rápido para la inicialización del servicio Logto open-source (OSS).
sidebar_position: 1
---
...
La CLI de Docker Compose normalmente viene con [Docker Desktop](https://www.docker.com/products/docker-desktop).
...
Prepara una instancia de [PostgreSQL](https://www.postgresql.org/)@^14.0 y utiliza la [CLI de Logto](/logto-oss/using-cli) para sembrar una base de datos para Logto:
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description: 'Herramienta ligera para desplegar apps en tu propia infraestructura.',
      customProps: {
        icon: <DokployIcon />,
      },
    },
    ...
    },
    {
      ...
      description: 'Simplifica el despliegue de apps y la gestión de infraestructura.',
      customProps: {
        icon: <RailwayIcon />,
      },
    },
    {
      ...
      description: 'Simplifica el despliegue, escalado y monitoreo de apps para desarrolladores.',
      customProps: {
        icon: <ZeaburIcon />,
      },
    },
...
<Url href="https://blog.logto.io/local-https">Trabajando con desarrollo HTTPS local</Url>
