...
:::caution
¡No uses nuestro comando de docker compose para producción! Ya que actualmente tenemos una base de datos Postgres incorporada junto con la app de Logto en `docker-compose.yml`,
...
- Si usas PgBouncer o RDS Proxy y ves `unsupported startup parameter: statement_timeout`, establece `DATABASE_STATEMENT_TIMEOUT=DISABLE_TIMEOUT` (v1.36.0+).
...
<Url href="https://github.com/logto-io/logto/blob/master/AWESOME.md">
  Recursos increíbles de la comunidad Logto
</Url>
