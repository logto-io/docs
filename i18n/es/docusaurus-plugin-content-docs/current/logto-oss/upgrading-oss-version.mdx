...
## Paso 1: Actualizar a la nueva versión \{#step-1-update-to-the-new-version}
...
## Paso 2: Aplicar alteraciones en la base de datos \{#step-2-apply-database-alterations}
...
## Paso 3: Reiniciar la aplicación \{#step-3-restart-the-application}
