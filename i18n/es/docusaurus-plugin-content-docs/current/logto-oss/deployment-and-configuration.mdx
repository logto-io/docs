...
Utilizamos un conjunto generado de variables de entorno en nuestra demo (`docker-compose.yml`), que deberías reemplazar por las tuyas propias y mantener la coherencia entre múltiples instancias de Logto.
...
Para producción, puedes reemplazar el volumen "empty dir" por un volumen persistente y realizar el trabajo de "init" a tu manera, ¡sabes lo que haces!
...
Consulta [Alteración de base de datos](/logto-oss/using-cli/database-alteration/) para detalles sobre el comando de alteración.
