...
- `ENDPOINT` Puedes especificar una URL con tu dominio personalizado para producción (Ej. `ENDPOINT=https://logto.domain.com`). Esto también afectará el valor del [identificador de emisor OIDC](https://openid.net/specs/openid-connect-core-1_0.html#IssuerIdentifier).
...
Consulta [Alteración de la base de datos](/logto-oss/using-cli/database-alteration/) para detalles sobre el comando de alteración.
