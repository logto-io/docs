...
### Alteración de base de datos \{#database-alteration}
...
Consulta [Alteración de base de datos](/logto-oss/using-cli/database-alteration/) para más detalles sobre el comando de alteración.
