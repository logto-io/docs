...
<img src={backupCodesSetUpFlowImage} alt="Flujo de configuración de códigos de respaldo" />

- **Flujo de verificación de códigos de respaldo**

<img src={backupCodesVerificationFlowImage} alt="Flujo de verificación de códigos de respaldo" />
