...
2. Habilita los factores de verificación compatibles para tus usuarios.
   1. Factores primarios:
      - [OTP de la aplicación autenticadora](/end-user-flows/mfa/authenticator-app-otp): El método más común y ampliamente aceptado. Usa una contraseña de un solo uso basada en tiempo (TOTP) generada por una aplicación autenticadora como Google Authenticator o Authy.
