...
2. Habilita los factores de verificación compatibles para tus usuarios.
   1. Factores primarios:
      ...
      - [Verificación por correo electrónico](/end-user-flows/mfa/email-mfa): Un método ampliamente accesible que envía códigos de verificación de un solo uso al correo electrónico registrado del usuario, adecuado para usuarios en todas las plataformas y dispositivos.
