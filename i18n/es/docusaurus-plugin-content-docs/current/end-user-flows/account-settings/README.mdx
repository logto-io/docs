...
- **Funcionalidad completa**: Permite gestionar el perfil de usuario (nombre, avatar, campos de perfil personalizados), actualizar correo electrónico, teléfono, nombre de usuario, contraseña, configuración de MFA y sesiones.
...
| **Modelo de permisos**             | Activa o desactiva qué campos están habilitados mediante la configuración del Centro de Cuenta                                                                                                                                                      | Activa o desactiva qué Account APIs están habilitadas mediante la Management API                                                 | Totalmente personalizable por los desarrolladores                                                                                                                               |
| **Funciones soportadas**           | Ver y actualizar: perfil de usuario (nombre, avatar, campos de perfil personalizados), correo electrónico, teléfono, nombre de usuario, contraseña, MFA (TOTP, passkeys, códigos de respaldo), cuentas sociales, sesiones, aplicaciones autorizadas | Ver, actualizar y eliminar: nombre de usuario, correo electrónico, teléfono, contraseña, cuentas sociales, MFA, perfil, sesiones | Todas las configuraciones básicas + Eliminar / suspender / restaurar cuenta, tokens de acceso personal, suplantación de usuario, conectar aplicaciones OAuth, sesión, etc.      |
| **Personalización de la interfaz** | Hereda la marca de la experiencia de inicio de sesión; admite CSS personalizado                                                                                                                                                                     | Personalización total (construye tu propia interfaz)                                                                             | Personalización total (construye tu propia interfaz)                                                                                                                            |
