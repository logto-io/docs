...
## Componentes clave del SSO empresarial \{#do-i-need-enterprise-sso}
...
## Flujo de trabajo de SSO compatible \{#key-components-of-enterprise-sso}
...
## Protocolos de SSO compatibles \{#supported-sso-workflow}
...
## Preguntas frecuentes \{#supported-sso-protocols}

<details>
  <summary>

### ¿Cómo agregar botones de conector de SSO e iniciar sesión directamente con el proveedor de SSO en mi sitio web? \{#faqs}
...
## Recursos relacionados \{#how-to-add-sso-connector-buttons-and-directly-sign-in-with-sso-provider-on-my-website}
