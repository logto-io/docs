...
:::note
La situación de vinculación de perfiles podría ser diferente cuando el mapeo de atributos SAML no está configurado correctamente o el proveedor de identidad no proporciona el correo electrónico del usuario.
:::
...
- **Eliminación del perfil de identidad SSO del usuario**: La identidad SSO del usuario, así como los datos de perfil asociados, se eliminarán de Logto.
