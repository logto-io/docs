...
2. Agrega usuarios manualmente ingresando su dirección de correo electrónico empresarial en <CloudLink to="/users">Consola > Gestión de usuarios</CloudLink> o impórtalos mediante la [Management API](https://openapi.logto.io/operation/operation-createuser).
