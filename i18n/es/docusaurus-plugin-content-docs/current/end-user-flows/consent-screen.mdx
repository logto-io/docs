...
En una pantalla de consentimiento, generalmente se presenta a los usuarios [información](/integrate-logto/third-party-applications/oidc-oauth-third-party-applications/consent-screen-branding#customize-the-branding-information) sobre los tipos de datos que se recopilarán, cómo se utilizarán y si se compartirán con terceros. Esta información es crucial para la transparencia, permitiendo a los usuarios tomar decisiones informadas sobre su privacidad y seguridad de datos.
...
<img src={consentScreenLogtoAsSp} alt="Pantalla de consentimiento Logto como SP" />
...
<img src={consentScreenLogtoAsIdp} alt="Pantalla de consentimiento Logto como IdP" />
