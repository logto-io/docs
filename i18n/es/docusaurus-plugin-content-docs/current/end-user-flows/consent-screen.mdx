...
En una pantalla de consentimiento, a los usuarios se les presenta típicamente [información](/integrate-logto/third-party-applications/oidc-oauth-third-party-applications/consent-screen-branding#customize-the-branding-information) sobre los tipos de datos que se recopilarán, cómo se utilizarán y si se compartirán con terceros. Esta información es crucial para la transparencia, permitiendo a los usuarios tomar decisiones informadas sobre su privacidad y seguridad de datos.
