...
Por defecto, Logto mostrará una página de error genérica (por ejemplo, una página 404 de "sesión desconocida") en estos escenarios. Para mejorar la experiencia del usuario final al encontrarse con errores, necesitas configurar los siguientes parámetros:
