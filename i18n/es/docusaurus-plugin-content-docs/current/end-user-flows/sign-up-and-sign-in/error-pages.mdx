...
- **Problemas en el callback de inicio de sesión social**: La sesión social no se encuentra en una página de callback social.
- **Enlaces mágicos inválidos**: Un [token de un solo uso (enlace mágico)](/end-user-flows/one-time-token) para cosas como invitación a una organización o inicio de sesión sin contraseña ha expirado o ya fue utilizado.
