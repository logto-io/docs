...
- **Problemas con el callback de inicio de sesión social**: No se encuentra la sesión social en una página de callback social.
- **Enlaces mágicos inválidos**: Un [token de un solo uso (enlace mágico)](/end-user-flows/one-time-token) para cosas como invitación a una organización o inicio de sesión sin contraseña ha expirado o ya fue consumido.

Por defecto, Logto mostrará una página de error genérica (por ejemplo, una página 404 de "sesión desconocida") en estos escenarios. Para mejorar la experiencia del usuario final al encontrar errores, debes configurar los siguientes parámetros:

- **URL de redirección de sesión desconocida**: Una URL de respaldo a la que enviar a los usuarios cuando no se encuentra su sesión.
- **Correo de soporte y sitio web de soporte**: Información de contacto que se muestra en las páginas de error.

## URL de redirección de sesión desconocida \{#unknown-session-redirect-url}
...
- Los usuarios guardan o comparten enlaces de inicio de sesión
...
1. Ve a <CloudLink to="/sign-in-experience/sign-up-and-sign-in">Consola > Inicio de sesión y cuenta > Registro e inicio de sesión > Configuración avanzada</CloudLink>
2. Establece la "URL de redirección de sesión desconocida" a la dirección de tu servicio o la página principal de tu producto. Por ejemplo, Logto Cloud establecerá "https://cloud.logto.io".

## Información de contacto de soporte \{#support-contact-info}

Si ocurren otros errores (como visitar una ruta inválida, un callback social sin sesión, o abrir un enlace mágico expirado), Logto mostrará una página de error predeterminada. Para ayudar a los usuarios, puedes mostrar información de contacto en estas páginas de error inevitables.
...
1. Ve a <CloudLink to="/sign-in-experience/content">Consola > Inicio de sesión y cuenta > Contenido > Soporte</CloudLink>
