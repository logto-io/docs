...
- **Enlaces mágicos inválidos**: Un [token de un solo uso (enlace mágico)](/end-user-flows/one-time-token) para cosas como invitaciones a organizaciones o inicio de sesión sin contraseña ha expirado o ya fue utilizado.
