...
4. Crea y envía el **enlace mágico de invitación** [siguiendo la guía](/end-user-flows/one-time-token#implementation-guide) (solicita el token de un solo uso, compón el enlace mágico, activa la autenticación a través del Logto SDK).<br/>
...
5. Envía el enlace mágico al correo electrónico del usuario (por ejemplo, `https://yourapp.com/landing-page?type=registrationInvitation&token=YHwbXSXxQfL02IoxFqr1hGvkB13uTqcd&email=user@example.com`). Personaliza la plantilla del correo electrónico, como:
   ...
   <img
     ...
     alt="Plantilla de correo electrónico para registro solo por invitación"
   />
...
### Opción 2: Invitar y crear usuarios vía Management API \{#option-2-invite-and-create-users-via-management-api}
