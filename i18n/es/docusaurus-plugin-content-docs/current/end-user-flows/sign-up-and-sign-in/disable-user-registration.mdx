...
2. En la sección de **Opciones avanzadas**, desactiva el interruptor de **Habilitar registro de usuarios** para deshabilitar el registro de usuarios. (Habilitado por defecto)

Una vez que el registro de usuarios está deshabilitado:

- El enlace "Crear cuenta" se elimina de la página de inicio de sesión.
- La página de registro se deshabilita, y los usuarios que la visiten serán redirigidos a la página de inicio de sesión.
- El flujo de registro social y SSO empresarial también se deshabilita. Los usuarios con cuentas sociales no registradas recibirán un error de "cuenta no encontrada" después de la autenticación social.
- La función de vinculación de cuentas sociales sigue estando disponible para los usuarios que tienen una cuenta con una dirección de correo electrónico o número de teléfono coincidente en el sistema.
...
1. Deshabilita el registro de usuarios en la Consola de Logto.
...
- **Nombre de usuario / Correo electrónico / Número de teléfono con contraseña**: Crea una cuenta de usuario con un **Nombre de usuario**, **Dirección de correo electrónico** o **Número de teléfono**, y habilita el identificador correspondiente para el inicio de sesión basado en contraseña.
  - Con una contraseña preestablecida: Establece una contraseña durante la creación de la cuenta y compártela de manera segura con el usuario. El usuario puede entonces iniciar sesión directamente usando su nombre de usuario, correo electrónico o número de teléfono junto con la contraseña preestablecida, y restablecer la contraseña si lo desea.
