...
## Configurar el flujo de inicio de sesión del identificador \{#configure-the-identifier-sign-in-flow}
...
## Configurar el identificador y las configuraciones de autenticación \{#set-up-the-identifier-and-authentication-settings}

### 1. Establecer los identificadores de inicio de sesión admitidos \{#1-set-the-supported-sign-in-identifiers}
...
### 2. Establecer las configuraciones de autenticación \{#2-set-the-authentication-settings}
...
## Experiencia de usuario del flujo de inicio de sesión del identificador \{#identifier-sign-in-flow-user-experience}
...
### Ejemplo 2: Correo electrónico / Teléfono con verificación de contraseña (primaria) y código de verificación (alternativa) habilitada \{#example-2-emailphone-with-passwordprimary-and-verification-code-alternative-verification-enabled}
