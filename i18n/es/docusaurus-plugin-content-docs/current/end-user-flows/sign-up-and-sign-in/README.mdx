...
Una vez que el usuario cumple con todos los requisitos de validación y verificación, la sesión de interacción concluye con un envío de resultados al proveedor OIDC, donde el usuario está completamente autenticado y ha proporcionado su consentimiento, finalizando el proceso de inicio de sesión seguro.
...
<details>
  <summary>Método de experiencia de inicio de sesión o personalización por aplicación</summary>
...
<details>
  <summary>Limitar dominio de correo electrónico / dirección IP / región</summary>
...
<details>
  <summary>API sin interfaz para inicio de sesión y registro</summary>

Actualmente, Logto no proporciona una API sin interfaz para inicio de sesión y registro. Sin embargo, puedes traer tu propia interfaz de inicio de sesión usando la [Trae tu propia interfaz](/customization/bring-your-ui/) para personalizar la experiencia de inicio de sesión y registro.
