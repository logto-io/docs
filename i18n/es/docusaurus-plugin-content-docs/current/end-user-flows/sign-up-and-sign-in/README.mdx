...
## Métodos comunes de inicio de sesión \{#common-sign-in-methods}

Dependiendo de los requisitos de tu producto, puedes combinar múltiples métodos de inicio de sesión en la misma experiencia alojada por Logto:

- [Inicio de sesión por correo electrónico / teléfono / nombre de usuario](/end-user-flows/sign-up-and-sign-in/sign-in): Inicio de sesión clásico identificador-primero con contraseña o código de verificación.
- [Inicio de sesión social](/end-user-flows/sign-up-and-sign-in/social-sign-in): Inicia sesión con Google, GitHub, Facebook y otros proveedores sociales.
- [Inicio de sesión con passkey](/end-user-flows/sign-up-and-sign-in/passkey-sign-in): Inicio de sesión sin contraseña con passkeys de WebAuthn, incluyendo botón directo, verificación de passkey identificador-primero e inicio de sesión basado en autocompletar.
...
Para el control de acceso basado en atributos, por ejemplo, limitar el inicio de sesión según el dominio de correo electrónico, dirección IP o región, puedes usar la función de [reclamos personalizados en el token (Custom token claims)](/developers/custom-token-claims/) en Logto para rechazar o permitir solicitudes de autorización según los atributos del usuario.
...
Actualmente, Logto no proporciona una API sin interfaz para el inicio de sesión y registro. Sin embargo, puedes usar tu propia interfaz de inicio de sesión mediante la opción [Trae tu propia interfaz](/customization/bring-your-ui/) para personalizar la experiencia de inicio de sesión y registro.
