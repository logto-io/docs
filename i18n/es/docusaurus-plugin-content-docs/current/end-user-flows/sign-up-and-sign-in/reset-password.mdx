...
La función de recuperación de contraseña se habilitará automáticamente cuando tengas un [Email connector](/connectors/email-connectors) o un [SMS connector](/connectors/sms-connectors) configurado. El usuario puede restablecer su contraseña proporcionando su dirección de correo electrónico o número de teléfono registrado.
