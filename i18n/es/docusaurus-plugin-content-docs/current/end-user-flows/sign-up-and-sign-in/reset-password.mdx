...
1. **Configura los conectores**: Configura los conectores de [Correo electrónico](/connectors/email-connectors) o [SMS](/connectors/sms-connectors) en <CloudLink to="/connectors/passwordless">Consola > Conectores > Conectores de correo electrónico y SMS</CloudLink>

2. **Recopila la información de contacto del usuario**: Asegúrate de que los usuarios tengan correo electrónico / teléfono registrado durante el [registro](/end-user-flows/sign-up-and-sign-in/sign-up) o mediante la [configuración de cuenta](/end-user-flows/account-settings/by-account-api#update-or-link-new-email)

3. **Habilita los métodos de verificación**:
...
4. **Guarda y prueba**: Guarda los cambios y prueba usando el [Live Preview](/customization/live-preview)
...
3. **Ingresar correo electrónico / teléfono**: Tras hacer clic en el enlace, el usuario será redirigido a una nueva página donde podrá ingresar su dirección de correo electrónico o número de teléfono registrado.
...
6. **Ingresar nueva contraseña**: Se solicitará al usuario que ingrese una nueva contraseña una vez que el código de verificación haya sido verificado correctamente.
