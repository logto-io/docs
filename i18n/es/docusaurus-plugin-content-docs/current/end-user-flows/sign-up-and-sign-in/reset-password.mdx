...
:::note
¿No ves el enlace "¿Olvidaste tu contraseña?"? Asegúrate de tener un **Email** o **SMS** connector válido configurado.
:::
...
<img src={resetPasswordImage} alt="Flujo de restablecimiento de contraseña" />
...
Para nuevos usuarios o usuarios que están actualizando su contraseña, puedes establecer una política de contraseñas para imponer requisitos de fortaleza de contraseña. Visita el <CloudLink to="/sign-in-experience/password-policy"> Console > Sign-in experience > Password policy</CloudLink> para configurar los ajustes de la política de contraseñas.
...
3. **Verificación de historial de violaciones**: Habilita esta configuración para rechazar contraseñas que hayan sido expuestas previamente en violaciones de datos. (Impulsado por [Have I Been Pwned](https://haveibeenpwned.com/Passwords))
...
### ¿Cómo cerrar sesión a un usuario después de un restablecimiento de contraseña exitoso? \{#how-to-sign-out-a-user-after-a-successful-password-reset}
