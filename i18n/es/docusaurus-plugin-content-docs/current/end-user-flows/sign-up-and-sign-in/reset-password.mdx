...
2. **Recopila la información de contacto del usuario**: Asegúrate de que los usuarios tengan correo electrónico / teléfono registrado durante el [registro](/end-user-flows/sign-up-and-sign-in/sign-up) o mediante la [configuración de la cuenta](/end-user-flows/account-settings/by-account-api#update-or-link-new-email)
...
2. **Clic en el enlace de "¿Olvidaste tu contraseña?"**: El usuario hace clic en el enlace "¿Olvidaste tu contraseña?".
3. **Ingresar correo electrónico / teléfono**: Después de hacer clic en el enlace, el usuario será redirigido a una nueva página donde podrá ingresar su correo electrónico o número de teléfono registrado.
...
5. **Ingresar código de verificación**: El usuario ingresa el código recibido en su correo electrónico o teléfono. Logto verificará el código y la identidad del usuario asociado al correo electrónico o número de teléfono.
...
Puedes implementar tu propio flujo de restablecimiento de contraseña utilizando la **Management API** y la **Account API** de Logto. Consulta [configuración de la cuenta](/end-user-flows/account-settings/) para más detalles.
