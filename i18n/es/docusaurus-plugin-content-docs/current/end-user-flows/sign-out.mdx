...
## Cierre de sesión federado: Cierre de sesión por canal de fondo
...
<details>
  <summary>No estoy recibiendo las notificaciones de cierre de sesión por canal de fondo.</summary>
