...
- **Inicio de sesión / Registro**: Envía un magic link para inicio de sesión o registro sin contraseña por correo electrónico.
...
### Paso 1: Solicita un token de un solo uso \{#step-1-request-one-time-token}
