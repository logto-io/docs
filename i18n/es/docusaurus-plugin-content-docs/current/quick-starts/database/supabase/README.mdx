...
<img src={postsTableImage} alt="Tabla de publicaciones" />
...
<img src={supabaseApiSettingsImage} alt="Página de configuración de la API de Supabase" />
...
<img src={createGetUserIdFunctionImage} alt="Crear función para obtener el ID de usuario" />
...
<img src={createRlsPolicyImage} alt="Crear política RLS" />
...
<img src={serviceRoleSecretImage} alt="Secreto de rol de servicio" />
