...
### Sobre el inicio de sesión basado en redirección \{#regarding-redirect-based-sign-in}
...
Para aprender más sobre la lógica y los beneficios del inicio de sesión basado en redirección, consulta <MainSiteUrl href="/concepts/sign-in-experience">Experiencia de inicio de sesión de Logto explicada</MainSiteUrl>.
