...
sidebar_custom_props:
  description: Nuxt es un framework de código abierto que hace que el desarrollo web sea intuitivo y potente.
language: js
...
# Añade autenticación a tu aplicación Nuxt 3 (Add authentication to your Nuxt 3 application)
