...
# Añade autenticación a tu aplicación Webflow (Add authentication to your Webflow application)
...
1. Integrar Logto con Webflow requiere la función de "Código personalizado" de Webflow, la cual requiere al menos el plan "Básico".
2. Un sitio de Webflow, puedes usar uno existente o crear uno nuevo.
