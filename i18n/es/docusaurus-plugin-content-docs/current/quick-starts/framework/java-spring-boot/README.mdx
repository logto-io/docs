...
sidebar_custom_props:
  description: Spring Boot es un marco web para Java que permite a los desarrolladores crear aplicaciones de servidor seguras, rápidas y escalables con el lenguaje de programación Java.
...
### Añadir dependencias \{#implementation}
...
### Configuración del Cliente OAuth2 \{#scopes-and-claims}
...
## Implementación \{#further-readings}
...
La clase `WebSecurityConfig` se usará para configurar los ajustes de seguridad de tu aplicación. Es la clase clave que manejará el flujo de autenticación y autorización. Por favor, consulta la [documentación de Spring Security](https://spring.io/guides/topicals/spring-security-architecture) para más detalles.
