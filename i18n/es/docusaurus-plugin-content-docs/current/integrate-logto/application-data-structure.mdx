...
_Application ID_ es una clave única autogenerada para identificar tu aplicación en Logto, y se hace referencia como [client id](https://www.oauth.com/oauth2-servers/client-registration/client-id-secret/) en OAuth 2.0.
...
_Redirect URIs_ son una lista de URIs de redirección válidas que han sido preconfiguradas para una aplicación. Cuando un usuario inicia sesión en Logto e intenta acceder a la aplicación, es redirigido a una de las URIs permitidas especificadas en la configuración de la aplicación.
