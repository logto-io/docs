...
Logto proporciona un tipo de aplicación máquina a máquina (M2M) para habilitar la autenticación directa entre servicios, basado en el flujo de Credenciales de Cliente de OAuth 2.0:
...
sequenceDiagram
    ...
    Logto->>Servicio B: Resultado de validación del token
