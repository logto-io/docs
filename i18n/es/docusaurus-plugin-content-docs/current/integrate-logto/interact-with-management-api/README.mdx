...
En el módulo de asignación de roles, puedes ver que todos los roles M2M están incluidos, y los roles indicados con un icono de Logto significan que estos roles incluyen permisos de Logto Management API.
...
#### Cambiando el número de página y el tamaño de página \{#changing-page-number-and-page-size}
...
Logto Cloud aplica límites de tasa de ejecución a nivel de tenant para proteger la estabilidad del sistema. Para más detalles, consulta la [sección de límite de tasa del sistema](/logto-cloud/system-limit#rate-limit).
