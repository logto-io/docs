...
Algunas APIs frecuentemente utilizadas se listan a continuación:
...
Algunas de las respuestas de la API pueden incluir muchos resultados, los resultados estarán paginados. Logto proporciona 2 tipos de información de paginación.
...
- La URL de la página anterior está seguida por rel="prev".
- La URL de la página siguiente está seguida por rel="next".
- La URL de la última página está seguida por rel="last".
- La URL de la primera página está seguida por rel="first".
