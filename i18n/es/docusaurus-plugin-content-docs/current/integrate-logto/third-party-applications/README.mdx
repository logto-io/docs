...
Para restringir qué usuarios pueden iniciar sesión en una aplicación de terceros, configura el [control de acceso a nivel de aplicación](/integrate-logto/app-level-access-control) en la pestaña **Reglas** de la aplicación.
