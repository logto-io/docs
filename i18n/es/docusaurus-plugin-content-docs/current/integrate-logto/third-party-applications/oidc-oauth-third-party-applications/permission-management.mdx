---
description: Elige los alcances de autorización de la aplicación (permisos) y asegúrate de que se muestren claramente en la pantalla de consentimiento de OAuth.
...
Ve a la <CloudLink to="/applications">Consola > Aplicaciones > Página de detalles de la aplicación</CloudLink> de tu aplicación de terceros OIDC y navega a la pestaña **Permisos** y haz clic en el botón **Agregar permisos** para gestionar los permisos de tus aplicaciones de terceros.
...
### Otorgar permisos de datos de la organización \{#grant-permissions-of-organization-data}
...
Esos permisos son alcances estándar de OIDC y alcances esenciales de perfil de usuario de Logto utilizados para acceder a los reclamos de usuario. Los reclamos de usuario se devolverán en el token de ID y el endpoint de userinfo respectivamente.
...
Puedes crear y gestionar tus alcances de recursos de API en la <CloudLink to="/api-resources">Consola > Recursos de API</CloudLink>.
