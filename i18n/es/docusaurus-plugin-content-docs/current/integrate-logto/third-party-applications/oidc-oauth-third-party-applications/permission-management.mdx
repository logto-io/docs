...
Logto te permite controlar los permisos específicos otorgados a las aplicaciones de terceros. Esto incluye gestionar [perfiles de usuario](#user-permissions-user-profile-scopes), [recursos de API](#api-resource-permissions-api-resource-scopes) y [alcances de organización](#organization-permissions-organization-scopes). A diferencia de las aplicaciones de primera parte, las aplicaciones de terceros que soliciten alcances no autorizados se les negará el acceso.
