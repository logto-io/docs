...
<center>
  <img src="/img/assets/grant-permissions-of-user-data.webp" alt="otorgar permisos de datos de usuario" />
</center>
...
[Permisos de organización](/authorization/organization-template) son los alcances definidos exclusivamente para organizaciones de Logto. Se utilizan para acceder a la información y recursos de la organización.
