...
Para restringir qué usuarios autenticados pueden acceder a una Protected App, configura el [control de acceso a nivel de aplicación](/integrate-logto/app-level-access-control) en la pestaña **Rules** de la aplicación.
