...
Por lo tanto, es importante asegurar las conexiones de origen, lo que evita que los atacantes descubran y accedan a tu servidor de origen sin autenticación. Hay varias formas de hacer esto:
...
Al validar este encabezado, puedes confirmar que la solicitud proviene de la Aplicación Protegida y negar cualquier solicitud que no incluya este encabezado.
...
El JWT se llama [Token de ID](https://auth.wiki/id-token) que está firmado por Logto y contiene información del usuario. Al validar este JWT, puedes confirmar que la solicitud proviene de la Aplicación Protegida y negar cualquier solicitud que no incluya este encabezado.
...
## Obtener el estado de autenticación y la información del usuario
