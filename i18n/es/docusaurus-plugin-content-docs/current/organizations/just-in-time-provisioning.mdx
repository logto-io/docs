...
| --------------------------------------------------------------- | ----------------- | ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Invitación de administrador                                     | Nuevo y existente |              | Los usuarios pueden [recibir una invitación por correo electrónico](/end-user-flows/organization-experience/invite-organization-members) para unirse a la organización.                             |
| Creación o importación de usuario de Management API             | Nuevo y existente |              | Los usuarios pueden usar una [cuenta de usuario pre-creada](/end-user-flows/sign-up-and-sign-in/disable-user-registration#implement-an-invitation-only-sign-up-flow) para unirse a la organización. |
| Aprovisionamiento just-in-time SSO                              | Nuevo y existente | ✅           | Los usuarios que inician sesión con [SSO](/end-user-flows/enterprise-sso) por primera vez pueden unirse a la organización.                                                                          |
...
Si tienes [SSO empresarial](/end-user-flows/enterprise-sso) configurado en Logto, puedes seleccionar tu SSO empresarial de la organización para habilitar el aprovisionamiento just-in-time.
