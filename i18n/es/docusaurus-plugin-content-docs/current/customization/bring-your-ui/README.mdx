...
Esta función requiere que tu interfaz de usuario personalizada sea compatible con Aplicaciones de Página Única (SPA), y se recomienda usar siempre una versión de producción para un rendimiento óptimo.
...
Una vez que la construcción se complete, encontrarás todos los activos compilados en el directorio `dist`. Luego crea un archivo ZIP del directorio `dist`: este archivo se usará para cargarlo en Logto Cloud más tarde.

### Requisitos de los activos de interfaz de usuario personalizada

Antes de cargar tus activos de interfaz de usuario personalizada, asegúrate de que cumplan con los siguientes requisitos:

- Los activos cargados deben estar empaquetados como un único archivo zip.
...
3. Una vez que la carga se complete, guarda los cambios y tu interfaz de usuario personalizada se servirá inmediatamente.
4. La ventana de "Vista previa de inicio de sesión" se desactivará cuando uses tu interfaz de usuario de inicio de sesión personalizada. Sin embargo, aún puedes hacer clic en el botón "Vista previa en vivo" para probar tu página de inicio de sesión personalizada en una nueva pestaña del navegador.

## Desarrolla tu interfaz de usuario personalizada

### Interactúa con Experience API

Tu interfaz de usuario personalizada necesita interactuar con [Experience API](https://openapi.logto.io/group/endpoint-experience) para realizar varias acciones como iniciar sesión, registrarse, restablecer la contraseña, vincular cuentas sociales, habilitar MFA y más. Para comprender mejor los flujos de usuario y los detalles de implementación, recomendamos revisar nuestro [RFC de diseño de Experience API](https://github.com/logto-io/rfcs/blob/master/draft/0004-experience-api.md) que proporciona especificaciones técnicas completas y ejemplos.
...
Por favor, consulta [Depura y prueba tu interfaz de usuario personalizada localmente](/customization/bring-your-ui/debug-and-test-your-custom-ui-locally/) para más detalles.

## Carga tus activos de interfaz de usuario personalizada usando la CLI

Además de cargar a través de la Consola, también puedes usar Logto CLI para cargar activos de interfaz de usuario personalizada. Esto es particularmente útil para flujos de trabajo de despliegue automatizado.

Por favor, consulta [Carga de activos de interfaz de usuario personalizada usando CLI](/customization/bring-your-ui/upload-custom-ui-assets-using-cli/) para más detalles.

## Restaura a la experiencia de inicio de sesión incorporada de Logto

Si deseas restaurar la experiencia de inicio de sesión incorporada de Logto, simplemente haz clic en el botón de eliminar en la tarjeta de Bring your UI. Después de guardar los cambios, la interfaz de usuario de la experiencia de inicio de sesión volverá a la predeterminada de Logto.
...
<Url href="https://github.com/logto-io/experience-samples">Muestras de experiencia</Url>

<Url href="https://blog.logto.io/bring-your-own-ui">
  Trae tu propia interfaz de usuario de inicio de sesión a Logto Cloud
</Url>
