...
Si nuestra interfaz de ajuste fino no se alinea completamente con tu marca, utiliza CSS personalizado para adaptar tu experiencia de inicio de sesión. Simplemente agrega tu código CSS a nuestro editor y ve los cambios al instante.

## CSS personalizado en Logto Console

1. Ve a <CloudLink to="/sign-in-experience/branding">Console > Sign-in experience > Branding > Custom CSS</CloudLink>.
2. Edita el código CSS en el editor de la izquierda, se renderizará en vivo en el modal de vista previa de la derecha inmediatamente. Nota: el editor de código solo admite código CSS hasta ahora. No HTML o Javascript.
