...
| Organization.Membership.Updated | Se añaden o eliminan usuarios o aplicaciones de una organización. La carga útil incluye [campos delta de membresía](/developers/webhooks/request#organizationmembershipupdated-payload). |
