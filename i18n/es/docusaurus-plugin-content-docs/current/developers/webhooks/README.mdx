...
- **Realizar llamadas adicionales a la API**: Configura un Webhook para verificar el acceso del usuario comprobando su dominio de correo electrónico o dirección IP y luego usa la Management API de Logto para asignar roles apropiados con permisos de recursos.
