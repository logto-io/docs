...
1. Navega a <CloudLink to="/tenant-settings/oidc-configs">Consola > Claves de firma</CloudLink>. Desde allí, puedes gestionar tanto las claves privadas OIDC como las claves de cookies OIDC.
