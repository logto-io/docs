...
La suplantación de usuario permite que usuarios autorizados como Sarah actúen temporalmente en nombre de otros usuarios como Alex dentro del sistema. Esta potente función es invaluable para la resolución de problemas, la atención al cliente y la realización de tareas administrativas.
...
Ahora, la aplicación de Sarah intercambia este token de sujeto por un token de acceso que representa a Alex, especificando el recurso donde se usará el token.
