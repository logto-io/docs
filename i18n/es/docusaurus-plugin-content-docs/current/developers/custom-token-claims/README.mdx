...
## ¿Cómo funcionan los reclamos de token personalizados? \{#how-do-custom-token-claims-work}
...
sequenceDiagram
  ...
  IdP-->>IdP: Fusionar carga útil de token de acceso en bruto y reclamos de token adicionales
