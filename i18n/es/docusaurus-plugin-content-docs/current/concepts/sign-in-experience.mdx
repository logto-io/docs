...
En este caso, el usuario es redirigido automáticamente a la página de inicio de sesión de Google sin interactuar con la página de inicio de sesión de Logto. La velocidad de esta redirección automática es casi instantánea, de modo que los usuarios pueden no notar la redirección.
