...
Ahora ofrecemos guías sobre cómo usar el conector SMTP para enviar correos electrónicos siguiendo a los proveedores para tu mejor comprensión:
...
Esperamos que puedas descubrir la configuración de todos los demás proveedores de correo electrónico con los siguientes ejemplos :rocket:
...
Un [artículo oficial de Gmail](https://support.google.com/a/answer/176600) muestra cómo determinar los valores de las propiedades requeridas para operar Gmail a través de un conector SMTP.
...
### Configuración con cuenta de correo directo de Aliyun \{#configure-with-aliyun-direct-mail-account}
...
Puedes ir a la [página de dirección del servicio SMTP](https://www.alibabacloud.com/help/en/directmail/latest/smtp-service-address) para elegir un host de dirección de servicio SMTP adecuado y un número de puerto.

Para verificar las "Direcciones del remitente", puedes encontrar la entrada en el panel de navegación lateral en la [consola de DirectMail](https://dm.console.aliyun.com/). Deberías ver `Sender address` y `SMTP Password` aquí.
...
### Prueba del conector SMTP \{#test-smtp-connector}
