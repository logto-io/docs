...
## Prerrequisitos \{#test-mailgun-email-connector}

- Una cuenta de [Mailgun](https://www.mailgun.com/)
- Una clave API de tu cuenta de Mailgun, que requiere el permiso para enviar mensajes (correos electrónicos). Consulta [Where Can I Find My API Key and SMTP Credentials?](https://help.mailgun.com/hc/en-us/articles/203380100-Where-Can-I-Find-My-API-Key-and-SMTP-Credentials-) para más información.
