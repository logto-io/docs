...
Desde la [página de consola de administración de DM](https://dm.console.aliyun.com/), debes:
...
3. Completa la configuración del Conector DM de Aliyun:
   ...
   - Puedes agregar múltiples plantillas de conector DM para diferentes casos. Aquí hay un ejemplo de cómo agregar una sola plantilla:
