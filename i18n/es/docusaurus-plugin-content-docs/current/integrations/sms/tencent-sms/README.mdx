...
### Crea una cuenta de Tencent Cloud \{#references}
...
- Configura el Conector de SMS de Tencent Cloud con los siguientes campos:
  ...
  - `region`: Especifica la región admitida desde el “[Sending Documentation](https://cloud.tencent.com/document/api/382/52071#.E5.9C.B0.E5.9F.9F.E5.88.97.E8.A1.A8)” (发送文档).
...
- [¿Cómo implementar la función de código de verificación por SMS?](https://cloud.tencent.com/document/product/382/43070)
