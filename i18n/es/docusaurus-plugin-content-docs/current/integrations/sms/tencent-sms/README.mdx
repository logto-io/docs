...
1. Ve a la “[Descripción general de la consola SMS](https://console.cloud.tencent.com/smsv2)” y pasa el cursor sobre tu avatar en la esquina superior derecha. Navega a “Gestión de acceso > Claves de acceso > Claves API” para generar tu `AccessKey ID` y `AccessKey Secret` después de completar la verificación de seguridad. Por favor, consérvalos adecuadamente.
...
### Prueba el conector Tencent Cloud SMS \{#test-tencent-cloud-sms-connector}
...
Eso es todo. No olvides <MainSiteUrl href="/connectors/sms-connectors#enable-phone-number-for-end-user-flows">Habilitar el conector en el registro e inicio de sesión</MainSiteUrl>.
