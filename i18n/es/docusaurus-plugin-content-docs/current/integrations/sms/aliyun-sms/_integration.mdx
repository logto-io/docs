...
5. Añade firma y plantilla siguiendo las pautas, y proporciona los materiales o información requeridos para la revisión.
...
3. Completa la configuración del Aliyun SMS Connector:
...
Puedes escribir un número de teléfono y hacer clic en "Enviar" para ver si la configuración funciona antes de "Guardar y Listo".
