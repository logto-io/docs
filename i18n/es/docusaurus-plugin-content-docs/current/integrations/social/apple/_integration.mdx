...
<img src={enableSignInWithAppleInXcodeImage} alt="Habilitar inicio de sesión con Apple" />
...
<img src={enableSignInWithAppleImage} alt="Habilitar inicio de sesión con Apple" />
...
<img src={domainAndUrlImage} alt="Dominio y URL" />
