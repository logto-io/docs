## Crear una aplicación web en la Plataforma Abierta de WeChat \{#create-a-web-app-in-the-wechat-open-platform}
...
Después de completar la información del sitio web, haz clic en "Submit Review" para continuar. Por lo general, la revisión es rápida y termina en 1-2 días.
