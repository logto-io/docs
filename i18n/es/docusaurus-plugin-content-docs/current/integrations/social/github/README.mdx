...
# Configura el inicio de sesión social con GitHub a través de OAuth App

Integra GitHub OAuth App para habilitar el inicio de sesión con GitHub, vinculación de cuentas y acceso seguro a las APIs de GitHub.
...
- Acceder a las APIs de GitHub mediante el almacenamiento seguro de tokens en Logto Secret Vault para tareas de automatización (por ejemplo, crear incidencias en GitHub, gestionar repositorios desde tu aplicación)
...
Una vez que hayas creado un conector de GitHub y lo hayas conectado con GitHub, puedes incorporarlo en tus flujos de usuario final. Elige las opciones que se adapten a tus necesidades:
...
<Url href="https://docs.github.com/en/apps/oauth-apps/building-oauth-apps/scopes-for-oauth-apps">
  Documentación de alcances para OAuth App de GitHub
</Url>
