...
### Habilita el botón de inicio de sesión social \{#enable-social-sign-in-button}
...
### Accede a las APIs del proveedor de identidad y realiza acciones \{#access-identity-provider-apis-and-perform-actions}
...
## Gestiona la identidad social del usuario \{#manage-user-s-social-identity}
...
3. En esta página, los administradores pueden gestionar la conexión social del usuario, ver toda la información de perfil otorgada y sincronizada desde su cuenta social, y comprobar el estado del token de acceso.
