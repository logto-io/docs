...
sidebar_custom_props:
  description: Google es una tecnología principal de motor de búsqueda y proveedor de servicios de correo electrónico.
...
Utiliza la Account API para construir un Centro de Cuenta personalizado en tu app que permita a los usuarios autenticados vincular o desvincular su cuenta de Google. [Sigue el tutorial de Account API](/end-user-flows/account-settings/by-account-api#link-a-new-social-connection)

:::tip
Se permite habilitar el conector de Google solo para vinculación de cuentas y acceso a API, sin habilitarlo para el inicio de sesión social.
:::
