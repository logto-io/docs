...
## Configurar los ajustes del conector Logto Alipay Native \{#set-up-the-logto-alipay-native-connector-settings}
...
![Añadir framework](./assets/add-framework.png)
...
Donde `callbackScheme` es uno de los [esquemas de URL personalizados](https://developer.apple.com/documentation/xcode/defining-a-custom-url-scheme-for-your-app) que pueden navegar a tu aplicación.
