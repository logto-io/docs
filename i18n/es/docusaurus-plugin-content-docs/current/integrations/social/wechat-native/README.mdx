...
<img src={createMobileAppImage} alt="Crear aplicación móvil" />
...
<img src={platformImage} alt="Plataforma de la aplicación" />
...
<img src={platformAndroidAppImage} alt="Plataforma de la aplicación Android" />
...
<img src={universalLinkImage} alt="Enlace universal" />
...
<img src={customUrlSchemeImage} alt="Esquema de URL personalizado" />
...
<img src={addFrameworkImage} alt="Agregar framework" />

Y agrega `-ObjC` a tus Build Settings > Linking > Other Linker Flags:

<img src={linkerFlagsImage} alt="Flags del linker" />
