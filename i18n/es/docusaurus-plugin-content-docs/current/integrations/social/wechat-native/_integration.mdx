...
Suponemos que ya has integrado el <MainSiteUrl href="/quick-starts/swift">Logto iOS SDK</MainSiteUrl> en tu app. En este caso, las cosas son bastante simples y ni siquiera necesitas leer la documentación del SDK de WeChat:
...
Suponemos que ya has integrado el <MainSiteUrl href="/quick-starts/android">Logto Android SDK</MainSiteUrl> en tu app. En este caso, las cosas son bastante simples y ni siquiera necesitas leer la documentación del SDK de WeChat:
