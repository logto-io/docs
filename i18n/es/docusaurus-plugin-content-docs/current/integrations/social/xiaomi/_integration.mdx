...
| --------------- | ----------------------------------------------------- | ------------- |
| 1               | Obtener perfil del usuario                            | user/profile  |
| 3               | Obtener open_id del usuario                           | user/openIdV2 |
...
| 7000            | Seguir cuenta de servicio de Páginas Amarillas        | Mi Cloud      |
...
| 40000           | Habilitar el servicio de IA en la nube                | Internal Use  |
...
Eso es todo. No olvides [habilitar el inicio de sesión social](https://docs.logto.io/connectors/social-connectors#enable-social-sign-in) en el registro e inicio de sesión.
