...
<img src={organizationTemplate} alt="Resumen de la plantilla de organización" style={{ width: '100%' }} />
<center>
  <figcaption>
    <i>
      Este diagrama ilustra cómo los roles de organización, permisos y recursos de API se conectan en una
      plantilla de organización de Logto.
    </i>
  </figcaption>
</center>
