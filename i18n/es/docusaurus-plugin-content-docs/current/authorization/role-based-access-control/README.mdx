...
El control de acceso basado en roles (RBAC) es un método de asignación de permisos a los usuarios basado en sus roles. Considera usar RBAC en los siguientes escenarios:
...
<img src={bookstoreSetupImage} width="60%" alt="API de Librería y Permisos" />
...
<img src={bookstoreRolesImage} width="60%" alt="Roles de Librería" />
