...
El [control de acceso basado en roles (RBAC)](https://auth.wiki/rbac) es un método de asignación de permisos a los usuarios basado en sus roles. Considera usar RBAC en los siguientes escenarios:
...
<img src={permissionsImage} width="60%" alt="Permisos" />
...
<img src={roleOrderAdminImage} width="60%" alt="Rol de Administrador de Pedidos" />
...
<img src={bookstoreSetupImage} width="60%" alt="API y Permisos de la Librería" />
...
- **_Administrador de productos_** puede gestionar productos, y no deben estar al tanto de ningún pedido.
...
<img src={bookstoreRolesImage} width="60%" alt="Roles de la Librería" />
...
Nota que el administrador de pedidos comparte el permiso `read:product` con el administrador de productos, y los permisos finales que un usuario posee son la unión de todos los permisos de los roles que se le han asignado.
...
<Url href="https://blog.logto.io/ciam-102-authz-and-rbac">
  CIAM 102: Autorización & Control de Acceso Basado en Roles
</Url>
