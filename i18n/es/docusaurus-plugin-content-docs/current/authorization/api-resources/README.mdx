...
Por defecto, este recurso de API está pre-registrado en tu servicio Logto. Todas las Management APIs bajo este URI están protegidas por Logto.

## Esquema de recurso de API de Logto

| **Nombre de la propiedad**                                                                                                                                                                                                               | **Descripción de la propiedad**                                                                                                          | **Requerido** |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| Nombre de la API                                                                                                                                                                                                                         | Un nombre amigable que te ayude a identificar el recurso de API.                                                                         | true          |
