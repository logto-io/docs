...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description: 'Controla acciones y características de UI específicas de la organización con roles de organización.',
      customProps: {
        icon: <Users />,
      },
    },
    ...
    },
    {
      ...
      description: 'Aprende cómo añadir reclamos personalizados para escenarios avanzados de control de acceso.',
      customProps: {
        icon: <Jwt />,
      },
    },
