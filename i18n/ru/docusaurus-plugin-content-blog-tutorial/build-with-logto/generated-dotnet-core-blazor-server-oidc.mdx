...
tags: [аутентификация, oidc, dotnet-core-blazor-server, c#, социальный вход, вход, логин]
title: Как создать вход через OIDC с использованием .NET Core (Blazor Server)
