...
tags: [аутентификация, saml, dotnet-core-blazor-server, c#, социальный вход, вход, логин]
title: Как создать вход через SAML с использованием .NET Core (Blazor Server)
