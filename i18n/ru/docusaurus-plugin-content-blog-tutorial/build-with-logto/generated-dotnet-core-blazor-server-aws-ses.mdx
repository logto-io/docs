...
tags: [аутентификация, aws-ses, dotnet-core-blazor-server, c#, вход без пароля, вход, логин]
title: Как создать AWS SES Email вход без пароля с .NET Core (Blazor Server)
