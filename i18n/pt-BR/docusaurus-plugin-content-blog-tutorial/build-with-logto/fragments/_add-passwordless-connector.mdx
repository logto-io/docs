...
2. Para adicionar um novo conector {props.connectorType}, clique no botão "Configurar" e selecione "{props.connector}".
3. Revise a documentação README para o provedor selecionado.
4. Complete os campos de configuração na seção "Configuração de Parâmetros".
...
<img src={connectorTabPasswordlessImage} alt="Aba do conector" />

:::note
Se você estiver seguindo o guia de Conector no local, pode pular a próxima seção.
:::
