...
tags: [autenticação, hugging-face, python, python, social-sign-in, sign-in, login]
title: Como construir login Hugging Face com Python
sdk: Python
...
## Integrar SDK Flask \{#integrate-framework-sdk}
