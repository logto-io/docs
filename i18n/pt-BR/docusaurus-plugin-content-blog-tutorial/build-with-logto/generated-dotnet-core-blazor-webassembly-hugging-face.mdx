...
tags: [autenticação, hugging-face, dotnet-core-blazor-webassembly, c#, social-sign-in, sign-in, login]
title: Como construir login Hugging Face com .NET Core (Blazor WebAssembly)
...
## Integrar SDK .NET Core (Blazor WebAssembly) \{#integrate-framework-sdk}
