...
tags: [autenticação, azure-ad, dotnet-core-blazor-webassembly, c#, social-sign-in, sign-in, login]
title: Como construir login Azure AD com .NET Core (Blazor WebAssembly)
