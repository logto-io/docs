...
tags: [autenticação, discord, dotnet-core-blazor-webassembly, c#, social-sign-in, sign-in, login]
title: Como construir login Discord com .NET Core (Blazor WebAssembly)
...
import ConnectorGuide from '@site/i18n/pt-BR/docusaurus-plugin-content-docs/current/integrations/social/discord/_integration.mdx';
...
## Ativar conector Discord na Experiência de Login \{#enable-connector-connector-in-sign-in-experience}
