...
authors: logto
tags: [autenticação, oauth2, dotnet-core-blazor-webassembly, c#, social-sign-in, sign-in, login]
title: Como construir login OAuth2 com .NET Core (Blazor WebAssembly)
---
...
import ConnectorGuide from '@site/i18n/pt-BR/docusaurus-plugin-content-docs/current/integrations/social/oauth2/_integration.mdx';
...
## Ativar conector OAuth2 na Experiência de Login \{#enable-connector-connector-in-sign-in-experience}
