...
title: Como construir SAML enterprise SSO com .NET Core (Blazor WebAssembly)
...
## Adicionar conector SAML enterprise SSO \{#add-connector-connector}

<AddSsoConnector framework=".NET Core (Blazor WebAssembly)" />

## Configurar SAML SSO application on your IdP \{#set-up-connectorconfigname}
...
## Ativar conector SAML enterprise SSO na Experiência de Login \{#enable-connector-connector-in-sign-in-experience}
