...
A [solução de autenticação única (SSO)](/end-user-flows/enterprise-sso) do Logto simplifica o gerenciamento de acesso para seus clientes corporativos. Os conectores de SSO corporativo são cruciais para habilitar o SSO para seus diferentes clientes empresariais.
...
5. Personalize a experiência de SSO e **domínio de email** na guia "Experiência".
