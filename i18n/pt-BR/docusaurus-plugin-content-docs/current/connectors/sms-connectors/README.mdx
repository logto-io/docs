...
5. Personalize o modelo de SMS usando o editor JSON.
...
## Habilitar número de telefone para fluxos do usuário final \{#enable-phone-number-for-end-user-flows}
...
- [**Configurar SMS para MFA**](/end-user-flows/mfa/sms-mfa): Vá para <CloudLink to="/mfa">Console &gt; Autenticação multifatorial</CloudLink>. Habilite "Código de verificação por SMS" como segundo fator para maior segurança.
