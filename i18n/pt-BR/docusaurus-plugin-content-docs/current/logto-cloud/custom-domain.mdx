...
2. Na seção "Domínio Personalizado", insira o nome do seu domínio e clique em "adicionar domínio".
   ...
   <img src={customDomainSectionImage} alt="Adicionar domínio" />

3. Copie o valor CNAME na tabela e vá para o provedor de DNS do seu domínio para adicionar o registro.

   <img src={customDomainProcessingImage} alt="Processamento de domínio personalizado" />
...
<img src={customDomainAddedImage} alt="Domínio personalizado adicionado" />
