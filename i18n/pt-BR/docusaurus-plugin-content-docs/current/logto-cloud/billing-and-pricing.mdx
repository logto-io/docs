...
No console, você encontrará uma seção "Sua próxima fatura" na seção de configurações do tenant, onde pode monitorar e controlar suas cobranças futuras.

![Informações da próxima fatura](./assets/next-billing-info.png)
...
|                                                              | Cota gratuita | Custo adicional                |
| ------------------------------------------------------------ | ------------- | ------------------------------ |
| **Tokens (Tokens)**                                          | 1 milhão      | $80 **_por milhão_** de tokens |
| **Aplicativos máquina para máquina**                         | 1             | $8 **_cada_** por mês          |
| **Recursos de API (API resources)**                          | 3             | $4 **_cada_** por mês          |
| **SSO corporativo (Enterprise SSO)**                         | 0             | $48 **_cada_** por mês         |
| **Autenticação multifatorial (Multi-factor authentication)** | _N/A_         | $48 por mês                    |
| **Organização (Organization)**                               | _N/A_         | $48 por mês                    |
...
2. **quantidade adicionada**: A quantidade de complemento que o usuário adicionou no ciclo de faturamento **_atual_**
3. **quantidade removida**: A quantidade de complemento que o usuário removeu no ciclo de faturamento **_atual_**
...
### Exemplo 1: Faturamento consistente sem alterações
...
### Exemplo 2: Adicionar complementos ou fazer alterações afetará suas próximas faturas
...
Se sua assinatura for renovada no dia 5 de cada mês e você adicionar um SSO corporativo no dia 20, você o usará por 15 dias naquele mês. Se você excluir o SSO corporativo no dia 30, significa que você o usou por apenas 10 dias.
...
Neste caso, você atualizou os recursos de complemento durante este ciclo de faturamento, então as alterações aparecerão na sua próxima fatura. O primeiro mês após a alteração pode ser ligeiramente superior. Sua fatura incluirá o preço base de $16, custos de complementos para uso não faturado e a cobrança total para o próximo ciclo recorrente.
...
### Como é determinado o tempo de uso do complemento?

Usamos um modelo pay-as-you-go, e você pode se perguntar o que acontece se você frequentemente adicionar ou remover recursos. O complemento é considerado em uso pelo tempo exato em que está ativo. Não se preocupe—nosso sistema, alimentado pelo Stripe, calcula seu uso até o segundo, garantindo faturamento preciso com base exatamente em quanto tempo cada recurso está em uso.
...
### Upgrade do plano gratuito para o Pro

Upgrades e downgrades se aplicam apenas ao tenant de produção. Aqui estão situações em que você pode precisar considerar o upgrade do plano gratuito:

1. Se seu uso de MAU ou Token exceder a cota, enviaremos um alerta por email no momento apropriado, notificando você sobre a necessidade de upgrade.
2. Se você quiser acessar recursos disponíveis apenas no plano premium.

### Upgrade do plano Pro para o Enterprise
...
### Downgrade do plano Pro para o plano gratuito

Se você optar por parar de usar o plano Pro, poderá mudar para o plano gratuito, mas precisará ajustar seu uso para se adequar à cota do plano gratuito.

## Mudança futura no plano de preços

Para fornecer a você uma experiência de faturamento estável e previsível, manteremos seu plano atual sempre que ocorrerem mudanças nos preços.
