...
No Logto, nosso plano Pro é totalmente self-service, projetado para transparência para que você possa entender e gerenciar facilmente seu faturamento.
...
No console, você encontrará uma seção "Sua próxima fatura" na seção de configuração do locatário, onde pode monitorar e controlar suas cobranças futuras.
...
| ------------------------------------ | ------------- | ------------------------------ |
| **Tokens**                           | 1 milhão      | $80 **_por milhão_** de tokens |
...
Se o plano Pro não atender às suas necessidades e você estiver procurando por suporte completo em nível empresarial, entre em contato conosco para discutir um plano empresarial personalizado.
...
Para fornecer a você uma experiência de faturamento estável e previsível, manteremos seu plano atual sempre que ocorrerem alterações nos preços.
