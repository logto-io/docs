...
1. **Limitação do método de login**: Códigos de verificação por email não podem ser usados simultaneamente como [método de login (1FA)](/end-user-flows/sign-up-and-sign-in/sign-in) e como fator de MFA (2FA). Escolha um fluxo de autenticação por email por implementação.
