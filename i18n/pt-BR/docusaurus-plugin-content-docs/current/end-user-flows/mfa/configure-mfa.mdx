...
O Logto oferece opções flexíveis de configuração de MFA para atender a diferentes requisitos de segurança. Você pode configurar o MFA em nível global para todos os usuários ou habilitá-lo por organização para aplicações multi-inquilino.
...
Uma vez que o MFA está habilitado, os usuários serão solicitados a configurar o MFA durante o processo de login e cadastro. Os usuários podem optar por pular esse processo de configuração se, e somente se, a política “Exigir MFA” estiver desabilitada.
...
- Se o usuário configurou múltiplos fatores para 2FA, o sistema apresentará opções de verificação com base nas seguintes regras de prioridade:
  ...
  - **Preferência pelo último uso**: Se não houver passkey disponível, o sistema priorizará o método de verificação que o usuário usou com sucesso pela última vez.
