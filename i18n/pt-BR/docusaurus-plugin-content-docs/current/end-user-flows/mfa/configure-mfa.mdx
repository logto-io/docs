...
<img src={configureMfaImage} alt="Configurações de MFA" />
...
<img src={linkMfaImage} alt="Fluxo de configuração do MFA" />
...
<img src={verifyMfaImage} alt="Fluxo de verificação do MFA" />
