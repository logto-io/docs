...
6. **Palavras personalizadas**: Forneça uma lista de palavras personalizadas (insensíveis a maiúsculas e minúsculas) que você deseja rejeitar na senha.
...
Você pode implementar seu próprio fluxo de redefinição de senha usando o **Management API** e **Account API** do Logto. Confira as [configurações da conta](/end-user-flows/account-settings/) para mais detalhes.
