...
<img src={signInExperienceSignUpImage} alt="configuração de cadastro" />
...
- **Não aplicável**: Nenhum identificador de cadastro está habilitado. Isso se aplica aos métodos de cadastro [social](/end-user-flows/sign-up-and-sign-in/social-sign-in) ou [SSO corporativo (Enterprise SSO)](/end-user-flows/enterprise-sso) apenas.
...
<img src={signUpUsernamePasswordImage} alt="Cadastro com nome de usuário e senha" />
...
<img src={signUpEmailVerificationImage} alt="Cadastro com email ou telefone com verificação" />
...
<img src={signUpEmailPasswordImage} alt="Cadastro com email, verificação e criação de senha" />
