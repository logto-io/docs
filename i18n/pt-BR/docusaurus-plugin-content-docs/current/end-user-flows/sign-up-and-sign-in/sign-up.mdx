...
<img
  ...
  alt="Cadastro com email ou telefone com verificação"
/>
...
## Cadastro com social ou SSO corporativo \{#type-4-email-address-with-verification-username-and-password-creation}
...
### Coletar informações adicionais do usuário no cadastro \{#faqs}
...
### Usuários criados por administradores / Usuários convidados \{#collect-additional-user-information-on-sign-up}
...
### Formulários de cadastro incorporados em seu site \{#admin-created-users--invited-users}
...
### Enviando emails de boas-vindas para novos usuários \{#embedded-sign-up-forms-on-your-website}
...
### Pular verificação de email no cadastro \{#sending-welcome-emails-to-new-users}
