...
## Configurar o identificador e as configurações de autenticação \{#set-up-the-identifier-and-authentication-settings}
...
### Exemplo 2: Email/Telefone com senha (primária) e código de verificação (alternativa) habilitados \{#example-2-emailphone-with-passwordprimary-and-verification-code-alternative-verification-enabled}
