...
- **Problemas no callback de login social**: A sessão social não foi encontrada em uma página de callback social.
...
- **URL de redirecionamento para sessão desconhecida**: Uma URL de fallback para onde os usuários serão enviados quando a sessão deles não for encontrada.
...
Isso garante que, mesmo quando algo dá errado, os usuários tenham uma maneira clara de obter ajuda.
