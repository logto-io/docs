...
1. Desative o registro de usuários no Console do Logto.
...
4. Quando o usuário clicar no link de registro, faça com que seu aplicativo chame a Management API do Logto para criar a conta do usuário.
...
1. Desative o registro de usuários no Console do Logto.
2. Crie manualmente contas de usuário no <CloudLink to="/users">Console > Gerenciamento de usuários</CloudLink> ou via Management API.
