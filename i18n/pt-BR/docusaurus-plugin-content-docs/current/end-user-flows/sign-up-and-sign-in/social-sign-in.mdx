...
## Coletar dados adicionais do perfil do usuário \{#collect-additional-user-profile-data}
...
### Por que meus emails ou números de telefone não são preenchidos após o registro com social? \{#why-my-emails-or-phone-numbers-are-not-populated-after-signing-up-with-social}
