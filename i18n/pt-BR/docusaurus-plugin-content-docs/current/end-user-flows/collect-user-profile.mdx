...
Além dos identificadores de autenticação e credenciais necessários para o login do usuário, seu aplicativo pode precisar coletar informações adicionais do perfil do usuário armazenadas no Logto para fácil recuperação via reivindicações JWT ou APIs, a fim de fornecer experiências de produto personalizadas. Você pode coletar dados do usuário pelos seguintes métodos:

- **Durante o novo registro de usuário**: Use o recurso [Coletar perfil do usuário](#quick-start) para adicionar uma etapa pronta chamada "Conte-nos sobre você" que coleta informações adicionais do perfil do usuário durante o cadastro. Novos usuários devem preencher todos os campos obrigatórios antes que o registro seja considerado concluído. Este documento foca nessa abordagem.
...
O recurso **Coletar perfil do usuário** permite que você reúna informações adicionais do usuário durante a experiência de registro do usuário final. Recomendamos coletar apenas as informações essenciais necessárias para o seu produto, evitando fluxos de cadastro longos que podem impactar as taxas de conversão.
...
1. Vá para <CloudLink to="/sign-in-experience/collect-user-profile">Console Logto > Login & conta > Coletar perfil do usuário</CloudLink>.
...
4. Volte para Login & conta > Coletar perfil do usuário, arraste e solte os campos para reordená-los, e as alterações serão aplicadas automaticamente.
...
| Perfil              | <code>user.profile.profile</code>                                                                                                                                                                                                                                                               | URL da página de perfil legível do usuário (ex: perfil em rede social).                                                                                                                                                 |
...
Você pode sobrescrever esses rótulos fornecendo suas próprias traduções em [Logto > Login & conta > Conteúdo](https://cloud.logto.io/to/sign-in-experience/content)
...
Não, eles coletam apenas informações da etapa final do novo cadastro de usuário.
