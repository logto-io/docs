...
- **Após o cadastro do usuário**: Use a [Account API](/end-user-flows/account-settings/by-account-api) para implementar experiências de autoatendimento durante fluxos de onboarding, centros de conta ou ao longo da jornada de uso do produto para atualizar informações do perfil do usuário.
...
1. Acesse <CloudLink to="/sign-in-experience/collect-user-profile">Console Logto > Experiência de Login > Coletar perfil do usuário</CloudLink>.
...
| Nome do campo (13%) | Chave do dado do usuário (44%)                                                                                                                                                                                                                                                                  | Descrição                                                                                                                                                                                                               |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| Data                   | Formato da data (pré-definido / personalizado) | Escolha formatos pré-definidos (MM/dd/aaaa, dd/MM/aaaa, aaaa-MM-dd). Alterar o placeholder substitui interações padrão. Ou use padrões totalmente personalizáveis do <a href="https://date-fns.org/v2.30.0/docs/format" target="_blank" rel="noopener noreferrer">date-fns</a>. |
...
Você pode substituir esses rótulos fornecendo suas próprias traduções em [Logto > Experiência de Login > Conteúdo](https://cloud.logto.io/to/sign-in-experience/content)
...
| GET          | <code>/api/custom-profile-fields/:name</code>                | Buscar definição de campo único por nome.             |
...
| PUT          | <code>/api/custom-profile-fields/:name</code>                | Atualizar campo por nome e conjunto completo.         |
