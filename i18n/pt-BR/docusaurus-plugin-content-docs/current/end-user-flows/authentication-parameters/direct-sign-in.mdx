...
### Onde encontrar o nome do conector IdP \{#where-to-find-the-connector-idp-name}
...
### O login direto é o mesmo que a autenticação via API? \{#is-direct-sign-in-the-same-as-api-authentication}
