...
Por exemplo, enviar usuários diretamente para o formulário de login do SSO corporativo:
...
Por exemplo, pré-preencher o endereço de email coletado no formulário de login:
