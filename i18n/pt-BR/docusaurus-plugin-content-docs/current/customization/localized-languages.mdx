...
<details>
  <summary>E se o idioma que adicionei se tornar um idioma fornecido pelo Logto?</summary>
...
<details>
  <summary>E se eu adicionar apenas alguns valores personalizados?</summary>

O que os usuários finais veem é o resultado da fusão das duas colunas.
Suponha que você queira fazer ajustes apenas em um subconjunto das cópias de conteúdo original fornecidas pelo Logto. A única diferença entre sua tela de inscrição e a fornecida pelo Logto serão as chaves que você editou. O restante do conteúdo permanecerá inalterado.
