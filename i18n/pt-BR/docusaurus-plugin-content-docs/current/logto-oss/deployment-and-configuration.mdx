...
Usamos um conjunto gerado de variáveis de ambiente em nosso demo (`docker-compose.yml`), que você deve substituir pelas suas próprias e manter a consistência entre várias instâncias do Logto.
