...
Para iniciar um workspace online do GitPod para o Logto, <a href="https://gitpod.io/#https://github.com/logto-io/demo" target="_blank" rel="noopener">clique aqui</a>. Aguarde alguns instantes e você verá uma mensagem como:
...
Observe que não fornecemos suporte ao cliente para provedores de serviços de terceiros. Para acessar nossos canais de suporte, faça a implantação no [Logto Cloud](https://cloud.logto.io). Obrigado!
