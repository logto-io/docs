...
Todos os aplicativos de terceiros serão catalogados na página **Aplicativos**, especificamente na guia **Apps de terceiros**. Essa organização os distingue dos aplicativos de primeira parte, garantindo uma gestão fácil.
