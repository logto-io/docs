...
Para buscar um token de acesso para um recurso de API em uma organização, você pode usar o método `GetAccessTokenWithOptions` com o recurso de API e o ID da organização como parâmetros:
