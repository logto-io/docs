...
### Instalar o plugin \{#authentication-settings}
...
### Configurar URI de redirecionamento \{#extra-params}
...
### Ponto de verificação: Teste seu site WordPress \{#require-verified-email}
...
## Configurações de autenticação \{#require-organization-id}
...
### Escopos \{#authorization-settings}
...
### Parâmetros extras \{#role-mapping}
...
### Exigir email verificado \{#advanced-settings}
...
### Exigir ID da organização \{#remember-session}
...
## Configurações de autorização \{#sync-profile}
...
### Mapeamento de papéis \{#wordpress-form-login}
...
## Configurações avançadas \{#username-strategy}

### Lembrar sessão \{#troubleshooting}
...
### Login com formulário do WordPress \{#frequently-asked-questions}
...
### Estratégia de nome de usuário \{#how-can-i-trigger-the-forgot-password-flow}
...
## Solução de problemas \{#how-can-i-use-the-wordpress-form-login}

### URL de callback mostra 404 \{#further-readings}
