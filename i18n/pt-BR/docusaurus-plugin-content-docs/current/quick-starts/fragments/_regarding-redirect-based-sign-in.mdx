...
### Sobre o login baseado em redirecionamento \{#regarding-redirect-based-sign-in}
...
Para saber mais sobre a lógica e os benefícios do login baseado em redirecionamento, veja <MainSiteUrl href="/concepts/sign-in-experience">Experiência de login do Logto explicada</MainSiteUrl>.
