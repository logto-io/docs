...
<img src={hasuraApiWithScopesImage} alt="Hasura API com escopos" />

<img src={userReaderRoleImage} alt="Papel de leitor de usuário" />

<img src={userMaintainerRoleImage} alt="Papel de mantenedor de usuário" />
...
<img src={hasuraJwtConfigImage} alt="Configuração JWT do Hasura" />
...
<img src={userAccessTokenScriptImage} alt="Script de token de acesso do usuário" />
...
<img src={userWithRolesImage} alt="Usuário com papéis" />
