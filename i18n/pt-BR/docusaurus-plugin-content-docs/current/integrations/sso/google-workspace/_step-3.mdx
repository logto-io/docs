...
<img src={googleWorkspaceCreateCredentialsImage} alt="Google Workspace criar credenciais" />

Continue configurando a credencial OAuth preenchendo as seguintes informações:

<img
  src={googleWorkspaceCredentialsConfigImage}
  alt="Configuração de credenciais do Google Workspace"
/>
