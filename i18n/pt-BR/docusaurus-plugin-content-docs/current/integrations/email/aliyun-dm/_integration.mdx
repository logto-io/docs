...
Acesse a [página do console do serviço DM](https://www.aliyun.com/product/directmail) e faça login. Ative o serviço Direct Mail clicando no botão "Apply to enable" (申请开通) no canto superior esquerdo da página e inicie o processo de configuração.
