...
- _Aliyun direct mail_ e _SendGrid mail_. Alguns de vocês podem estar familiarizados com esses dois provedores de serviço de email porque a equipe Logto forneceu conectores correspondentes; você provavelmente terá uma ideia geral sobre eles.
...
### Integrar com SendGrid SMTP API \{#integrate-with-sendgrid-smtp-api}
...
Você pode encontrar um guia passo a passo sobre ["Integrando com a SMTP API"](https://docs.sendgrid.com/for-developers/sending-email/integrating-with-the-smtp-api).

Os desenvolvedores podem acessar os detalhes do _remetente_ em ["Gerenciamento de Remetente"](https://mc.sendgrid.com/senders).

### Configurar com conta Aliyun direct mail \{#configure-with-aliyun-direct-mail-account}
...
Você pode ir para a [página de endereço de serviço SMTP](https://www.alibabacloud.com/help/en/directmail/latest/smtp-service-address) para escolher um host de endereço de serviço SMTP adequado e número de porta.
...
Você deve alterar os valores envolvidos com "\<" e ">" de acordo com as configurações de sua conta Gmail, SendGrid ou Aliyun e optar por manter outros campos sem "\<" e ">".
