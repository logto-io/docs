...
Assumimos que você já integrou o [Logto iOS SDK](/quick-starts/swift) no seu app. Nesse caso, tudo é bem simples, e você nem precisa ler a documentação do SDK Alipay:
...
Assumimos que você já integrou o [Logto Android SDK](/quick-starts/android) no seu app. Nesse caso, tudo é bem simples, e você nem precisa ler a documentação do SDK Alipay:
