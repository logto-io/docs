...
Este conector é apenas para aplicativos web. Se você está procurando o método para fazer login com WeChat em aplicativos nativos, consulte [conector nativo do WeChat](/integrations/wechat-native).
