...
> 💡 **Dica**
>
> O WeChat requer link universal para login nativo. Se você não configurou ou não sabe o que é, consulte o [documento oficial da Apple](https://developer.apple.com/ios/universal-links/).
...
Depois vá para a aba "Info", adicione um [esquema de URL personalizado](https://developer.apple.com/documentation/xcode/defining-a-custom-url-scheme-for-your-app) com o ID do aplicativo WeChat.
