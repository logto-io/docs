...
Assumimos que você já integrou o <MainSiteUrl href="/quick-starts/swift">Logto iOS SDK</MainSiteUrl> no seu aplicativo. Nesse caso, as coisas são bem simples e você nem precisa ler a documentação do SDK do WeChat:
...
Assumimos que você já integrou o <MainSiteUrl href="/quick-starts/android">Logto Android SDK</MainSiteUrl> no seu aplicativo. Nesse caso, as coisas são bem simples e você nem precisa ler a documentação do SDK do WeChat:
