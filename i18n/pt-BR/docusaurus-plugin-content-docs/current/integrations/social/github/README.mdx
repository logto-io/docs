...
sidebar_custom_props:
  ...
  description: GitHub é uma comunidade online para desenvolvimento de software e controle de versão. (GitHub is an online community for software development and version control.)
...
- Vincular contas de usuários a identidades do GitHub
...
1. Vá para <CloudLink to="/connectors/social">Logto console > Conector > Conector social</CloudLink>.
...
### Habilitar "Login com GitHub" (Enable "Sign-in with GitHub") \{#enable-sign-in-with-github}

1. No Logto Console, vá para <CloudLink to="/sign-in-experience/sign-up-and-sign-in">Conta & login > Cadastro e login</CloudLink>.
...
Use a Account API para construir um Centro de Conta personalizado em seu app que permita aos usuários autenticados vincular ou desvincular sua conta do GitHub. [Siga o tutorial da Account API](/end-user-flows/account-settings/by-account-api#link-a-new-social-connection)
...
## Gerenciar a identidade do usuário no GitHub (Manage user's GitHub identity) \{#manage-user-s-github-identity}
...
<Url href="https://docs.github.com/en/developers/apps/getting-started-with-apps/about-apps">
  Documentação do GitHub para desenvolvedores - Sobre Apps (GitHub Developer Documentation - About
  Apps)
</Url>

<Url href="https://docs.github.com/en/developers/apps/building-oauth-apps/creating-an-oauth-app">
  Documentação do GitHub para desenvolvedores - Criando um OAuth App (GitHub Developer Documentation
  - Creating an OAuth App)
</Url>

<Url href="https://docs.github.com/en/apps/oauth-apps/building-oauth-apps/scopes-for-oauth-apps">
  Documentação de escopos do GitHub OAuth App (GitHub OAuth App Scopes Documentation)
</Url>
