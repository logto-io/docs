...
Use a Account API para construir um Centro de Conta personalizado em seu aplicativo, permitindo que usuários autenticados vinculem ou desvinculem sua conta do GitHub. [Siga o tutorial da Account API](/end-user-flows/account-settings/by-account-api#link-a-new-social-connection)
