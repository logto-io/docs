...
## Site do Desenvolvedor Suporta Apenas Coreano Agora \{#developer-site-only-korean-support-now}
...
### Ambiente de Serviço Open API de Login (로그인 오픈 API 서비스 환경) \{#sign-in-open-api-service-environment-로그인-오픈-api-서비스-환경}
