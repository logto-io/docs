...
| 2001            | Acessar calendário na nuvem Xiaomi              | Mi Cloud         |
| 2002            | Acessar alarme na nuvem Xiaomi                  | Mi Cloud         |
...
| 12001           | Salvar dados do app na nuvem Xiaomi             | Mi Cloud         |
...
| 40000           | Ativar serviço de IA na nuvem                   | Uso Interno      |
...
É isso. Não se esqueça de [Ativar login social](https://docs.logto.io/connectors/social-connectors#enable-social-sign-in) no cadastro e login.
