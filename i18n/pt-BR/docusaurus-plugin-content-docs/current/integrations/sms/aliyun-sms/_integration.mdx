...
6. Após enviar sua aplicação de assinatura e modelo SMS, você precisará aguardar para que entre em vigor. Neste ponto, podemos voltar para a [página do console do serviço SMS](https://dysms.console.aliyun.com/overview) e enviar um SMS de teste. Se suas assinaturas e modelos estiverem prontos para uso, você pode testá-los diretamente; se ainda não estiverem em vigor, a Aliyun também fornece modelos de teste.
