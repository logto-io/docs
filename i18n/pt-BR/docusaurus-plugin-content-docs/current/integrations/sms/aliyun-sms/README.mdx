...
É isso. Não se esqueça de <MainSiteUrl href="/connectors/sms-connectors/#enable-phone-number-for-end-user-flows">Ativar o conector na experiência de login</MainSiteUrl>.
