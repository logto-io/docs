...
## Configurar um serviço de mensagens curtas no Console SMS da Aliyun \{#references}

### Criar uma conta Aliyun \{#create-an-aliyun-account}

Vá para o [site da Aliyun](https://cn.aliyun.com/) e registre sua conta Aliyun se você ainda não tiver uma.

### Habilitar e Configurar o Aliyun Short Message Service \{#enable-and-configure-aliyun-short-message-service}
...
4. Agora você está na [página do console do serviço SMS](https://dysms.console.aliyun.com/overview), vá para o botão "China Continental" (国内消息) ou "Fora da China Continental" (国际/港澳台消息) na barra lateral conforme seu caso de uso.
...
6. Após enviar sua aplicação de assinatura e modelo SMS, você precisa esperar que ela entre em vigor. Neste ponto, podemos voltar para a [página do console do serviço SMS](https://dysms.console.aliyun.com/overview) e enviar um SMS de teste. Se suas assinaturas e modelos estiverem prontos para uso, você pode testá-los diretamente; se ainda não estiverem em vigor, a Aliyun também fornece modelos de teste.
   - Pode ser necessário recarregar uma pequena quantia de dinheiro antes de enviar mensagens de teste.
   - Você também pode ser solicitado a vincular um número de telefone de teste antes de enviar mensagens de teste. Para mais detalhes, vá para a guia "Início Rápido" (快速学习) na barra lateral da [página do console do serviço SMS](https://dysms.console.aliyun.com/overview).
...
### Testar o conector SMS da Aliyun \{#test-aliyun-sms-connector}
...
- [Aliyun SMS - Início Rápido](https://dysms.console.aliyun.com/quickstart)
