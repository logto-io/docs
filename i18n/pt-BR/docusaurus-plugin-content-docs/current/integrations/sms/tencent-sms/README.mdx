...
### Criar uma conta no Tencent Cloud \{#create-an-tencent-cloud-account}

Vá para o [site do Tencent Cloud](https://cloud.tencent.com/) e registre sua conta se você ainda não tiver uma.

### Ativar e Configurar o SMS do Tencent Cloud \{#enable-and-configure-tencent-cloud-sms}
...
### Testar o conector SMS do Tencent Cloud \{#test-tencent-cloud-sms-connector}
