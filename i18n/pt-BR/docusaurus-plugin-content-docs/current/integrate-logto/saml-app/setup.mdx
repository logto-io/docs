...
![Certificados de aplicativo SAML](./assets/certificates.png)
...
#### Formato do ID do nome \{#name-id-format}
...
![Formato do ID do nome SAML](./assets/name-id-format.png)
...
![Criptografia de asserção SAML](./assets/encryption.png)
