...
O Aplicativo Protegido, alimentado pela Cloudflare, opera globalmente em redes de borda, garantindo baixa latência e alta disponibilidade para seu aplicativo.
...
Para verificar os cabeçalhos dentro do seu aplicativo, consulte o [exemplo de Autenticação Básica HTTP](https://developers.cloudflare.com/workers/examples/basic-auth/) fornecido pela Cloudflare para aprender como restringir o acesso usando o esquema HTTP Basic.
