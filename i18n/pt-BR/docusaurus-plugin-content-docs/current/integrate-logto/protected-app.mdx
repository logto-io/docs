...
Para restringir quais usuários autenticados podem acessar um Protected App, configure o [controle de acesso em nível de aplicativo](/authorization/app-level-access-control) na guia **Rules** do aplicativo.
