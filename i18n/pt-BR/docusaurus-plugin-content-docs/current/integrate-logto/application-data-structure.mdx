...
### Ponto de extremidade de configuração do provedor OpenID \{#openid-provider-configuration-endpoint}
...
### Ponto de extremidade de autorização \{#authorization-endpoint}
...
### Ponto de extremidade de token \{#token-endpoint}
...
### Ponto de extremidade de informações do usuário \{#userinfo-endpoint}
