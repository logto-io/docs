...
Se você estiver conectando um serviço ou produto que suporta nativamente a configuração de provedor de identidade externo (ex.: plataformas SaaS corporativas, ferramentas de colaboração), a configuração é simples:
