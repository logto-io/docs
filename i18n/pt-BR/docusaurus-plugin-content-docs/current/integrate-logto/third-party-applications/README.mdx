...
Para restringir quais usuários podem fazer login em um aplicativo de terceiros, configure o [controle de acesso em nível de aplicativo](/integrate-logto/app-level-access-control) na guia **Regras** do aplicativo.
