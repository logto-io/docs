...
| Organization.Membership.Updated | Usuários ou aplicativos são adicionados ou removidos de uma organização. O payload inclui [campos delta de associação](/developers/webhooks/request#organizationmembershipupdated-payload). |
...
| Tipo de evento     | Descrição                                                                                                                                                                                                                                                                                |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Identifier.Lockout | Uma conta de usuário é bloqueada devido a tentativas consecutivas de verificação de identidade falhadas. Pode ser acionado nos seguintes fluxos:<br /><ul><li>Falha na verificação de senha</li><li>Falha na verificação de código</li><li>Falha na verificação de token único</li></ul> |
