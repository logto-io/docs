...
Você precisará obter a chave de assinatura na página de detalhes do webhook no <CloudLink to="/webhooks">Console de Administração</CloudLink> para verificar a assinatura.
