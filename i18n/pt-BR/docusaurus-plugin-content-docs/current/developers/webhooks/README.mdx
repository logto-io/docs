...
- **Realizar chamadas adicionais de API**: Configure um Webhook para verificar o acesso do usuário verificando seu domínio de email ou endereço IP e, em seguida, use a Logto Management API para atribuir papéis apropriados com permissões de recursos.
