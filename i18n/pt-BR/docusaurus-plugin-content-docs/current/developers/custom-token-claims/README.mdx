...
# Token de acesso personalizado (Custom access token)
...
## Como funcionam as reivindicações personalizadas de token? (How do custom token claims work?) \{#how-do-custom-token-claims-work}
