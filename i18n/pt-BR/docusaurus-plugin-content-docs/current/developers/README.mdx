...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description: 'Execute código personalizado síncrono no fluxo de autenticação para migrar ou enriquecer usuários.',
      customProps: {
        icon: <Action />,
      }
    },
