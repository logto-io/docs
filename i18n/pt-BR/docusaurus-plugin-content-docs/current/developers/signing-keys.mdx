...
1. Navegue até <CloudLink to="/tenant-settings/oidc-configs">Console > Chaves de assinatura</CloudLink>. Lá, você pode gerenciar tanto as chaves privadas OIDC quanto as chaves de cookie OIDC.
