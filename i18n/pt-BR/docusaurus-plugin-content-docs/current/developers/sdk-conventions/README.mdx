...
No uso prático dos serviços do Logto, por conveniência, muitas vezes é necessário que os desenvolvedores integrem o SDK do Logto em seus próprios aplicativos cliente para gerenciar o status de login do usuário, permissões e mais.
...
- [Estratégia de design](/developers/sdk-conventions/design-strategy)
- [Convenção do SDK principal](/developers/sdk-conventions/core-sdk-convention)
- [Convenção do SDK da plataforma](/developers/sdk-conventions/platform-sdk-convention)
