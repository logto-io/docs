...
sequenceDiagram
    ...
    participant Logto as Endpoint de token Logto
...
3. Use um aplicativo do lado do servidor para a API A, como um aplicativo máquina para máquina ou um aplicativo web tradicional, para que ele possa autenticar-se com segurança usando um segredo de aplicativo.
...
2. `subject_token`: O token de acesso de usuário emitido pelo Logto recebido pela API A.
...
Veja [Validar tokens de acesso em API](/authorization/validate-access-tokens) para orientações de implementação.

## Recursos relacionados \{#related-resources}

<Url href="/authorization/global-api-resources">Proteger recursos globais de API</Url>

<Url href="/authorization/validate-access-tokens">Validar tokens de acesso em API</Url>
