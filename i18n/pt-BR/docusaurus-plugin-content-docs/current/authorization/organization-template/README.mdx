...
Você pode usar tanto o modelo de organização quanto o RBAC no nível do usuário / sistema no Logto, permitindo uma abordagem mais robusta para atender aos seus requisitos específicos de negócios e produtos. Para entender o RBAC, consulte esta [seção](/authorization/role-based-access-control/).
