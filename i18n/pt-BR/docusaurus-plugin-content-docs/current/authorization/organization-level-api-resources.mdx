...
2. **Defina papéis da organização** no template de organização e atribua as permissões de API relevantes.
...
### Como o Logto aplica o RBAC da organização \{#how-logto-applies-organization-rbac}
...
### Configure papéis da organização \{#set-up-organization-roles}
