...
<img src={organizationTemplate} alt="Visão geral do template de organização" style={{ width: '100%' }} />
<center>
  <figcaption>
    <i>
...
<Url href="/authorization/organization-permissions">Proteger permissões da organização (não-API)</Url>
