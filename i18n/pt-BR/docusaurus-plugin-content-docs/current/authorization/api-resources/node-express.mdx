...
Para demonstração, usamos o pacote [jose](https://github.com/panva/jose) para validar a assinatura do token, status de expiração e reivindicações (Claims) necessárias.
