...
O Logto utiliza [RFC 8707: Indicadores de Recurso para OAuth 2.0](https://www.rfc-editor.org/rfc/rfc8707) para implementar controle de acesso baseado em papel (RBAC). Embora seja um dos recursos do OAuth 2.0, ainda não é amplamente suportado.
