...
Logto oferece serviços de autorização para vários cenários. Aqui estão alguns casos de uso típicos e você pode escolher o mais adequado e alinhar seus requisitos com os recursos e serviços do Logto.

| Cenário                                                                                                                                                                  | Como                                                                                                                                                             | Fluxo de autorização                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Proteja simplesmente seus recursos de API, sem RBAC.](/authorization/api-resources/protect-your-api)                                                                    | Registre sua API no Logto Console, e o Logto simplesmente concederá tokens de acesso                                                                             | Logto concede `token de acesso (access token)` (sem permissões), e você precisa validar esses tokens para proteger seus recursos de API.                           |
