...
## Verstehe, wie die rollenbasierte Zugangskontrolle funktioniert \{#understand-how-role-based-access-control-work}

<Rbac style={{ maxWidth: '100%' }} />

### Berechtigungen (Scopes) \{#permissionsscopes}
...
Wenn keine API-Ressource angegeben ist, wird die Berechtigung als "für OIDC" behandelt. Normalerweise ist dies nicht das, was du in RBAC möchtest.
...
<Url href="https://blog.logto.io/mastering-rbac">
  Mastering RBAC in Logto: Ein umfassendes Praxisbeispiel
</Url>
