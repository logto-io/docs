...
### Änderung der Auth-Endpunkte für andere Anwendungen \{#modifying-auth-endpoints-for-other-applications}
...
### Aktualisierung der Callback-URI des sozialen Connectors \{#updating-the-social-connectors-callback-uri}
