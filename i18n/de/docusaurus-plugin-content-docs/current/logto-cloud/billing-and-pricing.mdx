...
```math
\text{Ihre nächste Rechnung} = \$16\text{ (Grundpreis)} + \text{Zusatzkosten (nicht abgerechnete Nutzung)} + \text{Zusatzkosten (nächste Zyklusgebühr)}
```
...
Wenn der Pro-Plan nicht deinen Bedürfnissen entspricht und du nach vollständigem Enterprise-Support suchst, kontaktiere uns bitte [hier](https://logto.io/contact), um einen individuellen Enterprise-Plan zu besprechen.
