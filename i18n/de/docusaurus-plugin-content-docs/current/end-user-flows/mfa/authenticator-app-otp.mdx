...
<img src={otpSetUpFlowImage} alt="OTP-Einrichtungsablauf" />
...
4. **Authentifizierung**: Das System überprüft das OTP und gewährt bei erfolgreicher Validierung den Zugang.

<img src={otpVerificationFlowImage} alt="OTP-Verifizierungsablauf" />
