...
<img src={webauthnSetupFlowImage} alt="WebAuthn-Einrichtungsablauf" />

- **Passkey-Verifizierungsabläufe**

<img src={webauthnVerificationFlowImage} alt="WebAuthn-Verifizierungsablauf" />
