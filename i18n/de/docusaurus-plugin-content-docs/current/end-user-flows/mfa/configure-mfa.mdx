...
## MFA-Benutzerablauf \{#mfa-user-flow}

### MFA-Einrichtungsablauf \{#mfa-set-up-flow}
...
<img src="/img/assets/link-mfa.png" alt="MFA-Einrichtungsablauf" />

### MFA-Verifizierungsablauf \{#mfa-verification-flow}
...
<img src="/img/assets/verify-mfa.png" alt="MFA-Verifizierungsablauf" />
...
### Ein Kontozentrum bauen \{#building-an-account-center}

Du kannst ein umfassendes Kontozentrum mit Logtos [Account API](/end-user-flows/account-settings/by-account-api) bauen, das es Benutzern ermöglicht:
