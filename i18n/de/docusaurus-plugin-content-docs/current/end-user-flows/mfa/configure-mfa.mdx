...
### MFA-Konfiguration auf Organisationsebene \{#organization-level-mfa-configuration}
...
2. **Anmeldung oder Registrierung abschließen**: Der Benutzer durchläuft den Identitätsprüfungsprozess im Anmelde- oder Registrierungsfluss.
...
Du kannst ein umfassendes Kontozentrum mit der Logto [Account API](/end-user-flows/account-settings/by-account-api) aufbauen, das es Benutzern ermöglicht:
...
### MFA-Einrichtungsaufforderungen nach dem Login \{#post-login-mfa-setup-prompts}
