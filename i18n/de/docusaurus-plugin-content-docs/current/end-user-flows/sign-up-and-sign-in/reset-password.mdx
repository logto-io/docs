...
Passe Passwortlänge, Zeichenvorgaben und Wortbeschränkungen an, um die Sicherheitsanforderungen deines Unternehmens zu erfüllen und gleichzeitig eine gute Benutzererfahrung zu bieten. Diese Einstellungen können im Bereich **Sicherheit** konfiguriert werden. Siehe [Passwort-Richtlinie](/security/password-policy) für weitere Informationen.
...
Abonniere das `PostResetPassword` [Webhook-Ereignis](/developers/webhooks/webhooks-events#user-interaction-hook-events), um eine Benachrichtigung zu erhalten, wenn ein Benutzer sein Passwort erfolgreich zurückgesetzt hat. Du kannst dann eine [Abmeldeaktion](/end-user-flows/sign-out) auslösen, um die aktuelle Sitzung des Benutzers ungültig zu machen und ihn zur Anmeldeseite weiterzuleiten.
...
Du kannst deinen eigenen Ablauf zum Zurücksetzen des Passworts implementieren, indem du die **Management API** und **Account API** von Logto verwendest. Siehe [Kontoeinstellungen](/end-user-flows/account-settings/) für weitere Details.
