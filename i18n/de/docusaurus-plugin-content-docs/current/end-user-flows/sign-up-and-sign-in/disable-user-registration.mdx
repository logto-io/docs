...
4. Wenn der Benutzer auf den Registrierungslink klickt, lasse deine Anwendung die Logto Management API aufrufen, um das Benutzerkonto zu erstellen.
...
1. Deaktiviere die Benutzerregistrierung in der Logto-Konsole.
2. Erstelle Benutzerkonten manuell in der <CloudLink to="/users">Konsole > Benutzerverwaltung</CloudLink> oder über die Management API.
