...
2. **Füge soziale Login-Buttons hinzu**:<br/>
   ...
   Navigiere zu <CloudLink to="/sign-in-experience/sign-up-and-sign-in">Konsole > Anmeldeerfahrung > Registrierung und Anmeldung</CloudLink>. Klicke auf die Schaltfläche „Sozialen Connector hinzufügen“, um soziale Login-Buttons auf deinen Registrierungs- und Anmeldeseiten zu integrieren. Verwende Drag & Drop, um ihre Reihenfolge in der Benutzeroberfläche zu arrangieren.
...
3. **Lege Optionen zur Kontoverknüpfung fest**:<br/>
   ...
   Um diesen Prozess zu vereinfachen, kannst du die Option **Automatische Kontoverknüpfung** in den Einstellungen der Anmeldeerfahrung aktivieren. Dies wird das soziale Konto automatisch mit einem bestehenden Konto verknüpfen, wenn die E-Mail-Adresse oder Telefonnummer übereinstimmt.
