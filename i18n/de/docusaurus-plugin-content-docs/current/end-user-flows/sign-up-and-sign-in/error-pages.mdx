...
Um dies zu handhaben, hat Logto die Einstellung `unknownSessionRedirectUrl` eingeführt. Wenn du diese URL festlegst, leitet Logto Benutzer automatisch auf die angegebene Seite weiter, um einen neuen Anmeldeablauf zu starten, anstatt die 404-Fehlerseite anzuzeigen.
...
2. Setze die „Unbekannte Sitzung Weiterleitungs-URL“ auf die Adresse deines Dienstes oder die Startseite deines Produkts. Beispiel: Logto Cloud setzt „https://cloud.logto.io“.
