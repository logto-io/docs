...
- Passwort-Zurücksetzung mit Magic Link.
...
Der Benutzer wird nach erfolgreicher Verifizierung automatisch den Organisationen zugeordnet und Standardrollen der Organisation werden zugewiesen.
...
### Kann ich weiterhin Magic Links verwenden, um Benutzer einzuladen, wenn ich die Benutzerregistrierung in "Anmeldung und Registrierung" deaktiviere? \{#if-i-disable-user-registration-in-sign-in-experience-can-i-still-use-magic-link-to-invite-users}

</summary>

Ja, du kannst weiterhin Magic Links verwenden, um Benutzer einzuladen, auch wenn du die Benutzerregistrierung in "Anmeldung und Registrierung" deaktivierst.
