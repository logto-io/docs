...
Bevor du Mitglieder in deine Organisation einlädst, musst du Organisationrollen erstellen. Sieh dir den Leitfaden [Organisationen konfigurieren](https://docs.logto.io/docs/recipes/organizations/configuration/) für detaillierte Anweisungen an.
...
Der integrierte "Logto-E-Mail-Dienst" von Logto Cloud unterstützt derzeit nicht den Nutzungstyp `OrganizationInvitation`. Stattdessen musst du deinen E-Mail-Connector (z.B. Sendgrid) konfigurieren und die `OrganizationInvitation`-Vorlage einrichten.

Eine Beispiel-E-Mail-Vorlage für den Nutzungstyp `OrganizationInvitation` wird unten gezeigt:
...
Du kannst den Leitfaden [Beliebte E-Mail-Dienste konfigurieren](https://docs.logto.io/docs/recipes/configure-connectors/email-connector/configure-popular-email-service/) für weitere Details zur Einrichtung von E-Mail-Connectors einsehen.

## Einladungen mit Logto Management API bearbeiten

Hinweis

Wenn du die Logto Management API noch nicht eingerichtet hast, sieh dir [Interaktion mit Management API](https://docs.logto.io/docs/recipes/interact-with-management-api/) für Details an.
...
Bitte beachte, dass alle oben aufgeführten APIs ein gültiges "Organisationstoken" erfordern. Sieh dir diesen [Leitfaden](https://docs.logto.io/docs/recipes/organizations/integration/#step-2-fetch-the-organization-token) an, um zu erfahren, wie du das Organisationstoken erhältst.
