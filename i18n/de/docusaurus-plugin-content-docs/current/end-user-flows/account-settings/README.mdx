...
## Verwendung der Account APIs (Empfohlen) \{#use-account-apis-recommended}
...
## Verwendung der Management APIs \{#use-management-apis}
...
| **Wann verwenden**          | Um schnell eine sichere Self-Service-Kontoeinstellungsseite in deiner Client-App mit minimalem Aufwand bereitzustellen. | Wenn die Account APIs nicht ausreichen. Z. B. für komplexe Löschlogik, risikoreiche Aktionen oder Backoffice-Tools.                       |
