...
Logto bietet verschiedene Management APIs zur Verwaltung von Benutzerkonten. Du kannst diese APIs verwenden, um eine Selbstbedienungs-Kontoeinstellungsseite für Endbenutzer zu erstellen.
...
| PATCH   | [/api/users/\{userId\}/is-suspended](https://openapi.logto.io/operation/operation-updateuserissuspended) | Benutzer-Sperrstatus nach Benutzer-ID aktualisieren.     |
...
### Verwaltung der sozialen Identitäten von Benutzern \{#user-social-identities-management}
...
| POST    | [/api/users/\{userId\}/identities](https://openapi.logto.io/operation/operation-createuseridentity)                               | Eine authentifizierte soziale Identität mit der Benutzer-ID verknüpfen.                                                                            |
| DELETE  | [/api/users/\{userId\}/identities](https://openapi.logto.io/operation/operation-deleteuseridentity)                               | Eine soziale Identität von der Benutzer-ID trennen.                                                                                                |
| PUT     | [/api/users/\{userId\}/identities](https://openapi.logto.io/operation/operation-replaceuseridentity)                              | Eine mit der Benutzer-ID verknüpfte soziale Identität direkt aktualisieren.                                                                        |
...
### Verwaltung der Unternehmensidentitäten von Benutzern \{#user-enterprise-identities-management}

| Methode | Pfad                                                                                                    | Beschreibung                                                                                                                                                                                                               |
| ------- | ------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| GET     | [/api/users/\{userId\}?includeSsoIdentities=true](https://openapi.logto.io/operation/operation-getuser) | Benutzerdetails nach Benutzer-ID abrufen. Die Unternehmensidentitäten sind im Feld `ssoIdentities` zu finden. Füge den Abfrageparameter `includeSsoIdentities=true` zur Benutzer-Details-API hinzu, um sie einzuschließen. |
...
### Verwaltung der MFA-Einstellungen von Benutzern \{#user-mfa-settings-management}

| Methode | Pfad                                                                                                                                 | Beschreibung                                                           |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| GET     | [/api/users/\{userId\}/mfa-verifications](https://openapi.logto.io/operation/operation-listusermfaverifications)                     | MFA-Einstellungen eines Benutzers nach Benutzer-ID abrufen.            |
| POST    | [/api/users/\{userId\}/mfa-verifications](https://openapi.logto.io/operation/operation-createusermfaverification)                    | Eine MFA-Verifizierung für einen Benutzer nach Benutzer-ID einrichten. |
| DELETE  | [/api/users/\{userId\}/mfa-verifications/\{verificationId\}](https://openapi.logto.io/operation/operation-deleteusermfaverification) | Eine MFA-Verifizierung eines Benutzers nach ID löschen.                |
