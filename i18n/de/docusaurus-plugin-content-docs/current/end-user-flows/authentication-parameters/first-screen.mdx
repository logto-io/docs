...
Für [Logto OSS](/logto-oss)-Nutzer werden diese Parameter seit Version 1.15.0 unterstützt. Wenn du eine ältere Version verwendest, bitte [aktualisiere](/logto-oss/upgrading-oss-version) auf die neueste Version.
:::
