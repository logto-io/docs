...
![Erster Bildschirmparameter](./assets/first-screen-parameter.png)
...
Für [Logto OSS](/logto-oss) Benutzer sind diese Parameter seit Version 1.15.0 unterstützt. Wenn du eine ältere Version verwendest, bitte [aktualisiere](/logto-oss/upgrading-oss-version) auf die neueste Version.
:::
