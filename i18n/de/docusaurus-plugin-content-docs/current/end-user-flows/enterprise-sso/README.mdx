...
Logto ermöglicht es dir, soziale Login-Buttons zu deiner Website hinzuzufügen und den SSO-Anmeldeprozess direkt zu starten, ohne das Standard-Anmeldeformular anzuzeigen. Sieh dir unseren [Direkte Anmeldung](/end-user-flows/authentication-parameters/direct-sign-in/) Leitfaden für detaillierte Anweisungen an.
