...
## Sicherheitsüberprüfung mit Account API implementieren \{#implement-security-verification-by-account-api}
...
| POST    | [/api/verifications/verification-code/verify](https://openapi.logto.io/operation/operation-verifyverificationbyverificationcode) | E-Mail oder Telefonnummer per Verifizierungscode verifizieren. |
