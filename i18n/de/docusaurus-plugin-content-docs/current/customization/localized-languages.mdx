...
Sieh dir [den Quellcode](https://github.com/logto-io/logto/blob/master/packages/phrases-experience/src/locales/en/index.ts) an, um alle anpassbaren Inhalte zu sehen.
...
<details>
  <summary>Was passiert, wenn die von mir hinzugefügte Sprache zu einer von Logto bereitgestellten Sprache wird?</summary>
...
<details>
  <summary>Was passiert, wenn ich nur wenige benutzerdefinierte Werte hinzugefügt habe?</summary>
