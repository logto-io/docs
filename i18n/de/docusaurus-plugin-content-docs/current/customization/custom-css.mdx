...
Wenn unsere Feinabstimmungs-UI nicht vollständig mit deiner Marke übereinstimmt, verwende benutzerdefiniertes CSS, um deine Anmeldeerfahrung anzupassen. Füge einfach deinen CSS-Code in unseren Editor ein und sieh die Änderungen sofort.
...
4. Vergiss nicht, auf die Schaltfläche „Live-Vorschau“ zu klicken, um die Änderungen auf allen Seiten zu überprüfen.
