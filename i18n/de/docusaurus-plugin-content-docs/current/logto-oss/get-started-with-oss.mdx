...
:::tip
Logto OSS (self-hosted) unterstützt keine Konfiguration mehrerer Administratoren. Für Teamarbeit und Projekte, die mehrere Admin-Benutzer erfordern, empfehlen wir [Logto Cloud](https://cloud.logto.io), das vollständige Teamverwaltungsfunktionen bietet.
:::
