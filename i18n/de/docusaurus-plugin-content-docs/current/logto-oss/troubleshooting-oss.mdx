...
<summary>
  ...
  <code>Crypto.subtle is unavailable...</code> an)
</summary>
...
<summary>
  ...
  (zeigt den Fehler <code>"code": "oidc.invalid_redirect_uri"</code> an)
</summary>
...
<summary>
  ...
  (zeigt den Fehler <code>TypeError: Failed to fetch</code> an)
</summary>
...
<summary>Ich habe CORS-Probleme.</summary>
...
<summary>
  Was ist das nochmal? <code>Error: Invalid id token</code>
</summary>
