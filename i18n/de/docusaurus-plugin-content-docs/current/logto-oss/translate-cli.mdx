...
Für reguläre Logto-Benutzer, die benutzerdefinierte Übersetzungen ohne Beitrag zum Projekt suchen, verweisen wir auf unseren [Lokalisierungsleitfaden](/customization/localized-languages/).
