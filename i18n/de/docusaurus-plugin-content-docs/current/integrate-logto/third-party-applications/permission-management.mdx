...
Logto ermöglicht es dir, die spezifischen Berechtigungen zu steuern, die Drittanbieteranwendungen gewährt werden. Dies umfasst die Verwaltung von [Benutzerprofil](#user-permissions-user-profile-scopes)-, [API-Ressourcen](#api-resource-permissions-api-resource-scopes)- und [Organisations-Berechtigungen](#organization-permissions-organization-scopes). Im Gegensatz zu First-Party-Apps wird Drittanbieteranwendungen, die nicht autorisierte Berechtigungen anfordern, der Zugriff verweigert.
...
- `role`: Logto-Benutzerprofil-Berechtigung, wird für den Zugriff auf Benutzer-[Rollen](/authorization/role-based-access-control/#roles) verwendet.
...
[Organisationsberechtigungen](/authorization/organization-template/#organization-permission) sind Berechtigungen, die ausschließlich für Logto-Organisationen definiert sind. Sie werden für den Zugriff auf Organisationsinformationen und -ressourcen verwendet.
...
Du kannst eigene Organisations-Berechtigungen auf der Seite mit den Organisationstemplate-Einstellungen definieren. Siehe [Organisationstemplate konfigurieren](/authorization/organization-template/configure-organization-template/) für weitere Details.
