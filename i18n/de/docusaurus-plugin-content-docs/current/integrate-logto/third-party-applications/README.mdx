...
:::note
Bevor du die OIDC-Konfigurationen einrichtest, stelle bitte sicher, dass du [eine OIDC-Drittanbieteranwendung erstellt](/quick-starts/quick-starts/third-party-traditional-web) hast.
:::
...
2. Rufe die [**Client-ID**](/integrate-logto/application-data-structure#application-id) und das [**Client-Secret**](/integrate-logto/application-data-structure#application-secret) von der Logto-Anwendungsdetailseite ab und trage sie in die IdP-Verbindungseinstellungen deines Service-Providers ein.

3. Rufe den [**Autorisierungsendpunkt**](/integrate-logto/application-data-structure#authorization-endpoint) und den [**Token-Endpunkt**](/integrate-logto/application-data-structure#token-endpoint) von der Logto-Anwendungsdetailseite ab und gib sie an deinen Service-Provider weiter.
