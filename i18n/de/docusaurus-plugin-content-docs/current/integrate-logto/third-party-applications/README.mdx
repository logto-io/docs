...
:::note
Bevor du die OIDC-Konfigurationen einrichtest, stelle bitte sicher, dass du [eine OIDC-Drittanbieteranwendung erstellt](/quick-starts/third-party-traditional-web) hast.
:::
