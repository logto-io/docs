...
Durch die richtige Konfiguration der Attributzuordnung stellst du sicher, dass dein Service Provider alle notwendigen Benutzerinformationen erhält, um deinen Benutzern den passenden Zugang und die passende Personalisierung zu bieten.

Du kannst alle in Logto verfügbaren Benutzerinformationen den vom SP erwarteten Attributen mithilfe der Einstellungen zur Attributzuordnung zuordnen.
