...
_Die Anwendungs-ID_ ist ein eindeutiger, automatisch generierter Schlüssel zur Identifizierung deiner Anwendung in Logto und wird als [client id](https://www.oauth.com/oauth2-servers/client-registration/client-id-secret/) in OAuth 2.0 bezeichnet.
...
Der _Anwendungsname_ ist ein wichtiger Bestandteil der Verwaltung von Anwendungen in Logto, da Administratoren damit einzelne Anwendungen innerhalb der Plattform leicht identifizieren und deren Aktivitäten verfolgen können.
...
_Verfügbarkeit: Native App, Traditionelle Web, SPA; Standard: 14 Tage; Maximum: 180 Tage_
