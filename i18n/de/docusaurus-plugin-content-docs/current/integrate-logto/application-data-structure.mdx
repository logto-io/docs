...
Redirect-URIs unterstützen Wildcard-Muster (`*`) für dynamische Umgebungen wie Preview-Deployments. Wildcards können im Hostnamen und im Pfadnamen von HTTP/HTTPS-URIs verwendet werden.
