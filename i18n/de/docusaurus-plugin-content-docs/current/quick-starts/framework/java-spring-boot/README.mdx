...
#### Erstelle eine neue Klasse `WebSecurityConfig` in deinem Projekt
...
#### Erstelle einen `idTokenDecoderFactory` Bean
...
#### Aktualisiere die `WebSecurityConfig` Klasse mit einer `securityFilterChain`
