...
Registriere eine neue `Java Spring Boot`-Anwendung in der Logto-Konsole und erhalte die Client-Zugangsdaten sowie die IdP-Konfigurationen für deine Webanwendung.
