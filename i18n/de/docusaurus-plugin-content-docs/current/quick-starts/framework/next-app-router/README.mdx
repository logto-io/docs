...
sidebar_custom_props:
  ...
  description: Next.js App Router ist ein neues Paradigma zum Erstellen von Anwendungen mit den neuesten Funktionen von React. (Next.js App Router is a new paradigm for building applications using React's latest features.)
language: js
official_link: https://nextjs.org/learn/dashboard-app
app_type: Traditionelle Webanwendung (Traditional web)
