...
- **v2**: Öffnet die Anmeldeerfahrung in einer eingebetteten WebView, die für die nativen Social-Connectoren erforderlich ist, unterstützt jedoch keine [Passkey-Anmeldung](/end-user-flows/sign-up-and-sign-in/passkey-sign-in) (WebView unterstützt kein WebAuthn, den zugrundeliegenden Standard von Passkeys).
- **v3 (beta)**: Öffnet die Anmeldeerfahrung in [Chrome Custom Tabs](https://developer.android.com/develop/ui/views/layout/webapps/overview-of-android-custom-tabs) (dem Systembrowser), was die Passkey-Anmeldung ermöglicht und die Browsersitzung teilt. Beachte, dass v3 die Unterstützung für die [WeChat (Native)](/integrations/wechat-native)- und [Alipay (Native)](/integrations/alipay-native)-Connectoren entfernt; du kannst stattdessen [WeChat (Web)](/integrations/wechat-web) und [Alipay (Web)](/integrations/alipay-web) verwenden, die über den Browser funktionieren. Wenn du von den nativen Connectoren abhängig bist, bleibe bei v2.
