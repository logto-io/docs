...
# Authentifizierung zu deiner Auth.js (Next Auth)-Anwendung hinzufügen (Add authentication to your Auth.js (Next Auth) application)

Diese Anleitung zeigt dir, wie du Logto in deine Next.js-Anwendung mit [Auth.js](https://authjs.dev/) (früher bekannt als Next Auth) integrierst.
...
### Logto-Provider konfigurieren \{#configure-logto-provider}
...
<Url href="https://blog.logto.io/next-auth-v5">
  Migration der Logto-Integration von NextAuth.js v4 auf v5
</Url>
