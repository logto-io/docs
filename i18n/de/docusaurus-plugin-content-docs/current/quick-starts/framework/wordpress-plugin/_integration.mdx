...
{/* Kommentiere den folgenden Block aus, wenn das Plugin im WordPress-Plugin-Verzeichnis verfügbar ist */}
...
1. Lade das Logto WordPress-Plugin von einem der folgenden Links herunter:
   - [Neueste Version](https://github.com/logto-io/wordpress/releases): Lade die Datei herunter, deren Name im Format `logto-plugin-<version>.zip` ist.
     {/* Kommentiere die folgende Zeile aus, wenn das Plugin im WordPress-Plugin-Verzeichnis verfügbar ist */}
...
sequenceDiagram
    ...
    User->>WordPress: Besuche die WordPress-Anmeldeseite
