...
2. **RedirectUri**: Die URI, zu der weitergeleitet wird, nachdem die notwendigen Aktionen in der Logto Authentifizierungs-Middleware durchgeführt wurden.
...
Ähnlich hat .NET Core auch **SignedOutCallbackPath** und **RedirectUri** für den Abmeldeprozess.
