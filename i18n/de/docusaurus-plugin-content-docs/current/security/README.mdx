...
Moderne Authentifizierungs-Sicherheit bekämpft Bedrohungen wie Phishing, Credential Stuffing, Brute-Force-Angriffe, Ransomware, DDoS bis hin zu KI-gesteuerten Angriffen. Der Schutz von Benutzeridentitäten ist entscheidend, um das Vertrauen in die Marke und die Einhaltung von Vorschriften zu gewährleisten.
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description:
        'Füge deiner Anmeldeerfahrung CAPTCHA (z. B. Google reCAPTCHA, Cloudflare Turnstile) hinzu, um automatisierte Bot-Angriffe zu verhindern.',
      customProps: {
        icon: <CheckboxIcon />,
      },
    },
    {
      ...
      description:
        'Steuere neue Anmeldungen und neu verknüpfte E-Mails mit einer Allowlist und blockiere temporäre oder unerwünschte Adressen.',
      customProps: {
        icon: <BlockUserIcon />,
      },
    },
    ...
    },
    {
      ...
      description:
        'Begrenze die Anzahl der Verifizierungs- und Nachrichtenversendungen pro Empfänger, um Postfach-Spam und SMS-Missbrauch zu verhindern.',
      customProps: {
        icon: <SendEmailIcon />,
      },
    },
    {
      ...
      description:
        'Verberge den Kontostatus, um Konto-Aufzählungsangriffe zu blockieren und sensible Kontoinformationen nicht preiszugeben.',
      customProps: {
        icon: <HideIcon />,
      },
    },
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      href: '/end-user-flows',
      description:
        'Beschränke Registrierungen auf eingeladene Benutzer, indem du E-Mail-Magic-Links für ein sicheres Onboarding verwendest.',
      customProps: {
        icon: <SendEmailIcon />,
      },
    },
