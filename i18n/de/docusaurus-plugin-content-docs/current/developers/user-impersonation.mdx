...
{
  "userId": "alex123",
  "reason": "Untersuchung eines Zugriffsproblems auf Ressourcen",
  "ticketId": "TECH-1234"
}
```
...
2. Das Mimikry-Zugangstoken wird nicht mit einem [Auffrischungstoken (Refresh token)](https://auth.wiki/refresh-token) geliefert. Sarah muss diesen Vorgang wiederholen, falls das Token abläuft, bevor sie Alex' Problem gelöst hat.
