...
sequenceDiagram
  ...
  activate IdP
  IdP-->>IdP: Anmeldedaten validieren &<br/>rohe Zugangstoken-Nutzlast generieren
...
:::warning
Logto-eigene Token-Ansprüche können NICHT überschrieben oder modifiziert werden. Benutzerdefinierte Ansprüche werden dem Token als zusätzliche Ansprüche hinzugefügt. Wenn benutzerdefinierte Ansprüche mit den eingebauten Ansprüchen in Konflikt stehen, werden diese benutzerdefinierten Ansprüche ignoriert.
:::
