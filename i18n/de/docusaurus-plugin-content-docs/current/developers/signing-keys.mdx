...
## Signaturschlüssel aus der Console UI rotieren \{#rotate-signing-keys-from-console-ui}
...
1. Navigiere zu <CloudLink to="/tenant-settings/oidc-configs">Console > Mandanteneinstellungen > OIDC-Konfiguration</CloudLink>. Dort kannst du sowohl OIDC-Private Keys als auch OIDC-Cookie-Keys verwalten.
