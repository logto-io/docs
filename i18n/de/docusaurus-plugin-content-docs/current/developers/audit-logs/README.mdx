...
Das Audit-Log von Logto ermöglicht es dir, Benutzeraktivitäten und Ereignisse einfach zu überwachen. Es bietet eine solide Grundlage für verschiedene Benutzerverwaltungs- und Systemüberwachungs-Szenarien.
...
:::warning
Audit-Logs enthalten nur Protokolle, die während des Authentifizierungsprozesses von Benutzern auftreten. Protokolle von Management API-Operationen werden nicht aufgezeichnet.
:::

## Benutzeraktivität auf Mandantenebene erfassen \{#capture-user-activity-at-the-tenant-level}

Die Logs von Logto bieten umfassende Details und sorgen so für einfache Nachvollziehbarkeit und Kundensicherheit. Sie erfassen und protokollieren folgende Informationen:
...
Durch die Aufzeichnung dieser Ereignisse können Organisationen potenzielle Sicherheitsrisiken effektiv erkennen und schnell darauf reagieren, um unbefugten Systemzugriff zu verhindern.
...
<img
  ...
  alt="Audit-Logs zu einem bestimmten Benutzer"
/>
...
### Ich nutze selbstgehostetes Logto und es dauert Sekunden, bis die Audit-Logs geladen werden. Wie kann ich die Performance verbessern? \{#im-using-self-hosted-logto-and-it-takes-seconds-to-get-the-audit-logs-how-can-i-improve-the-performance}
