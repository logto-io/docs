---
description: Starte dein Identitäts- und Zugriffsmanagementsystem schnell, indem du Logto integrierst. Genieße Authentifizierung (Authentication), Autorisierung (Authorization) und Multi-Tenant-Management alles in einem.
---
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      href: '/end-user-flows',
      description:
        'Sie bietet einen vollständigen Authentifizierungs-Flow und eine Benutzeroberfläche, einschließlich Identifier-Anmeldung, Social Sign-In, Passkey-Anmeldung, MFA und umfangreiche Anpassungsmöglichkeiten über die Logto Console und API.',
      customProps: {
        icon: <ExperienceIcon />,
      },
    },
    ...
    },
    {
      ...
      description:
        'Ein Remote-MCP-Server, der KI-Tools und IDEs mit Logto Cloud verbindet und Ressourcenmanagement sowie Authentifizierungsintegration ermöglicht.',
      customProps: {
        icon: <McpIcon />,
      },
    },
