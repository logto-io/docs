---
description: Starte schnell dein Identitäts- und Zugangsmanagementsystem, indem du Logto integrierst. Genieße Authentifizierung, Autorisierung und Multi-Tenant-Management alles in einem.
---
...
Willkommen zur Logto-Dokumentation! Logto ist eine Lösung für Identitäts- und Zugangsmanagement (IAM), die für moderne Apps und SaaS-Produkte entwickelt wurde. Es bietet ein sicheres, skalierbares und anpassbares Authentifizierungs- und Autorisierungssystem für deine Anwendungen.
  ...
  items={[
    {
      ...
      description:
        'Eine webbasierte Schnittstelle zur Konfiguration und Verwaltung von Ressourcen, die eine schnelle Einrichtung der Anmeldeerfahrung und einfache Identitätsverwaltung bietet.',
      customProps: {
  ...
  items={[
    {
      ...
      href: '/logto-cloud',
      description:
        'Unser Cloud-Service umfasst Free, Pro und Enterprise-Pläne, um eine Vielzahl von Kundenbedürfnissen zu erfüllen. Es wird von Logto gehostet und verwaltet. Es bietet auch den Dev-Tenant, der alle Funktionen in Logto zum Testen enthält.',
      customProps: {
        icon: <CloudIcon />,
      },
    },
