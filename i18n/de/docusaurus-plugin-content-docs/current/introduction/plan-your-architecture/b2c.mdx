...
| Endbenutzer/Verbraucher | Verwalten ihre eigene Authentifizierung und persönlichen Informationen.                             | <ul><li>[Endbenutzererfahrung](/end-user-flows)</li><li>[Logto Management API](https://openapi.logto.io/)</li><li>[Account API](https://openapi.logto.io/operation/operation-getaccountcentersettings)</li></ul> |
