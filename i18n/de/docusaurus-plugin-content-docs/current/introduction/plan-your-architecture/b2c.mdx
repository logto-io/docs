...
## Baue dein B2C-Identitätssystem \{#build-your-b2c-identity-system}
...
| ----------------------- | --------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Entwickler              | Verwalten und sichern das Benutzeridentitätssystem und arbeiten direkt mit der Identitätsdatenbank. | <ul><li>[Logto Console](https://cloud.logto.io)</li><li>[Logto Management API](https://openapi.logto.io/)</li></ul>                                              |
| Endbenutzer/Verbraucher | [Verwalten ihre eigene Authentifizierung und persönlichen Informationen.](/end-user-flows)          | <ul><li>[Logto Management API](https://openapi.logto.io/)</li><li>[Account API](https://openapi.logto.io/operation/operation-getaccountcentersettings)</li></ul> |
