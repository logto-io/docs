...
Es gibt jedoch einige Einschränkungen, die zu beachten sind — Sie können die E-Mail-Adresse des Absenders, die Domain oder den spezifischen E-Mail-Inhalt nicht anpassen.

Je nach Ihren sich entwickelnden Geschäftsanforderungen können Sie später andere E-Mail-Dienstanbieter verwenden. Wir bieten eine Reihe von einsatzbereiten E-Mail-Dienst-Connectors und unterstützen auch SMTP und WebHook-Trigger zum Versenden von E-Mails, sodass Sie immer eine passende Lösung finden werden.

:::note
Der integrierte kostenlose E-Mail-Dienst von Logto ist derzeit nur für Cloud-Nutzer verfügbar. Für Nutzer des Open-Source-Dienstes haben Sie die Flexibilität, Ihren E-Mail-Dienstanbieter für die E-Mail-Anmeldung zu konfigurieren.
:::
...
2. Um einen neuen E-Mail-Connector hinzuzufügen, klicken Sie auf die Schaltfläche "**Einrichten**" und wählen Sie den "**Logto E-Mail-Dienst**" Connector aus.
...
Der Logto E-Mail-Dienst verwendet einheitliche E-Mail-Vorlagen, die für spezifische Authentifizierungsszenarien maßgeschneidert sind:
...
Ein Beispiel für E-Mail-Vorlagen für den "Registrierung"-Verwendungstyp mit benutzerdefinierten Markeninformationen:
...
<details>
<summary>Ist es möglich, benutzerdefiniertes CSS oder HTML zum Logto E-Mail-Dienst hinzuzufügen?</summary>
