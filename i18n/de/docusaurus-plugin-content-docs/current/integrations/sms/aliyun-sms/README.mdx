...
## Kurznachrichtendienst in der Aliyun SMS-Konsole einrichten \{#references}
...
1. Von der [SMS-Dienstkonsole](https://dysms.console.aliyun.com/overview) aus, fahre mit der Maus über dein Avatar in der oberen rechten Ecke und gehe zu "AccessKey Management" (AccessKey 管理) und klicke auf "AccessKey erstellen" (创建 AccessKey). Du erhältst ein "AccessKey ID" und "AccessKey Secret" Paar nach Abschluss der Sicherheitsüberprüfung. Bitte bewahre sie ordnungsgemäß auf.
