...
### Ein Tencent Cloud-Konto erstellen \{#references}
...
- Konfiguriere den Tencent Cloud SMS Connector mit den folgenden Feldern:
  ...
  - `sdkAppId`: Zu finden in der „[Anwendungsverwaltung](https://console.cloud.tencent.com/smsv2/app-manage)“ (应用管理).
...
- [Wie implementiert man die SMS-Verifizierungscode-Funktion?](https://cloud.tencent.com/document/product/382/43070)
