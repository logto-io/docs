...
- Auf Google APIs über sichere Token-Speicherung im Logto Secret Vault für Automatisierungsaufgaben zugreift (z. B. Bearbeiten von Google Docs, Verwalten von Kalenderereignissen in deiner App)
...
:::tip
Es ist möglich, den Google Connector ausschließlich für die Kontoverknüpfung und den API-Zugriff zu aktivieren, ohne ihn für die soziale Anmeldung zu aktivieren.
:::

### Auf Google APIs zugreifen und Aktionen ausführen \{#access-google-apis-and-perform-actions}

Deine Anwendung kann gespeicherte Google Zugangstokens (Access tokens) aus dem Secret Vault abrufen, um Google APIs aufzurufen und Backend-Aufgaben zu automatisieren (z. B. Verwalten von Google Drive-Dateien, Erstellen von Kalenderereignissen oder Versenden von E-Mails über Gmail). Siehe die Anleitung zum Abrufen gespeicherter Tokens für den API-Zugriff.

## Google-Identität des Benutzers verwalten \{#manage-user-s-google-identity}
