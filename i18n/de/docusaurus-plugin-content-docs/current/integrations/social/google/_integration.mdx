...
Navigiere zur [Zugangsdaten-Seite](https://console.cloud.google.com/apis/credentials) in der Google Cloud Console und erstelle OAuth-Zugangsdaten für deine Anwendung.
...
Wenn du auf [Google APIs](https://console.cloud.google.com/apis/library) zugreifen und Aktionen mit Benutzerautorisierung durchführen möchtest (egal ob über soziale Anmeldung oder Kontoverknüpfung), muss Logto bestimmte API-Berechtigungen erhalten und Tokens speichern.
