...
Du kannst die App auch direkt [live schalten](https://developers.facebook.com/docs/development/build-and-test/app-modes#live-mode), sodass sich jeder Facebook-Nutzer mit der App anmelden kann.
