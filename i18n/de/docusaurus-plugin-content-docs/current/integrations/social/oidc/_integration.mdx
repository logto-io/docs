...
Wenn du einen Social-Button auf deiner Anmeldeseite anzeigen möchtest, kannst du den **Namen** und das **Logo** (Dark Mode und Light Mode) des sozialen Identitätsanbieters festlegen. Dies hilft den Nutzern, die Option zur sozialen Anmeldung zu erkennen.
...
1. Gehe in der Logto-Konsole zu <CloudLink to="/sign-in-experience/sign-up-and-sign-in">Anmelde- & Kontoerfahrung > Anmeldung und Registrierung</CloudLink>.
