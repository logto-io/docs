...
2. Konfiguriere die OAuth-Einstellungen:
   ...
   - `connector_id` findest du oben auf der Detailseite des Connectors in der Logto Console
3. Hole dir `AppID` und `AppSecret` von der Detailseite der Anwendung
...
Standardmäßig fordert der Connector die folgende Berechtigung an:
...
| 2002       | Zugriff auf Xiaomi-Cloud-Alarm                | Mi Cloud          |
...
| 6004       | Drittanbieterdienst-Zugriff auf Xiaomi-Geräte | Mi Home           |
...
| 40000      | Cloud-AI-Service aktivieren                   | Interner Gebrauch |
...
Das war's. Vergiss nicht, [Soziale Anmeldung aktivieren](https://docs.logto.io/connectors/social-connectors#enable-social-sign-in) im Bereich Anmeldung und Registrierung.
