...
Das war's. Der GitLab-Connector sollte jetzt verfügbar sein. Vergiss nicht, den [Connector für die Anmeldung und Registrierung zu aktivieren](https://docs.logto.io/docs/recipes/configure-connectors/social-connector/enable-social-sign-in/).
