...
Weitere Details zum Einrichten von GitHub OAuth-Apps findest du unter [Erstellen einer OAuth-App](https://docs.github.com/en/apps/oauth-apps/building-oauth-apps/creating-an-oauth-app).
:::
...
Wenn du möchtest, dass das Zugangstoken abläuft oder Auffrischungstokens verwenden möchtest, solltest du stattdessen eine **GitHub App** integrieren. Erfahre mehr über die [Unterschiede zwischen GitHub Apps und OAuth Apps](https://docs.github.com/en/apps/oauth-apps/building-oauth-apps/differences-between-github-apps-and-oauth-apps).
:::
