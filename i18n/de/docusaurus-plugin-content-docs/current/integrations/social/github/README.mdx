...
Das war's. Der GitHub-Connector sollte jetzt verfügbar sein. Vergiss nicht, <MainSiteUrl href="/connectors/social-connectors#enable-social-sign-in">Sozialen Connector in der Anmeldeerfahrung aktivieren</MainSiteUrl>.
