...
- id: Der eindeutige Identifikator des Benutzers. Logto liest den `nameID` Anspruch aus der SAML-Antwort als Benutzer-SSO-Identitäts-ID.
...
<img src={azureAdDefaultAttributeMappingImage} alt="Azure AD Standard-Attributzuordnung" />
...
<img src={azureAdLogtoAttributeMappingImage} alt="Azure AD_Logto Attributzuordnung" />
