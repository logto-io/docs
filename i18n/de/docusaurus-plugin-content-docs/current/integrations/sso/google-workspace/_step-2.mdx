...
1. Navigiere zur Seite [OAuth-Zustimmungsbildschirm](https://console.cloud.google.com/apis/credentials/consent) und wähle den Benutzertyp `Intern`. Dadurch wird die OAuth-Anwendung nur für Benutzer innerhalb deiner Organisation verfügbar.
