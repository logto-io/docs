...
tags: [认证 (Authentication), sendgrid, dotnet-core-mvc, c#, 无密码登录, 登录, 登录]
title: 如何使用 .NET Core (MVC) 构建 SendGrid Email 无密码登录
sdk: .NET Core (MVC)
connector: SendGrid
---
...
<CreateApplication type="传统 Web" framework=".NET Core (MVC)" />
