...
authors: logto
tags: [认证 (Authentication), sendgrid, next, js, 无密码登录, 登录, 登录]
title: 如何使用 Next.js (Pages Router) 构建 SendGrid Email 无密码登录
---
...
<CreateApplication type="传统 Web" framework="Next.js" />
