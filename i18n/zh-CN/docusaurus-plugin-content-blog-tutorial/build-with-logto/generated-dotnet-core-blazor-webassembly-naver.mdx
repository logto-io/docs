...
authors: logto
tags: [认证 (Authentication), naver, dotnet-core-blazor-webassembly, c#, 社交登录, 登录, 登录]
title: 如何使用 .NET Core (Blazor WebAssembly) 构建 Naver 登录
---
...
import ConnectorGuide from '@site/i18n/zh-CN/docusaurus-plugin-content-docs/current/integrations/social/naver/_integration.mdx';
...
## 在登录体验中启用 Naver 连接器 \{#enable-connector-connector-in-sign-in-experience}
