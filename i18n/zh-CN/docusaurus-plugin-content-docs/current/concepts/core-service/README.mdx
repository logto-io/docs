...
_核心服务_ 是一个用于关键 Logto 职责的单体服务。源代码位于 [`@logto/core`](https://github.com/logto-io/logto/tree/master/packages/core)。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>前端代理</td>
      <td>用于前端项目的 HTTP 代理或静态文件服务。</td>
      <td>
        详情请参见 <a href="#frontend-proxies">前端代理</a>。
      </td>
    </tr>
  </tbody>
</table>
...
前往 [API 参考](https://openapi.logto.io) 查看详细信息。
...
_前端代理_ 是一个以环境相关方式服务于前端项目的中间件函数：
