---
description: 快速通过集成 Logto 启动你的身份和访问管理系统。享受认证 (Authentication)、授权 (Authorization) 和多租户管理于一体的服务。
---
...
欢迎来到 Logto 文档！Logto 是为现代应用和 SaaS 产品设计的身份和访问管理 (IAM) 解决方案。它为你的应用程序提供了一个安全、可扩展且可定制的认证 (Authentication) 和授权 (Authorization) 系统。
...
Logto 的功能建立在四个关键支柱之上，形成了你可以轻松集成到产品或业务中的功能基础。
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      href: '/end-user-flows',
      description:
        '它提供了完整的认证 (Authentication) 流程和用户界面，通过 Logto 控制台和 API 进行广泛的自定义。',
      customProps: {
        icon: <ExperienceIcon />,
      },
    },
    ...
    },
    {
      ...
      label: 'SDKs',
      href: '/quick-starts',
      description: '探索我们的端到端教程和 SDK，以快速开始使用你喜欢的框架。',
      customProps: {
        icon: <SdkIcon />,
      },
    },
  ...
  items={[
    {
      ...
      href: '/logto-cloud',
      description:
        '我们的云服务包括免费、专业和企业计划，以满足各种客户需求。它由 Logto 托管和管理。它还提供开发租户，包含 Logto 的所有功能以供测试。',
      customProps: {
        icon: <CloudIcon />,
      },
    },
...
加入 [Logto Discord](https://discord.com/invite/UEPaF3j5e6) 服务器 —— 一个为开发者和企业提供的活跃社区。参与讨论，保持更新，并分享反馈。

<br />

如果你是身份系统的新手，请阅读这些基本概念以开始：
