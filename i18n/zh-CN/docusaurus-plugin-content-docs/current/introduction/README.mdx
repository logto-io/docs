...
<DocCardList
  items={[
    ...
    },
    {
      ...
      href: '/end-user-flows',
      description:
        '提供完整的认证 (Authentication) 流程和用户界面，包括标识符登录、社交登录、Passkey 登录、多因素认证 (MFA)，并可通过 Logto Console 和 API 进行深度定制。',
      customProps: {
        icon: <ExperienceIcon />,
      },
    },
    ...
    },
    {
      ...
      description:
        '远程 MCP 服务器，将 AI 工具和 IDE 连接到 Logto Cloud，实现资源管理和认证 (Authentication) 集成。',
      customProps: {
        icon: <McpIcon />,
      },
    },
  ...
  items={[
    {
      ...
      href: '/logto-cloud',
      description:
        '我们的云服务包含免费版、专业版和企业版，满足不同客户需求。由 Logto 托管和管理。同时提供 dev tenant，包含 Logto 的全部功能用于测试。',
      customProps: {
        icon: <CloudIcon />,
      },
    },
