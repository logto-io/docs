...
如果我们的标准连接器无法满足你的特定需求，欢迎[联系我们](https://logto.productlane.com/roadmap)。对于 OSS 用户，如果需求紧急，你可以[自行实现连接器 (OSS)](/logto-oss/develop-your-connector/implement-connectors#build-a-passwordless-connector)。我们始终欢迎[贡献](/logto-oss/contribution)；你的努力也许能帮助有相同需求的其他社区成员。
