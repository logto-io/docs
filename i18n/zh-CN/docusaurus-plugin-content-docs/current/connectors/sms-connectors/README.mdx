...
日志 (Logto) 有一些内置的 SMS 连接器，允许开箱即用：
...
<details>
<summary>日志 (Logto) 没有我想用的 SMS 连接器。我该怎么办？</summary>
...
对于开源日志 (Logto) 用户，我们提供了一种易于扩展的连接器创建方法，允许你根据具体场景 [自定义自己的连接器](/logto-oss/develop-your-connector)。我们欢迎你向日志 (Logto) 提交 pull request，以便社区中的其他人也能从你的工作中受益。
