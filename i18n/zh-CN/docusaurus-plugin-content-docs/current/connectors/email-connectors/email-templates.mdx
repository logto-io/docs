...
<img src={builtInEmailTemplateSampleImage} alt="内置邮件模板示例" />
...
### 为不同语言自定义邮件模板 \{#custom-email-templates-for-different-languages}
...
### 提供商侧邮件模板本地化 \{#provider-side-email-template-localization}
...
### 如果 Logto 中未配置模板，如何使用第三方邮件模板服务？ \{#how-to-use-third-party-email-template-services-if-templates-are-not-configured-in-logto}
