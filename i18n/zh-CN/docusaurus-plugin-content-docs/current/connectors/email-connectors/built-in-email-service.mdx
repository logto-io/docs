...
## 统一电子邮件模板 \{#unified-email-templates}
...
<img src={emailServiceTemplateSampleImage} alt="Logto 内置电子邮件服务示例" />

如果没有提供自定义品牌信息，电子邮件模板仍然可以使用默认显示和布局：

<img src={emailServiceTemplateSampleWithoutBrandingImage} alt="Logto 内置电子邮件服务示例无品牌" />
...
### 是否可以向 Logto 电子邮件服务添加自定义 CSS 或 HTML？ \{#is-it-possible-to-add-custom-css-or-html-to-logto-email-service}
