...
5. 在“体验 (Experience)”选项卡中自定义 SSO 体验和**电子邮件域**。
...
在 Logto 中，[即时 (Just-in-Time, JIT) 供应](https://auth.wiki/jit-provisioning) 是一种用于在用户首次登录系统时动态分配组织 (Organization) 成员资格和角色 (Role) 的过程。
