...
为了在登录体验中动态显示客户的组织标志，你可以在组织设置页面上传组织标志。导航到 <CloudLink to="/organizations">控制台 > 组织</CloudLink>。
...
以下是如何在 `signIn` 方法中使用 [Logto 浏览器 SDK](/quick-starts/vanilla-js/#implement-sign-in-and-sign-out) 传递 `organization_id` 参数的示例：
