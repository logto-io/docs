...
阿里云是亚洲主要的云服务提供商，提供包括短信（短消息服务）在内的多种云服务。阿里云短信连接器是 Logto 团队提供的一个插件，借助它，Logto 终端用户可以通过短信验证码注册和登录他们的 Logto 账户。
...
6. 提交短信签名和模板申请后，你需要等待其生效。此时，我们可以返回 [短信服务控制台页面](https://dysms.console.aliyun.com/overview) 并发送测试短信。如果你的签名和模板已准备好使用，可以直接尝试；如果尚未生效，阿里云也提供测试模板。
   - 在发送测试消息之前，你可能需要充值少量金额。
   - 在发送测试消息之前，你可能还需要绑定一个测试电话号码。更多详情，请访问 [短信服务控制台页面](https://dysms.console.aliyun.com/overview) 侧边栏的“快速学习”选项卡。
...
2. 进入你刚访问的“国内消息”或“国际/港澳台消息”选项卡，你可以轻松找到“签名名称”和“模板 CODE”。
   - 如果你想使用仅供测试的签名和模板，请改为进入“快速学习”选项卡，你将在“签名和模板（仅供测试）”下找到它们。
3. 填写阿里云短信连接器设置：
...
你可以输入一个电话号码并点击“发送”以查看设置是否能在“保存并完成”之前工作。
...
- [阿里云短信 - 快速学习](https://dysms.console.aliyun.com/quickstart)
