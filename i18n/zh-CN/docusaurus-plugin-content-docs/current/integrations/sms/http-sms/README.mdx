...
你可以在 [短信模板](/connectors/sms-connectors/sms-templates) 中找到所有类型，并在 [connector-kit](https://github.com/logto-io/logto/tree/master/packages/toolkit/connector-kit/src/types/passwordless.ts) 中查看 `SendMessageData` 的完整类型定义。
