...
<img src="/img/assets/azure_ad_default_attribute_mapping.webp" alt="Azure AD 默认属性映射" />
...
<img src="/img/assets/azure_ad_logto_attribute_mapping.webp" alt="Azure AD_Logto 属性映射" />
