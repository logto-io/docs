...
此连接器仅适用于 Web 应用。如果你正在寻找在原生应用中使用 WeChat 登录的方法，请参阅 [WeChat 原生连接器](/integrations/wechat-native)。
...
<img src={appTabsImage} alt="应用标签" />

在申请表中填写所需信息。

<img src={createWebAppImage} alt="创建网页应用" />
