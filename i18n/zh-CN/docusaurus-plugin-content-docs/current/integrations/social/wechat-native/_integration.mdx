...
我们假设你已经在应用中集成了 [Logto iOS SDK](/quick-starts/swift)。在这种情况下，操作非常简单，甚至无需阅读微信 SDK 文档：
...
我们假设你已经在应用中集成了 [Logto Android SDK](/quick-starts/android)。在这种情况下，操作非常简单，甚至无需阅读微信 SDK 文档：
