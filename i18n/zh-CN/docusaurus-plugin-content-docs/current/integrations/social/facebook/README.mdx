...
### 关联或解绑 Facebook 账户 \{#link-or-unlink-a-facebook-account}

使用 Account API 在你的应用中构建自定义账户中心，让已登录用户可以关联或解绑他们的 Facebook 账户。[参见 Account API 教程](/end-user-flows/account-settings/by-account-api#link-a-new-social-connection)
