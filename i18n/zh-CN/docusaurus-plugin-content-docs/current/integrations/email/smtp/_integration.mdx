...
开发人员可以在 ["Sender Management"](https://mc.sendgrid.com/senders) 访问 _sender_ 详细信息。

### 配置阿里云邮件推送帐户 \{#configure-with-aliyun-direct-mail-account}

登录 [阿里云网站](https://cn.aliyun.com/)。如果没有帐户，请注册一个新帐户。
...
:::note
为了保持简单，前面的案例中只提供了一个示例模板。你应该为其他用例添加更多模板。
...
你还可以配置 [OAuth2 认证选项](https://nodemailer.com/smtp/oauth2/) 和其他高级配置。详情请参见[这里](https://nodemailer.com/smtp/)。
