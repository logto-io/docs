...
- **用户数据对象**
  对于用户访问令牌，Logto 提供了额外的用户数据上下文供你访问。用户数据对象包含你可能需要设置自定义声明的所有用户配置文件数据和组织成员数据。请查看 [用户](/user-management/user-data) 和 [组织](/organizations/organization-data) 以获取更多详细信息。
- **授予数据对象**
  对于通过模拟令牌交换授予的用户访问令牌，Logto 提供了额外的授予数据上下文供你访问。授予数据对象包含来自主体令牌的自定义上下文。请查看 [模拟](/developers/user-impersonation) 以获取更多详细信息。
