...
Logto 提供强大的安全访问管理，专为正面应对这些风险而设计。通过优先考虑主动威胁预防和系统韧性，我们确保你的系统在不影响可用性的前提下始终受到保护。在 Logto，安全不是事后考虑——而是基础，助力企业在威胁不断演变的时代中蓬勃发展，让防御始终快于威胁。
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description: '通过允许名单和阻止临时或不需要的地址，控制新注册和新绑定邮箱。',
      customProps: {
        icon: <BlockUserIcon />,
      },
    },
