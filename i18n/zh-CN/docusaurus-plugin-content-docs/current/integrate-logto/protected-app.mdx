...
## 受保护的应用程序如何工作 \{#how-protected-app-works}
...
<Url href="https://blog.logto.io/protected-app">Protected App 的动机</Url>

<Url href="https://blog.logto.io/fastest-way-to-build-auth-system">构建认证系统的最快方法</Url>
