...
[Logto Cloud](https://cloud.logto.io) 提供了一系列管理和运营服务，帮助你顺畅且轻松地管理身份和资源。由 Logto 托管，包含了如[多区域支持](/logto-cloud/tenant-settings#tenant-region)、租户管理、[计费与定价](/logto-cloud/billing-and-pricing)、[成员管理](/logto-cloud/tenant-member-management)以及控制台基于角色的访问控制 (RBAC) 等功能。
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description:
        '通过 MCP 将 AI 工具和 IDE 连接到 Logto Cloud，管理资源并集成认证 (Authentication)。',
      customProps: {
        icon: <McpIcon />,
      },
    },
