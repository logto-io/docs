...
## 在控制台配置自定义域名 \{#configure-custom-domain-in-console}
...
如果你在添加自定义域名时遇到 “The hostname is associated with a held zone, please contact the owner to have the hold removed” 的错误提示，说明该域名已在 Cloudflare 区域中，并被设置为“Zone Hold”状态。详见 [Cloudflare 官方文档](https://developers.cloudflare.com/fundamentals/setup/account/account-security/zone-holds/)。
