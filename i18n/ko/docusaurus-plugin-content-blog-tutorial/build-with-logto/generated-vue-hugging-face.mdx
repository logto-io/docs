...
tags: [인증, hugging-face, vue, js, 소셜 로그인, 로그인, 로그인]
title: Hugging Face 로그인 을 Vue로 구축하는 방법
sdk: Vue
...
import IntegrateSdk from '@site/i18n/ko/docusaurus-plugin-content-docs/current/quick-starts/framework/vue/_for-tutorial.mdx';
...
## Vue SDK 통합하기 \{#integrate-framework-sdk}
