...
title: Microsoft Entra ID OIDC enterprise SSO를 .NET Core (Blazor Server)로 구축하는 방법
...
import ConnectorGuide from '@site/i18n/ko/docusaurus-plugin-content-docs/current/integrations/sso/entra-id-oidc/_integration.mdx';
...
## Microsoft Entra ID OIDC enterprise SSO 커넥터 추가하기 \{#add-connector-connector}
...
## 로그인 경험에서 Microsoft Entra ID OIDC enterprise SSO 커넥터 활성화하기 \{#enable-connector-connector-in-sign-in-experience}
