...
<DocCardList
  items={[
    ...
    },
    {
      ...
      href: '/quick-starts',
      description:
        '선호하는 프레임워크로 빠르게 시작할 수 있도록 엔드-투-엔드 튜토리얼과 SDK를 제공합니다.',
      customProps: {
        icon: <SdkIcon />,
      },
    },
  ...
  items={[
    {
      ...
      href: '/logto-cloud',
      description:
        '클라우드 서비스는 Free, Pro, Enterprise 플랜을 제공하여 다양한 고객 요구를 충족합니다. Logto가 호스팅 및 관리하며, dev tenant를 통해 모든 기능을 테스트할 수 있습니다.',
      customProps: {
        icon: <CloudIcon />,
      },
    },
