---
description: Logto 를 통합하여 아이덴티티 및 접근 관리 시스템을 빠르게 시작하세요. 인증 (Authentication), 인가 (Authorization), 다중 테넌트 관리를 모두 한 곳에서 즐기세요.
---
...
Logto 문서에 오신 것을 환영합니다! Logto 는 현대 애플리케이션과 SaaS 제품을 위해 설계된 아이덴티티 및 접근 관리 (IAM) 솔루션입니다. 애플리케이션을 위한 안전하고 확장 가능하며 맞춤화 가능한 인증 (Authentication) 및 인가 (Authorization) 시스템을 제공합니다.
...
Logto 의 기능은 네 가지 주요 기둥에 기반하여 구축되었으며, 이를 통해 제품이나 비즈니스에 쉽게 통합할 수 있는 기능의 기초를 형성합니다.
  ...
  items={[
    {
      ...
      description:
        '웹 기반 인터페이스로 리소스를 구성하고 관리하며, 로그인 경험을 빠르게 설정하고 아이덴티티 관리를 쉽게 할 수 있습니다.',
      customProps: {
    ...
    },
    {
      ...
      href: '/end-user-flows',
      description:
        '완전한 인증 흐름과 사용자 인터페이스를 제공하며, Logto Console 및 API 를 통해 광범위한 맞춤화를 제공합니다.',
      customProps: {
        icon: <ExperienceIcon />,
      },
    },
    {
      ...
      description:
        'Logto 의 백엔드는 다양한 인증 (Authentication) 및 인가 (Authorization) 기능을 지원하는 API 모음을 제공하며, Logto Management API, Experience API 및 Account API 를 포함합니다.',
      customProps: {
        icon: <LogtoApiIcon />,
      },
    },
    {
      ...
      href: '/quick-starts',
      description:
        '선호하는 프레임워크로 빠르게 시작할 수 있도록 종단 간 튜토리얼과 SDK 를 탐색하세요.',
      customProps: {
        icon: <SdkIcon />,
      },
    },
  ...
  items={[
    {
      ...
      href: '/logto-cloud',
      description:
        '우리의 클라우드 서비스는 고객의 다양한 요구를 충족시키기 위해 Free, Pro, Enterprise 플랜을 포함합니다. Logto 에 의해 호스팅 및 관리됩니다. 또한 Logto 의 모든 기능을 테스트할 수 있는 개발 테넌트를 제공합니다.',
      customProps: {
        icon: <CloudIcon />,
      },
    },
    {
      ...
      href: '/logto-oss',
      description:
        '자신의 인프라에 Logto 를 자체 호스팅하세요. 자세한 내용은 GitHub 페이지 및 오픈 소스 섹션을 방문하세요.',
      customProps: {
        icon: <OpenSourceIcon />,
      },
    },
...
아이덴티티 시스템에 익숙하지 않은 경우, 시작할 때 다음 필수 개념을 읽어보세요:
