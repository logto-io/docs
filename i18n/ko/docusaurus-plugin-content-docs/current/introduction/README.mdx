...
Logto의 역량은 네 가지 핵심 기둥 위에 구축되어 있으며, 여러분의 제품이나 비즈니스에 쉽게 통합할 수 있는 기능의 기반이 됩니다.
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description:
        'AI 도구 및 IDE를 Logto Cloud에 연결하는 원격 MCP 서버로, 리소스 관리와 인증 (Authentication) 통합을 지원합니다.',
      customProps: {
        icon: <McpIcon />,
      },
    },
