...
새 사용자 또는 비밀번호를 업데이트하는 사용자를 위해 비밀번호 강도 요구 사항을 적용하는 비밀번호 정책을 설정할 수 있습니다. <CloudLink to="/security/password-policy">콘솔 > 보안 > 비밀번호 정책</CloudLink>을 방문하여 비밀번호 정책 설정을 구성하세요.
