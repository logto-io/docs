...
import logtoManagementApiDetailsSrc from '@site/docs/integrate-logto/interact-with-management-api/assets/logto-management-api-details.webp';
import logtoManagementApiResourceSrc from '@site/docs/integrate-logto/interact-with-management-api/assets/logto-management-api-resource.webp';
...
<CloudLink to="/applications">Console > Applications</CloudLink>로 이동하여 "Machine-to-machine"
...
<Url href="https://blog.logto.io/management-api">Logto Management API 사용: 단계별 가이드</Url>

<Url href="https://blog.logto.io/use-postman-to-obtain-m2m-access-token">
  Postman을 사용하여 M2M 액세스 토큰을 몇 분 안에 얻기
</Url>
