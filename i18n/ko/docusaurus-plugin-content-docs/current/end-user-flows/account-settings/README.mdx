...
Logto의 Account API는 즉시 사용할 수 있는 프론트엔드 엔드포인트로, 최종 사용자가 내장된 권한 검사를 통해 자신의 정보를 안전하게 조회하고 업데이트할 수 있습니다. 클라이언트 애플리케이션에 간단히 임베드하여 세련된 셀프 서비스 계정 설정 페이지를 구현하세요.
  ...
  items={[
    {
      ...
      description:
        '사용자 Account API를 활용하여 나만의 계정 설정 페이지를 만드는 방법을 알아보세요.',
      customProps: {
        icon: <GearIcon />,
      },
    },
  ...
  items={[
    {
      ...
      description:
        '사용자 Management API를 활용하여 나만의 계정 설정 페이지를 만드는 방법을 알아보세요.',
      customProps: {
        icon: <GearIcon />,
      },
    },
