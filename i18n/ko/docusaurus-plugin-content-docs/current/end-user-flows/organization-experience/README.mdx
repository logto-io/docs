...
[조직](/organizations) 경험은 비즈니스 고객과 그들의 직원들이 사용하는 UI 및 플로우의 집합입니다. 특히 [다중 테넌트 애플리케이션](https://auth.wiki/multi-tenancy)에서 중요합니다. 이 가이드는 Logto Management API를 사용하여 앱에 통합하는 방법을 보여줍니다.

이 섹션은 최종 사용자에게 **조직 경험**을 설계하는 데 도움을 줍니다. 예를 들어:
...
### Logto Management API 접근하기 \{#access-the-logto-management-api}

- 백엔드 서비스가 Logto Management API에 안전하게 호출합니다.
- 설정 방법은 [Management API와 상호작용하기](/integrate-logto/interact-with-management-api) 가이드를 참고하세요.
- 기계 간 인증 (Machine-to-machine authentication)을 사용하여 액세스 자격 증명을 획득하세요.

다음 장에서는 Logto Management API를 설정하는 방법과 조직 경험을 구축할 때의 일반적인 사용 사례를 안내합니다.
  ...
  items={[
    {
      ...
      description: '조직 역할과 권한으로 다중 테넌트 앱을 직접 설계하세요.',
      customProps: {
    ...
    {
      type: 'link',
      label: 'Logto Management API로 앱 서비스 설정하기',
      href: '/end-user-flows/organization-experience/setup-app-service-with-management-api',
      description:
        '기계 간 인증 (Machine-to-machine authentication)을 사용하여 백엔드를 Logto Management API에 안전하게 연결하세요.',
      customProps: {
        icon: <GearIcon />,
      },
    },
    {
      ...
      description:
        'Logto Management API를 사용하여 최종 사용자가 직접 제품에서 조직을 생성할 수 있도록 하세요.',
      customProps: {
        icon: <OrganizationIcon />,
      },
    },
    ...
    },
    {
      ...
      description: '앱에서 조직 전환 기능을 구현하세요.',
      customProps: {
        icon: <GearIcon />,
      },
    },
    {
      ...
      description: 'Logto Management API를 사용하여 조직 초대 기능을 구현하세요.',
      customProps: {
        icon: <GearIcon />,
      },
    },
    {
      ...
      description: '앱에서 조직 가입 플로우를 구현하세요.',
      customProps: {
        icon: <GearIcon />,
      },
    },
    {
      ...
      description: '조직 내에서 권한과 리소스를 관리하세요.',
      customProps: {
        icon: <GearIcon />,
      },
    },
