...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description: '인증 (Authentication) 플로우에서 동기식 커스텀 코드를 실행하여 사용자를 마이그레이션하거나 정보를 확장할 수 있습니다.',
      customProps: {
        icon: <Action />,
      }
    },
    {
      ...
      description: '인가된 사용자가 최종 사용자를 대신하여 임시로 행동할 수 있도록 허용합니다. 문제 해결, 고객 지원, 관리 작업에 유용합니다.',
      customProps: {
