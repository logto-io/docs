...
### 플러그인 설치 \{#authentication-settings}
...
### 체크포인트: WordPress 웹사이트 테스트 \{#require-verified-email}
...
## 고급 설정 \{#username-strategy}

### 세션 기억하기 \{#troubleshooting}
...
### 프로필 동기화 \{#callback-url-shows-404}
...
### WordPress 폼 로그인 \{#frequently-asked-questions}
...
### 사용자 이름 전략 \{#how-can-i-trigger-the-forgot-password-flow}

WordPress에서 사용자의 사용자 이름을 생성하는 여러 가지 방법이 있습니다. 사용자의 고유 식별자로 이메일을 사용하는 경우 기본 전략을 사용하는 것이 안전합니다.

## 문제 해결 \{#how-can-i-use-the-wordpress-form-login}

### 콜백 URL이 404를 표시합니다 \{#further-readings}
