...
sidebar_custom_props:
  ...
  description: Next.js App Router는 React의 최신 기능을 활용하여 애플리케이션을 구축하는 새로운 패러다임입니다. (Next.js App Router is a new paradigm for building applications using React's latest features.)
language: js
official_link: https://nextjs.org/learn/dashboard-app
app_type: 전통적인 웹 (Traditional web)
