...
2. [Xiaomi Account Service](https://dev.mi.com/passport/oauth2/applist) 를 방문하세요.
3. 애플리케이션이 없다면 새 애플리케이션을 생성하세요.

## Xiaomi OAuth 애플리케이션 구성하기 \{#configure-xiaomi-oauth-application}

1. [Xiaomi Account Service](https://dev.mi.com/passport/oauth2/applist) 를 방문하세요.
2. OAuth 설정을 구성하세요:
...
4. Logto Console의 `clientId` 및 `clientSecret` 필드에 3단계에서 얻은 값을 입력하세요.
5. 선택적 구성:
...
이제 완료되었습니다. [소셜 로그인 활성화](https://docs.logto.io/connectors/social-connectors#enable-social-sign-in) 를 Sign-up 및 Sign-in에서 잊지 말고 설정하세요.
