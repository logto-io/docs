...
tutorial_config_name: Facebook 로그인
---
...
### Facebook 계정 연결 또는 연결 해제 \{#link-or-unlink-a-facebook-account}
...
### Facebook API에 접근 및 작업 수행 \{#access-facebook-api-and-perform-actions}
...
2. **소셜 연결**에서 Facebook 항목을 찾아 **관리**를 클릭하세요.
