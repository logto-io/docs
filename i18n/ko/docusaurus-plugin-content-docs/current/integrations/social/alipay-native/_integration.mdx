...
앱에 <MainSiteUrl href="/quick-starts/swift">Logto iOS SDK</MainSiteUrl>를 통합했다고 가정합니다. 이 경우 매우 간단하며, Alipay SDK 문서를 읽을 필요도 없습니다:
...
앱에 <MainSiteUrl href="/quick-starts/android">Logto Android SDK</MainSiteUrl>를 통합했다고 가정합니다. 이 경우 매우 간단하며, Alipay SDK 문서를 읽을 필요도 없습니다:
