...
사용자 속성 매핑 로직은 Azure AD 측이나 Logto 측에서 관리할 수 있습니다.

1. Logto 측에서 AzureAD 사용자 속성을 Logto 사용자 속성에 매핑합니다.
...
![Azure AD 기본 속성 매핑.webp](./assets/azure_ad_default_attribute_mapping.webp)

1. AzureAD 측에서 AzureAD 사용자 속성을 Logto 사용자 속성에 매핑합니다.

   Azure AD SSO 애플리케이션의 `Attributes & Claims` 섹션을 방문하세요.

   `Edit`를 클릭하고, Logto 사용자 속성 설정에 따라 `Additional claims` 필드를 업데이트하세요:
...
![Azure AD_Logto 속성 매핑.webp](./assets/azure_ad_logto_attribute_mapping.webp)
