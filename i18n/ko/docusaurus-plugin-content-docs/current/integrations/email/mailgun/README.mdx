...
sidebar_custom_props:
  description: Mailgun은 이메일을 보내고, 받고, 추적할 수 있는 이메일 전송 서비스입니다.
---
...
- Mailgun 계정에서 발급받은 API 키 (이메일 전송 권한 필요). 자세한 내용은 [Where Can I Find My API Key and SMTP Credentials?](https://help.mailgun.com/hc/en-us/articles/203380100-Where-Can-I-Find-My-API-Key-and-SMTP-Credentials-)를 참고하세요.
