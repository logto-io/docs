...
- _Aliyun direct mail_ 및 _SendGrid mail_. Logto 팀이 해당 커넥터를 제공했기 때문에 이 두 이메일 서비스 제공자에 익숙할 수 있으며, 일반적인 아이디어를 가질 수 있습니다.

다음 예시를 통해 다른 모든 이메일 제공자의 설정을 파악할 수 있기를 바랍니다 :rocket:
