...
1. <CloudLink to="/organization-template/organization-permissions">콘솔 → 조직 템플릿 → 조직 권한</CloudLink>으로 이동하세요.
...
1. <CloudLink to="/organization-template/organization-roles">콘솔 → 조직 템플릿 → 조직 역할</CloudLink>로 이동하세요.
