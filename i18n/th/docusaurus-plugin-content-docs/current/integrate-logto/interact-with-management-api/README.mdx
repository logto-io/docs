...
Logto Management API คือชุด API ที่ครอบคลุมซึ่งให้ผู้พัฒนาควบคุมการใช้งานได้อย่างเต็มที่เพื่อตอบโจทย์ความต้องการของผลิตภัณฑ์และเทคโนโลยีของตนเอง โดยถูกสร้างไว้ล่วงหน้า แสดงอยู่ใน <CloudLink to="/api-resources">Console > API resources > Logto Management API</CloudLink> และไม่สามารถลบหรือแก้ไขได้
...
- [บทบาท (Roles)](https://openapi.logto.io/operation/operation-listroles)
- [ทรัพยากร (Resources)](https://openapi.logto.io/operation/operation-listresources)
- [ตัวเชื่อมต่อ (Connectors)](https://openapi.logto.io/operation/operation-listconnectors)
- [องค์กร (Organizations)](https://openapi.logto.io/operation/operation-listorganizations)

หากต้องการดู API ทั้งหมดที่มีให้ใช้งาน โปรดเยี่ยมชม https://openapi.logto.io/
...
ในโมดูลกำหนดบทบาท คุณจะเห็นว่ามีบทบาท M2M ทั้งหมด และบทบาทที่มีไอคอน Logto หมายถึงบทบาทเหล่านั้นมีสิทธิ์ Logto Management API รวมอยู่ด้วย
...
## ตัวอย่างสถานการณ์การใช้งาน Logto Management API \{#typical-scenarios-for-using-logto-management-api}

นักพัฒนาของเราได้สร้างฟีเจอร์เพิ่มเติมมากมายโดยใช้ Logto Management API เราเชื่อว่า API ของเราสามารถขยายขนาดได้สูงและรองรับความต้องการที่หลากหลายของคุณ ตัวอย่างสถานการณ์ที่ไม่สามารถทำได้ใน Logto Admin Console แต่สามารถทำได้ผ่าน Logto Management API มีดังนี้

### สร้างโปรไฟล์ผู้ใช้ด้วยตนเอง \{#implement-user-profile-on-your-own}

ขณะนี้ Logto ยังไม่มี UI สำเร็จรูปสำหรับโปรไฟล์ผู้ใช้ เราตระหนักว่าโปรไฟล์ผู้ใช้เกี่ยวข้องกับคุณลักษณะทางธุรกิจและผลิตภัณฑ์อย่างใกล้ชิด ในขณะที่เรากำลังหาวิธีที่เหมาะสมที่สุด ขอแนะนำให้ใช้ API ของเราเพื่อสร้างโซลูชันของคุณเอง เช่น คุณสามารถใช้ interaction API, profile API และ verification code API เพื่อพัฒนาโซลูชันที่ตรงกับความต้องการของคุณ

### ค้นหาผู้ใช้ขั้นสูง \{#advanced-user-search}

Logto Admin Console รองรับฟังก์ชันค้นหาและกรองขั้นพื้นฐาน สำหรับตัวเลือกการค้นหาขั้นสูง เช่น การค้นหาแบบ fuzzy, การจับคู่แบบเป๊ะ และการแยกแยะตัวพิมพ์เล็ก-ใหญ่ โปรดดู [คู่มือการค้นหาผู้ใช้ขั้นสูง](/user-management/advanced-user-search)

### จัดการองค์กรด้วยตนเอง \{#implement-organization-management-on-your-own}

หากคุณใช้ฟีเจอร์ [องค์กร (organizations)](/organizations) เพื่อสร้างแอปหลายผู้เช่า คุณอาจต้องใช้ Logto Management API สำหรับงานเช่น การเชิญองค์กรและการจัดการสมาชิก สำหรับผลิตภัณฑ์ SaaS ของคุณที่มีทั้งผู้ดูแลระบบและสมาชิกใน tenant Logto Management API จะช่วยให้คุณสร้างพอร์ทัลผู้ดูแลระบบที่ปรับแต่งให้เหมาะกับธุรกิจของคุณ ดูรายละเอียดเพิ่มเติมได้ที่ [ที่นี่](/end-user-flows/organization-experience/)
...
ผลลัพธ์ของ API บางรายการอาจมีข้อมูลจำนวนมาก ผลลัพธ์เหล่านี้จะถูกแบ่งหน้า Logto ให้ข้อมูลแบ่งหน้า 2 แบบ
...
### อัตราการร้องขอ (Rate limit) \{#rate-limit}

:::note
ใช้เฉพาะกับ Logto Cloud เท่านั้น
:::

Logto Cloud ใช้ข้อจำกัดอัตราการร้องขอระดับ tenant เพื่อปกป้องเสถียรภาพของระบบ ดูรายละเอียดได้ที่ [system limit rate-limit section](/logto-cloud/system-limit#rate-limit)
