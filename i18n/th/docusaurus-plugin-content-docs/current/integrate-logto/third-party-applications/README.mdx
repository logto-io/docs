...
หากต้องการจำกัดว่าผู้ใช้ใดสามารถลงชื่อเข้าใช้แอปพลิเคชันบุคคลที่สาม ให้กำหนดค่า [การควบคุมการเข้าถึงระดับแอป](/integrate-logto/app-level-access-control) ในแท็บ **Rules** ของแอปพลิเคชันนั้น
