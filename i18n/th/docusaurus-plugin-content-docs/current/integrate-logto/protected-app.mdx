...
หากต้องการจำกัดว่าผู้ใช้ที่ได้รับการยืนยันตัวตนคนใดสามารถเข้าถึง Protected App ได้ ให้กำหนดค่า [การควบคุมการเข้าถึงระดับแอป](/authorization/app-level-access-control) ในแท็บ **Rules** ของแอปพลิเคชัน
