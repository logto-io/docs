...
- **v2**: เปิดประสบการณ์การลงชื่อเข้าใช้ใน WebView แบบฝัง ซึ่งจำเป็นสำหรับ social connector แบบเนทีฟ แต่ไม่รองรับ [การลงชื่อเข้าใช้ด้วย passkey](/end-user-flows/sign-up-and-sign-in/passkey-sign-in) (WebView ไม่รองรับ WebAuthn ซึ่งเป็นมาตรฐานพื้นฐานของ passkey)
- **v3 (beta)**: เปิดประสบการณ์การลงชื่อเข้าใช้ใน [Chrome Custom Tabs](https://developer.android.com/develop/ui/views/layout/webapps/overview-of-android-custom-tabs) (เบราว์เซอร์ของระบบ) ซึ่งเปิดใช้งานการลงชื่อเข้าใช้ด้วย passkey และแชร์ session ของเบราว์เซอร์ โปรดทราบว่า v3 ยกเลิกการรองรับ connector [WeChat (Native)](/integrations/wechat-native) และ [Alipay (Native)](/integrations/alipay-native) คุณสามารถใช้ [WeChat (Web)](/integrations/wechat-web) และ [Alipay (Web)](/integrations/alipay-web) แทนได้ ซึ่งทำงานผ่านเบราว์เซอร์ หากคุณพึ่งพา connector แบบเนทีฟ ให้ใช้ v2 ต่อไป
