...
| Organization.Membership.Updated | ผู้ใช้หรือแอปพลิเคชันถูกเพิ่มหรือลบออกจากองค์กร ข้อมูลที่ส่งมารวมถึง [ฟิลด์การเปลี่ยนแปลงสมาชิก](/developers/webhooks/request#organizationmembershipupdated-payload) |
