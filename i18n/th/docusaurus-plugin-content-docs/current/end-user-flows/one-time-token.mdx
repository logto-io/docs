...
หรือคุณอาจลืมรหัสผ่านและต้องการลงชื่อเข้าใช้ / รีเซ็ตรหัสผ่านโดยตรวจสอบตัวตนอย่างรวดเร็วผ่านอีเมล
...
ก่อนเริ่มต้น โปรดตรวจสอบให้แน่ใจว่าคุณมี Logto instance พร้อมใช้งาน และได้ตั้งค่าการเชื่อมต่อ Machine-to-Machine ระหว่างเซิร์ฟเวอร์แอปพลิเคชันของคุณกับ Logto endpoint (จำเป็นสำหรับ Management API) ดูเพิ่มเติมเกี่ยวกับ [Logto Management API](/integrate-logto/interact-with-management-api)
...
### ขั้นตอนที่ 4: (ไม่บังคับ) ลบโทเค็นที่แคชไว้ในหน้า callback ของการลงชื่อเข้าใช้ \{#step-4-clear-cached-tokens-in-sign-in-callback-page}
...
กระบวนการยืนยันตัวตนด้วย magic link ไม่รองรับการกำหนดบทบาทให้ผู้ใช้โดยตรง แต่คุณสามารถใช้ [Webhooks](/developers/webhooks) และ [Management API](/user-management/manage-users#manage-roles-of-users) เพื่ออัปเดตบทบาทของผู้ใช้หลังจากลงทะเบียนได้
