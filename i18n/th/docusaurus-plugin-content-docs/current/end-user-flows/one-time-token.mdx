...
ก่อนเริ่มต้น ให้แน่ใจว่าคุณมี Logto instance พร้อมใช้งาน และได้เชื่อมต่อ Machine-to-Machine ระหว่างเซิร์ฟเวอร์แอปของคุณกับ Logto endpoint (จำเป็นสำหรับ Management API) ดูเพิ่มเติมเกี่ยวกับ [Logto Management API](/integrate-logto/interact-with-management-api)
...
สำหรับลิงก์วิเศษรีเซ็ตรหัสผ่าน พารามิเตอร์อีเมลเป็นทางเลือก; หากไม่ใส่ Logto จะขอให้ผู้ใช้กรอกอีเมลก่อนตรวจสอบโทเค็น
ลิงก์วิเศษควรนำไปยัง landing page ในแอปของคุณเอง
...
หากคุณมีอีเมลของผู้ใช้จาก landing page แล้ว ให้ส่งผ่าน `login_hint` ด้วย; หากไม่มีก็ไม่ต้องใส่ Logto จะขอให้ผู้ใช้กรอกอีเมลก่อนตรวจสอบโทเค็น
...
หากผู้ใช้ลงชื่อเข้าใช้แล้ว การเรียกใช้ฟังก์ชัน `signIn()` จาก SDK จะล้างโทเค็นที่แคชไว้ทั้งหมด (โทเค็น ID, โทเค็นการเข้าถึง, และโทเค็นรีเฟรช) ออกจาก storage ฝั่ง client
...
หากกำหนดค่านี้ คุณจะต้องลบโทเค็นด้วยตนเองในหน้าคอลแบ็กของ sign-in
...
ได้ คุณสามารถใช้ลิงก์วิเศษเพื่อเชิญผู้ใช้ใหม่เข้าสู่แอปพลิเคชันของคุณ รวมถึงองค์กรด้วย
...
### ฉันสามารถกำหนดบทบาทให้ผู้ใช้ผ่านลิงก์วิเศษได้หรือไม่? \{#can-i-assign-users-to-specific-roles-using-the-magic-link}
...
### จะเกิดอะไรขึ้นหากผู้ใช้ลงชื่อเข้าใช้แล้ว แล้วคลิกอีกลิงก์วิเศษหนึ่ง? \{#what-will-happen-if-a-user-already-signed-in-and-then-click-another-magic-link}
