...
2. **เก็บข้อมูลติดต่อของผู้ใช้**: ตรวจสอบให้แน่ใจว่าผู้ใช้มีอีเมล / เบอร์โทรศัพท์ที่ลงทะเบียนไว้ระหว่าง [สมัครสมาชิก](/end-user-flows/sign-up-and-sign-in/sign-up) หรือผ่าน [การตั้งค่าบัญชี](/end-user-flows/account-settings/by-account-api#update-or-link-new-email)
...
5. **กรอกรหัสยืนยัน**: ผู้ใช้กรอกรหัสยืนยันที่ได้รับทางอีเมลหรือโทรศัพท์ Logto จะตรวจสอบรหัสและตัวตนของผู้ใช้ที่เกี่ยวข้องกับอีเมลหรือเบอร์โทรศัพท์นั้น
...
ผู้ใช้ที่ผ่านการยืนยันตัวตนแล้วสามารถเปลี่ยน (หรือตั้ง) รหัสผ่านของตนได้ผ่านประสบการณ์การตั้งค่าบัญชีในแอปของคุณ ดู [การตั้งค่าบัญชี](/end-user-flows/account-settings/by-account-api#update-users-password) สำหรับวิธีสร้างฟีเจอร์นี้ด้วย Account API
...
คุณสามารถสร้าง endpoint รีเซ็ตรหัสผ่านแบบ self-hosted และใช้ Logto SDK เพื่อเริ่มคำขอลงชื่อเข้าใช้โดยตั้งค่า [`first_screen`](/end-user-flows/authentication-parameters/first-screen) เป็น `reset-password` ซึ่งจะนำผู้ใช้ไปยังหน้าตั้งรหัสผ่านใหม่โดยอัตโนมัติ
