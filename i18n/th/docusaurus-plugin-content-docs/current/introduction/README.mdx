...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description:
        'แบ็กเอนด์ของ Logto มีชุด API สำหรับฟังก์ชันการยืนยันตัวตน (Authentication) และการอนุญาต (Authorization) หลากหลาย รวมถึง Logto Management API, Experience API และ Account API',
      customProps: {
        icon: <LogtoApiIcon />,
      },
    },
  ...
  items={[
    {
      ...
      href: '/logto-cloud',
      description:
        'บริการคลาวด์ของเรามีทั้งแพ็กเกจ Free, Pro และ Enterprise เพื่อตอบโจทย์ลูกค้าหลากหลายรูปแบบ โดยโฮสต์และดูแลโดย Logto พร้อม dev tenant สำหรับทดสอบฟีเจอร์ทั้งหมดของ Logto',
      customProps: {
        icon: <CloudIcon />,
      },
    },
