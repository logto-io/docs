...
<DocCardList
  items={[
    ...
    },
    {
      ...
      href: '/end-user-flows',
      description:
        'มอบกระบวนการยืนยันตัวตน (Authentication) ที่สมบูรณ์และอินเทอร์เฟซผู้ใช้ พร้อมการปรับแต่งอย่างยืดหยุ่นผ่าน Logto Console และ API',
      customProps: {
        icon: <ExperienceIcon />,
      },
    },
    {
      ...
      description:
        'แบ็กเอนด์ของ Logto มีชุด API สำหรับรองรับฟังก์ชันการยืนยันตัวตน (Authentication) และการอนุญาต (Authorization) หลากหลาย รวมถึง Logto Management API, Experience API และ Account API',
      customProps: {
        icon: <LogtoApiIcon />,
      },
    },
    {
      ...
      href: '/quick-starts',
      description:
        'สำรวจบทเรียนและ SDK แบบครบวงจรของเรา เพื่อเริ่มต้นกับเฟรมเวิร์กที่คุณต้องการได้อย่างรวดเร็ว',
      customProps: {
        icon: <SdkIcon />,
      },
    },
  ...
  items={[
    {
      ...
      href: '/logto-cloud',
      description:
        'บริการคลาวด์ของเรามีทั้งแพ็กเกจ Free, Pro และ Enterprise เพื่อตอบโจทย์ลูกค้าหลากหลายรูปแบบ โดยโฮสต์และดูแลโดย Logto พร้อม dev tenant สำหรับทดสอบฟีเจอร์ทั้งหมดใน Logto',
      customProps: {
        icon: <CloudIcon />,
      },
    },
...
หากคุณยังใหม่กับระบบเอกลักษณ์ กรุณาอ่านแนวคิดสำคัญเหล่านี้ก่อนเริ่มต้น:
