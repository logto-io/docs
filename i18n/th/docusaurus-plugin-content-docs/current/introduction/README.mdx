...
ความสามารถของ Logto ถูกสร้างบนเสาหลัก 4 ด้าน ซึ่งเป็นรากฐานของฟีเจอร์ที่คุณสามารถผสานเข้ากับผลิตภัณฑ์หรือธุรกิจของคุณได้อย่างง่ายดาย
  ...
  items={[
    {
      ...
      description:
        'อินเทอร์เฟซบนเว็บสำหรับตั้งค่าและจัดการทรัพยากร ช่วยให้ตั้งค่าประสบการณ์การลงชื่อเข้าใช้และจัดการเอกลักษณ์ได้อย่างรวดเร็ว',
      customProps: {
    ...
    },
    {
      ...
      href: '/end-user-flows',
      description:
        'มอบกระบวนการยืนยันตัวตน (Authentication) และอินเทอร์เฟซผู้ใช้ที่ครบถ้วน รวมถึงการลงชื่อเข้าใช้ด้วยตัวระบุ, การลงชื่อเข้าใช้โซเชียล, การลงชื่อเข้าใช้ด้วย passkey, MFA และการปรับแต่งอย่างกว้างขวางผ่าน Logto Console และ API',
      customProps: {
        icon: <ExperienceIcon />,
      },
    },
  ...
  items={[
    {
      ...
      href: '/logto-cloud',
      description:
        'บริการคลาวด์ของเรามีทั้งแพ็กเกจ Free, Pro และ Enterprise เพื่อตอบโจทย์ลูกค้าหลากหลายรูปแบบ โดย Logto เป็นผู้โฮสต์และดูแลทั้งหมด พร้อม dev tenant สำหรับทดสอบฟีเจอร์ทั้งหมดใน Logto',
      customProps: {
        icon: <CloudIcon />,
      },
    },
