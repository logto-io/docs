...
sidebar_custom_props:
  description: Alipay เป็นแพลตฟอร์มการชำระเงินผ่านมือถือและออนไลน์ของบุคคลที่สาม
...
6. ไปที่ [Alipay Customer Center](https://b.alipay.com/index2.htm) และลงชื่อเข้าใช้ด้วยบัญชีนักพัฒนา Alipay คลิก "Account Center" (账号中心) ที่แถบด้านบนและไปที่ "APPID binding" (APPID 绑定) ซึ่งสามารถพบทางเข้าได้ที่ด้านล่างของแถบด้านข้าง "Add binding" (添加绑定) โดยกรอก APPID ของเว็บแอปที่คุณสร้างในขั้นตอนที่ 4
...
3. กรอกการตั้งค่าตัวเชื่อมต่อ Logto:
   ...
   - กรอกช่อง `scope` ด้วย 'auth_base' หรือ 'auth_user' คุณสามารถเว้นว่างช่องนี้ได้เพราะเป็นตัวเลือก ค่าเริ่มต้นคือ 'auth_user' คุณสามารถดู [ความแตกต่าง](https://opendocs.alipay.com/fw/api/105942) ระหว่างค่าแต่ละแบบได้

### ประเภทของการตั้งค่า (Config types) \{#config-types}
...
เรียบร้อยแล้ว อย่าลืม [เปิดใช้งานตัวเชื่อมต่อโซเชียลในหน้าสมัครและเข้าสู่ระบบ](/connectors/social-connectors/#enable-social-sign-in)
