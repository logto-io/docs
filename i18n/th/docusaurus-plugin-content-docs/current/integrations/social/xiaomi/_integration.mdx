...
## ตั้งค่าแอปพลิเคชัน OAuth ของ Xiaomi \{#configure-xiaomi-oauth-application}
...
2. ตั้งค่าการตั้งค่า OAuth:
   ...
   - เพิ่ม URL การเรียกกลับการอนุญาต: `${your_logto_origin}/callback/${connector_id}`
...
เสร็จเรียบร้อย อย่าลืม [เปิดใช้งานการเข้าสู่ระบบโซเชียล](https://docs.logto.io/connectors/social-connectors#enable-social-sign-in) ในขั้นตอนการสมัครและเข้าสู่ระบบ
