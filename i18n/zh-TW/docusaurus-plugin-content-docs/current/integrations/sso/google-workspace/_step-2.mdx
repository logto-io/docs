...
<img src={googleWorkspaceConsentScreenSettingsImage} alt="Google Workspace 使用者授權頁面設定" />

3. 設定應用程式的 `Scopes`。為了正確從 IdP 檢索使用者的身分資訊和電子郵件地址，Logto SSO 連接器需要從 IdP 授予以下權限範圍：

<img src={googleWorkspaceConsentScreenScopesImage} alt="Google Workspace 使用者授權頁面權限範圍" />
