...
sidebar_custom_props:
  description: Tencent 提供雲端運算服務給線上企業。
...
### 建立 Tencent Cloud 帳戶 \{#references}
...
6. 提交簽名和模板以供審核。提交後：
   - 等待其生效。
   - 可以從「[短信服務控制台概覽](https://console.cloud.tencent.com/smsv2)」發送測試短信。已批准的簽名和模板可直接用於測試，或在審核中使用提供的測試模板。
