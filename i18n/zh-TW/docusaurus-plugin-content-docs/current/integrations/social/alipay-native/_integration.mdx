...
假設你已在應用中整合 <MainSiteUrl href="/quick-starts/swift">Logto iOS SDK</MainSiteUrl>。這樣一來，流程非常簡單，甚至不需要閱讀 Alipay SDK 文件：
...
假設你已在應用中整合 <MainSiteUrl href="/quick-starts/android">Logto Android SDK</MainSiteUrl>。這樣一來，流程非常簡單，甚至不需要閱讀 Alipay SDK 文件：
