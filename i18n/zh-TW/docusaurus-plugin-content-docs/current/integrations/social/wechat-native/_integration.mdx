...
假設你已在 App 中整合 <MainSiteUrl href="/quick-starts/swift">Logto iOS SDK</MainSiteUrl>。這種情況下操作非常簡單，甚至不用看微信 SDK 文件：
...
假設你已在 App 中整合 <MainSiteUrl href="/quick-starts/android">Logto Android SDK</MainSiteUrl>。這種情況下操作非常簡單，甚至不用看微信 SDK 文件：
