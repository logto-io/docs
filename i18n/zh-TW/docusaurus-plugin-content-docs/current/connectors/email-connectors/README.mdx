...
若我們的標準連接器無法滿足你的特殊需求，歡迎 [聯絡我們](https://logto.productlane.com/roadmap)。若你是 OSS 使用者且需求緊急，也可 [自行實作連接器 (OSS)](/logto-oss/develop-your-connector/implement-connectors#build-a-passwordless-connector)。我們也歡迎 [貢獻](/logto-oss/contribution)；你的努力可能幫助到有相同需求的社群成員。
