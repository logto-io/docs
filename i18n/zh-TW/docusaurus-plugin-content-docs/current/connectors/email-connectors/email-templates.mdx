...
## 電子郵件範本類型 \{#email-template-customization-options}
...
## 電子郵件範本本地化 \{#email-template-examples}

### 不同語言的自訂電子郵件範本 \{#email-template-localization}
...
### 提供商端的電子郵件範本本地化 \{#custom-email-templates-for-different-languages}
...
## 常見問題 \{#provider-side-email-template-localization}

<details>
<summary>

### 如果 Logto 中未配置範本，如何使用第三方電子郵件範本服務？ \{#faqs}
...
### 是否有辦法使用 Logto 電子郵件發送自訂的「歡迎電子郵件」給我們的使用者？ \{#how-to-use-third-party-email-template-services-if-templates-are-not-configured-in-logto}
...
## 相關資源 \{#is-there-a-way-to-use-logto-email-for-sending-our-users-a-customized-welcome-email}
