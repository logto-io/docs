...
本指南將向你展示如何將 Logto 整合到你的使用 [Auth.js](https://authjs.dev/)（前稱 Next Auth）的 Next.js 應用程式中。
...
- 已建立的 Logto 傳統應用程式。
- 一個包含 Auth.js 的 Next.js 專案，請查看 [Auth.js 文件](https://authjs.dev/getting-started/installation)。
