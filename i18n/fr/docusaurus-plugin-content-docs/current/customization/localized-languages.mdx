...
1. **Accédez à** : <CloudLink to="/sign-in-experience/content">Console > Connexion & compte > Contenu > Langues</CloudLink>.
...
| Valeurs personnalisées   | Les valeurs personnalisées sont celles qui ont déjà été modifiées par les utilisateurs. Les valeurs sources Logto seront écrasées.                                                                                                         |
...
L’internationalisation de l’expérience de connexion Logto rend possible la personnalisation de la langue.
...
Supposons que vous ne souhaitiez ajuster qu’un sous-ensemble des textes originaux fournis par Logto. La seule différence entre votre écran d’inscription et celui fourni par Logto sera les clés que vous avez modifiées. Le reste du contenu restera inchangé.
...
L’indicatif téléphonique dans l’[expérience de connexion](/end-user-flows/sign-up-and-sign-in/sign-up) est par défaut celui de la langue du navigateur de l’utilisateur. Par exemple, si la langue du navigateur est définie sur `fr`, l’indicatif sera celui de la France (+33).
