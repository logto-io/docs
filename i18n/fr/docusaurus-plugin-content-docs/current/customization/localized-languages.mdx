...
| Valeurs sources de Logto | Les valeurs sources de Logto sont des valeurs fournies par Logto qui n'ont pas été personnalisées par les utilisateurs.                                                                                                                                          |
| Valeurs personnalisées   | Les valeurs personnalisées sont des valeurs qui ont déjà été personnalisées par les utilisateurs. Les valeurs sources de Logto seront remplacées.                                                                                                                |
...
Vous pouvez également utiliser l'API [PATCH /api/sign-in-exp](https://openapi.logto.io/group/endpoint-sign-in-experience) pour contrôler les [politiques de détection de la langue](https://openapi.logto.io/operation/operation-getsigninexp#operation-getsigninexp-200-body-application-json-languageinfo).
...
Supposons que vous ne souhaitiez apporter des ajustements qu'à un sous-ensemble des copies de contenu originales fournies par Logto. La seule différence entre votre écran d'inscription et celui fourni par Logto sera les clés que vous avez modifiées. Le reste du contenu restera inchangé.
