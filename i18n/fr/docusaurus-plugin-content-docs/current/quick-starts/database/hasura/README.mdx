...
<img src={hasuraApiWithScopesImage} alt="Hasura API avec scopes" />

<img src={userReaderRoleImage} alt="Rôle lecteur utilisateur" />

<img src={userMaintainerRoleImage} alt="Rôle mainteneur utilisateur" />
...
<img src={hasuraJwtConfigImage} alt="Configuration JWT Hasura" />
...
<img src={userAccessTokenScriptImage} alt="Script de jeton d’accès utilisateur" />
...
<img src={userWithRolesImage} alt="Utilisateur avec rôles" />
