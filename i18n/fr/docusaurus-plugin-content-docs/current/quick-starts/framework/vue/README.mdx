...
sidebar_custom_props:
  description: Vue.js est un framework JavaScript progressif et adoptable de manière incrémentielle pour construire des interfaces utilisateur sur le web.
---
