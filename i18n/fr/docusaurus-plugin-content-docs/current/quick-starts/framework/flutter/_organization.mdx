...
### Récupérer un jeton d’accès pour les organisations \{#fetch-access-token-for-organizations}

Tout comme les ressources API, vous pouvez également demander un jeton d’accès pour les organisations. Cela est utile lorsque vous devez accéder à des ressources définies en utilisant la portée de l'organisation au lieu de la portée de la ressource API.
