...
- **v2** : Ouvre l'expérience de connexion dans une WebView intégrée, ce qui est requis par les connecteurs sociaux natifs, mais ne prend pas en charge la [connexion par passkey](/end-user-flows/sign-up-and-sign-in/passkey-sign-in) (WebView ne prend pas en charge WebAuthn, la norme sous-jacente des passkeys).
- **v3 (beta)** : Ouvre l'expérience de connexion dans les [Chrome Custom Tabs](https://developer.android.com/develop/ui/views/layout/webapps/overview-of-android-custom-tabs) (le navigateur système), ce qui permet la connexion par passkey et partage la session du navigateur. Notez que v3 supprime la prise en charge des connecteurs [WeChat (Native)](/integrations/wechat-native) et [Alipay (Native)](/integrations/alipay-native) ; vous pouvez utiliser [WeChat (Web)](/integrations/wechat-web) et [Alipay (Web)](/integrations/alipay-web) à la place, qui fonctionnent via le navigateur. Si vous dépendez des connecteurs natifs, restez sur v2.
