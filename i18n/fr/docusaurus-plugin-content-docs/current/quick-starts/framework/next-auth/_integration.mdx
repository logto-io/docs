...
3. Personnalisez la fonction `profile` pour mapper le profil utilisateur à l'objet utilisateur de Next Auth, le mappage par défaut est montré dans l'exemple.
