...
### Exemple 2 : Ajouter des suppléments ou effectuer des changements affectera vos factures à venir \{#example-2-adding-add-ons-or-making-changes-will-affect-your-upcoming-bills}
...
### Comment est déterminé le temps d'utilisation des suppléments ? \{#how-is-the-add-on-usage-time-determined}
