...
| ----------------------------------- | ------------- | -------------------------------- |
| **Jetons (Tokens)**                 | 1 million     | 80 $ **_par million_** de jetons |
...
Si vous vous désabonnez du plan Pro, nous vous rembourserons le coût supplémentaire non utilisé, et le montant sera déduit de votre facture finale.
...
### Mise à niveau du plan Pro vers le plan Entreprise \{#pro-plan-upgrade-to-enterprise}
