...
<img src={roleOrderAdminImage} width="60%" alt="Rôle d'admin des commandes" />
...
- **_Admin des commandes_** peut gérer les commandes et voir les produits (car les commandes se composent de produits), mais ne peut pas gérer les produits.
- **_Admin des produits_** peut gérer les produits, et ils ne devraient pas être au courant de toutes les commandes.
