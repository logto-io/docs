...
- [Logto Management API - rôle d’organisation](https://openapi.logto.io/operation/operation-updateorganizationrole).
- [Logto Management API - permission d’organisation](https://openapi.logto.io/operation/operation-listorganizationscopes).
