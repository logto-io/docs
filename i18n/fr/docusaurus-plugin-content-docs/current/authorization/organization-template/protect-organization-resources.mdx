...
## Étape 1 : Obtenir les identifiants d'organisation à partir du flux OIDC
...
### Optionnel : Obtenir les rôles d'organisation
...
## Étape 2. Récupérer le jeton d'organisation
...
### Ajouter des paramètres à la requête d'authentification
...
### Récupérer le jeton d'organisation
...
### Récupérer le jeton d'organisation pour une application machine-à-machine
...
## Étape 3. Vérifier les jetons d'organisation
