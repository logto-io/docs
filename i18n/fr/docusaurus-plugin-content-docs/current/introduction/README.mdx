...
Bienvenue dans la documentation Logto ! Logto est une solution de gestion des identités et des accès (IAM) conçue pour les applications modernes et les produits SaaS. Elle fournit un système sécurisé, évolutif et personnalisable d’authentification (Authentication) et d’autorisation (Authorization) pour vos applications.
...
## Explorer par outils de support \{#explore-by-support-toolkit}
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      href: '/end-user-flows',
      description:
        'Elle propose un parcours complet d’authentification (Authentication) et une interface utilisateur, avec une personnalisation avancée via Logto Console et l’API.',
      customProps: {
        icon: <ExperienceIcon />,
      },
    },
  ...
  items={[
    {
      ...
      href: '/logto-cloud',
      description:
        'Notre service cloud inclut des offres Free, Pro et Enterprise pour répondre à une variété de besoins clients. Il est hébergé et géré par Logto. Il propose également un tenant dev incluant toutes les fonctionnalités de Logto pour tester.',
      customProps: {
        icon: <CloudIcon />,
      },
    },
