...
L'approvisionnement JIT est une fonctionnalité utile pour les produits [B2B](/introduction/plan-your-architecture/b2b) et multi-tenants. Il facilite l'intégration des membres des locataires sans nécessiter d'intervention administrative.
