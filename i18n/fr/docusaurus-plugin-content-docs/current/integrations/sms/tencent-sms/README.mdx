...
### Créer un compte Tencent Cloud \{#references}
...
1. Connectez-vous avec votre compte sur le [site Web de Tencent Cloud](https://cloud.tencent.com/) et allez à la [page de la console de service SMS](https://cloud.tencent.com/product/sms).
...
4. Sur la “[SMS Console Overview](https://console.cloud.tencent.com/smsv2)” (短信服务控制台概览), choisissez “Domestic Messages”(国内消息) ou “International/Hong Kong, Macao, Taiwan Messages”(国际/港澳台消息) dans la barre latérale en fonction de vos besoins.
...
6. Soumettez la signature et le modèle pour approbation. Après soumission :
   ...
   - Un test SMS peut être envoyé depuis la “[SMS Console Overview](https://console.cloud.tencent.com/smsv2)” (短信服务控制台概览). Les signatures et modèles approuvés peuvent être utilisés directement pour les tests, ou utilisez les modèles de test fournis s'ils sont encore en cours de révision.
...
- [Comment implémenter la fonction de code de vérification par SMS ?](https://cloud.tencent.com/document/product/382/43070)
