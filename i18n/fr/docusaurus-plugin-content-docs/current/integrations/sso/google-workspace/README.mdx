...
## Étape 3 : Créer une nouvelle information d'identification OAuth
...
## Étape 4 : Configurer le connecteur Logto avec les informations d'identification du client
...
## Étape 6 : Définir les domaines email et activer le connecteur SSO
