...
Pour tous les types de flux, nous avons fourni une clé OPTIONNELLE `customConfig` pour placer vos paramètres personnalisés.
...
Utilisez l’Account API pour créer un Centre de compte personnalisé dans votre application permettant aux utilisateurs connectés de lier ou délier leurs comptes sociaux. [Suivez le tutoriel Account API](/end-user-flows/account-settings/by-account-api#link-a-new-social-connection)
