...
# Configurer la connexion sociale avec GitHub via OAuth App (Set up social login with GitHub via OAuth App)

Intégrez GitHub OAuth App pour activer la connexion avec GitHub, la liaison de comptes et l'accès sécurisé aux API GitHub.

<GuideTip />

## Commencer \{#get-started}

Le connecteur GitHub permet l'intégration OAuth 2.0 pour permettre à votre application de :
...
2. Cliquez sur **Ajouter un connecteur social**, sélectionnez **GitHub**, cliquez sur **Suivant**, et suivez le tutoriel étape par étape pour finaliser l'intégration.
...
<Url href="https://docs.github.com/en/developers/apps/building-oauth-apps/creating-an-oauth-app">
  Documentation développeur GitHub - Créer une OAuth App
</Url>

<Url href="https://docs.github.com/en/apps/oauth-apps/building-oauth-apps/scopes-for-oauth-apps">
  Documentation sur les portées des OAuth Apps GitHub
</Url>
