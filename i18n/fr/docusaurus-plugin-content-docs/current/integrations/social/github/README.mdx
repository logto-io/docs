...
3. Sur cette page, les administrateurs peuvent gérer la connexion GitHub de l'utilisateur, voir toutes les informations de profil accordées et synchronisées depuis son compte GitHub, et vérifier le statut du jeton d’accès.
