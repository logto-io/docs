...
`clientId` et `clientSecret` peuvent être trouvés sur la page de détails de votre application OAuth.
...
| Champs ProfileMap | Type   | Obligatoire | Valeur par défaut |
| ----------------- | ------ | ----------- | ----------------- |
| id                | string | false       | id                |
