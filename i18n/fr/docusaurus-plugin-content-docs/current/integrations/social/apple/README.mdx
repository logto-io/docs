...
C'est tout. Le connecteur Apple devrait être disponible dans les applications web et natives. N'oubliez pas d'<MainSiteUrl href="/connectors/social-connectors#enable-social-sign-in">Activer le connecteur social dans l'expérience de connexion</MainSiteUrl>.
