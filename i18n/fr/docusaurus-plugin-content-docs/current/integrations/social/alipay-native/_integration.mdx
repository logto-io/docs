...
Nous supposons que vous avez intégré le <MainSiteUrl href="/quick-starts/swift">Logto iOS SDK</MainSiteUrl> dans votre application. Dans ce cas, les choses sont très simples, et vous n’avez même pas besoin de lire la documentation du SDK Alipay :
...
Nous supposons que vous avez intégré le <MainSiteUrl href="/quick-starts/android">Logto Android SDK</MainSiteUrl> dans votre application. Dans ce cas, les choses sont très simples, et vous n’avez même pas besoin de lire la documentation du SDK Alipay :
