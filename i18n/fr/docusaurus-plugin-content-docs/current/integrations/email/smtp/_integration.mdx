...
Nous proposons maintenant des guides sur l'utilisation du connecteur SMTP pour envoyer des e-mails avec les fournisseurs suivants pour une meilleure compréhension :
...
Suivez le guide [Envoyer des e-mails en utilisant SMTP](https://www.alibabacloud.com/help/en/directmail/latest/send-emails-using-smtp) et terminez ces 'tâches' pour obtenir les paramètres et informations requis.
