...
Les Webhooks offrent une communication en temps réel entre les applications, éliminant le besoin de scrutation et permettant des mises à jour immédiates des données. Ils simplifient l'intégration des applications et l'automatisation des flux de travail sans code complexe ni API propriétaires.
...
- **Synchronisation des données :** Configurez un Webhook pour maintenir l'application à jour sur les changements tels que les suspensions ou suppressions de comptes utilisateurs.
...
| Élément                                                                                                                                                                                                                            | Description                                                                                                                                                                                                                                                 |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Événement                                                                                                                                                                                                                          | Lorsqu'une action spécifique est effectuée, elle déclenche un événement de hook avec un type spécifique. Par exemple, Logto émettra un événement de hook PostRegister lorsque l'utilisateur a terminé le processus d'inscription et créé un nouveau compte. |
