...
1. Accédez à <CloudLink to="/tenant-settings/oidc-configs">Console > Clés de signature</CloudLink>. À partir de là, vous pouvez gérer à la fois les clés privées OIDC et les clés de cookie OIDC.
...
3. Vous trouverez un tableau qui liste toutes les clés de signature en cours d'utilisation. Remarque : Vous pouvez supprimer la clé précédente, mais vous ne pouvez pas supprimer la clé actuelle.

   | Statut     | Description                                                                                                                          |
   | ---------- | ------------------------------------------------------------------------------------------------------------------------------------ |
   | Actuelle   | Indique que cette clé est actuellement utilisée activement dans vos applications et APIs.                                            |
