...
1. Rendez-vous sur <CloudLink to="/tenant-settings/oidc-configs">Console > Paramètres du tenant > Configurations OIDC</CloudLink>. À partir de là, vous pouvez gérer à la fois les clés privées OIDC et les clés de cookie OIDC.
