...
:::note
Cette fonction sera exportée comme un module. Assurez-vous de conserver le nom de la fonction `getCustomJwtClaims` afin que le module puisse exporter la fonction correctement.
:::
...
- **Objet de données d’interaction utilisateur**
  ...
  | `verificationRecords` | Une liste d’enregistrements de vérification soumis par l’utilisateur pour identifier et vérifier son identité lors des interactions. | `VerificationRecord[]` |
