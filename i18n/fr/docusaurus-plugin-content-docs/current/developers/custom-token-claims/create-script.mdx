...
- **Objet de données d’interaction utilisateur**
  ...
  | `verificationRecords` | Liste des enregistrements de vérification soumis par l’utilisateur pour s’identifier et se vérifier lors des interactions. | `VerificationRecord[]` |
