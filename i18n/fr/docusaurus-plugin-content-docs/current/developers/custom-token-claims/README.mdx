...
<Url href="https://blog.logto.io/glance-on-custom-jwt-access-token-claims">
  Ajoutez des revendications personnalisées aux jetons d’accès JWT avec Logto pour renforcer votre
