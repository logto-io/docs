...
Les [revendications de jetons](https://auth.wiki/claim) sont les paires clé-valeur qui fournissent des informations sur une entité ou le jeton lui-même. Les revendications peuvent inclure des informations sur l'utilisateur, le temps d'expiration du jeton, les permissions, et d'autres métadonnées pertinentes pour le processus d'authentification et d'autorisation.
