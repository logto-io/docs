...
:::warning
Note de sécurité : Dans les déploiements auto-hébergés, les scripts JWT personnalisés sont exécutés avec les mêmes privilèges que le processus serveur Logto. Cette fonctionnalité est destinée uniquement aux administrateurs de confiance. Ne permettez pas à des utilisateurs non fiables ou à privilèges réduits de créer, modifier ou tester ces scripts.
:::
