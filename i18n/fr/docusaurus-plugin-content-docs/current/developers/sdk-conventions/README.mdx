...
Dans l'utilisation pratique des services Logto, pour plus de commodité, il est souvent nécessaire pour les développeurs d'intégrer le SDK Logto dans leurs propres applications clientes afin de gérer le statut de connexion des utilisateurs, les permissions, et plus encore.
