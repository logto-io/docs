...
- **Utilisateur** : Affiche les informations sur l'utilisateur, telles que son avatar, nom complet, nom d'utilisateur, numéro de téléphone et e-mail.
...
Pour afficher les détails d'un utilisateur, cliquez simplement sur la ligne correspondante dans le tableau des utilisateurs. Cela vous amènera à la page "**Détails de l'utilisateur**" où vous trouverez les informations du profil de l'utilisateur, notamment :
...
Pour consulter les activités récentes d'un utilisateur, accédez à l'onglet "Journaux utilisateur" sur la page des détails utilisateur. Vous y trouverez un tableau affichant les activités récentes de l'utilisateur, y compris l'action effectuée, le résultat de l'action, l'application concernée et l'heure à laquelle l'utilisateur a agi.
...
Après avoir mis à jour la [politique de mot de passe](/security/password-policy) dans Logto, les utilisateurs existants peuvent toujours se connecter avec leurs mots de passe actuels. Seuls les nouveaux comptes créés devront respecter la politique de mot de passe mise à jour.
