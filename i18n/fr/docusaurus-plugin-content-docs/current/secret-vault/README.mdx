  ...
  items={[
    {
      ...
      description:
        'Stockez et gérez en toute sécurité les jetons d’accès (Access tokens) et de rafraîchissement (Refresh tokens) émis par des fournisseurs d’identité (IdP) tiers fédérés pour une utilisation dans des appels API en aval.',
      customProps: {
        icon: <Connectors />,
      },
    },
