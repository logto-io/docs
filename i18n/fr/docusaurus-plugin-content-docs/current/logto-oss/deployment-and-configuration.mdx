...
Vous pouvez utiliser Node.js pour servir HTTPS directement ou configurer un proxy / répartiteur HTTPS devant Node.js. Voir [Activer HTTPS](/concepts/core-service/configuration/#enabling-https) pour plus de détails.
