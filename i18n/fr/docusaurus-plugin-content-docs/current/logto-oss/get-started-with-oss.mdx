...
à chaque ré-exécution de la commande, une nouvelle instance de base de données sera créée et toutes les données précédemment enregistrées seront perdues.
:::
...
Nous recommandons d’utiliser une nouvelle base de données vide dédiée à Logto, bien que cela ne soit pas strictement obligatoire.
...
<Url href="https://github.com/logto-io/logto/blob/master/AWESOME.md">
  Ressources communautaires Logto remarquables
</Url>
