...
Logto utilise des variables d'environnement pour la configuration, avec la prise en charge du fichier `.env`. Voir [Configuration](/concepts/core-service/configuration) pour une utilisation détaillée et la liste complète des variables.
