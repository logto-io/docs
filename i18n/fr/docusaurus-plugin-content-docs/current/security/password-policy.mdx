...
Pour les nouveaux utilisateurs ou les utilisateurs qui mettent à jour leur mot de passe, vous pouvez définir une politique de mot de passe afin d'appliquer des exigences de robustesse. Rendez-vous sur <CloudLink to="/security/password-policy"> Console > Sécurité > Politique de mot de passe</CloudLink> pour configurer les paramètres de la politique de mot de passe.
