...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description:
        'Contrôlez les nouvelles inscriptions et les nouveaux e-mails liés avec une liste d’autorisation et bloquez les adresses jetables ou indésirables.',
      customProps: {
        icon: <BlockUserIcon />,
      },
    },
    {
      type: 'link',
      label: 'Blocage d’identifiant',
      href: '/security/identifier-lockout',
      description:
        'Verrouillez temporairement un identifiant après plusieurs tentatives d’authentification échouées pour empêcher l’accès par force brute.',
      customProps: {
        icon: <LockoutIcon />,
      },
    },
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description:
        'Faites tourner périodiquement les clés de signature pour se protéger contre la fuite de clés et la falsification de jetons.',
      customProps: {
        icon: <SendEmailIcon />,
      },
    },
