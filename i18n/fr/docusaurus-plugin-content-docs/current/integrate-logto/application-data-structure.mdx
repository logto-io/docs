...
### URIs de redirection après déconnexion \{#post-sign-out-redirect-uris}
...
Vous pouvez consulter la [déconnexion initiée par la partie de confiance](https://openid.net/specs/openid-connect-rpinitiated-1_0.html#RPLogout) pour plus d'informations.
