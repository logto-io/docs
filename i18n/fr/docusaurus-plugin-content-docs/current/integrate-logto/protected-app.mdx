...
Pour restreindre quels utilisateurs authentifiés peuvent accéder à un Protected App, configurez le [contrôle d’accès au niveau de l’application](/integrate-logto/app-level-access-control) dans l’onglet **Règles** de l’application.
