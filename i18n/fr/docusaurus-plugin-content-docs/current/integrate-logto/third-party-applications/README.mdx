...
Ainsi, puisque OIDC repose sur [OAuth 2.0](https://auth.wiki/oauth-2.0) en ajoutant une couche d’authentification, vous pouvez également intégrer une application tierce en utilisant le protocole OAuth.
