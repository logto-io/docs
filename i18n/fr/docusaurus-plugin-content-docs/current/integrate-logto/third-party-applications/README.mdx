...
Pour restreindre quels utilisateurs peuvent se connecter à une application tierce, configurez le [contrôle d'accès au niveau de l'application](/integrate-logto/app-level-access-control) dans l'onglet **Règles** de l'application.
