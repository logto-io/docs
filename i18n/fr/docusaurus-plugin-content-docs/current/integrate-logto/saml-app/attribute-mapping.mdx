...
Vous pouvez associer toutes les informations utilisateur disponibles dans Logto aux attributs attendus par votre SP à l’aide des paramètres de mappage des attributs.
