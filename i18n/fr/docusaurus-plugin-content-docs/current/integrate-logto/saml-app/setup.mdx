...
<img src={certificatesImage} alt="Certificats d'application SAML" />
...
<img src={nameIdFormatImage} alt="Format de l'ID de nom SAML" />
...
<img src={encryptionImage} alt="Chiffrement de l'assertion SAML" />
