...
1. **Bouton d'authentification unique** :
   ...
   - Plusieurs connecteurs : Si plusieurs connecteurs SSO d’entreprise sont associés au domaine de messagerie de l'utilisateur, l'utilisateur devra d'abord sélectionner l'IdP souhaité dans une liste avant d'être redirigé vers la page de connexion de l'IdP.
...
2. Ajoutez manuellement des utilisateurs en saisissant leur adresse e-mail d'entreprise dans <CloudLink to="/users">Console > Gestion des utilisateurs</CloudLink> ou importez via [Management API](https://openapi.logto.io/operation/operation-createuser).
