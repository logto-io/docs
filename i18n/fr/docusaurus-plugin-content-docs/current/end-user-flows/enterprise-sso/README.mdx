...
## Composants clés du SSO d’entreprise \{#do-i-need-enterprise-sso}
...
## Flux de travail SSO pris en charge \{#key-components-of-enterprise-sso}
...
## Protocoles SSO pris en charge \{#supported-sso-workflow}
...
## FAQs \{#supported-sso-protocols}

<details>
  <summary>

### Comment ajouter des boutons de connecteur SSO et se connecter directement avec le fournisseur SSO sur mon site web ? \{#faqs}
...
## Ressources associées \{#how-to-add-sso-connector-buttons-and-directly-sign-in-with-sso-provider-on-my-website}
