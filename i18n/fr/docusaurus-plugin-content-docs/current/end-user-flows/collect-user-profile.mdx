...
| Date                         | Format de date (prédéfini/personnalisé) | Choisissez des formats prédéfinis (MM/jj/aaaa, jj/MM/aaaa, aaaa-MM-jj). Changer l'exemple remplace les interactions par défaut. Ou utilisez des modèles entièrement personnalisables <a href="https://date-fns.org/v2.30.0/docs/format" target="_blank" rel="noopener noreferrer">date-fns</a>. |
...
| URL                          | N/A                                     | N/A                                                                                                                                                                                                                                                                                             |
| Regex                        | Expression régulière                    | Modèle de validation (sans les barres de début / fin). Ex : <code>^\d{3}-\d{2}-\d{4}$</code> pour un numéro de sécurité sociale.                                                                                                                                                                |
