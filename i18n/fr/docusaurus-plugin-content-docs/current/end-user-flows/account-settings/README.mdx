...
| **Fonctionnalités prises en charge** | Voir, mettre à jour et supprimer : nom d’utilisateur, e-mail, téléphone, mot de passe, comptes sociaux, MFA, profil                                   | Toutes les options de base + suppression / suspension / restauration de compte, jetons d’accès personnels, usurpation d’identité utilisateur, connexion d’applications OAuth, etc.       |
| **Complexité de configuration**      | Très faible (plug-and-play)                                                                                                                           | Moyenne à élevée (nécessite une implémentation personnalisée)                                                                                                                            |
