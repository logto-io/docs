...
:::note
Pour utiliser cette méthode, vous devez [configurer le connecteur email](/connectors/email-connectors/) ou [le connecteur SMS](/connectors/sms-connectors/), et vous assurer que le modèle `UserPermissionValidation` est configuré.
:::
