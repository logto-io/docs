...
<img src={webauthnSetupFlowImage} alt="Flux de configuration WebAuthn" />

- **Flux de vérification des passkeys**

<img src={webauthnVerificationFlowImage} alt="Flux de vérification WebAuthn" />
