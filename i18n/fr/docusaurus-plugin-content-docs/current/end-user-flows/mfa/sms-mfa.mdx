...
5. Testez la fonctionnalité du connecteur pour garantir la bonne livraison des messages.
...
### Scénario 2 : Numéro vérifié comme identifiant d’inscription \{#scenario-2-phone-verified-as-the-sign-up-identifier}
...
### Scénario 3 : Numéro vérifié mais plusieurs facteurs principaux disponibles \{#scenario-3-phone-verified-but-multiple-primary-factors-available}
...
## Flux de vérification SMS MFA \{#sms-mfa-verification-flows}
...
Si plusieurs facteurs MFA sont disponibles, les utilisateurs peuvent sélectionner parmi leurs facteurs configurés. Le système détermine quel facteur MFA afficher en premier selon l’ordre de priorité spécifié dans [Configurer la MFA](/end-user-flows/mfa/configure-mfa#mfa-verification-flow).
