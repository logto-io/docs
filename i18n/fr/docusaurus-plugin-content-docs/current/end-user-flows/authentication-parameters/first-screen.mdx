...
Un ensemble de paramètres d'authentification personnalisés qui vous permettent d'adapter l'expérience de l'écran de démarrage souhaitée pour les utilisateurs finaux.
...
![Paramètre de l'écran de démarrage](./assets/first-screen-parameter.png)
