...
1. **Nom d'utilisateur** a été précédemment défini comme identifiant d'inscription avec le paramètre **Créer votre mot de passe** activé automatiquement.
...
4. L'utilisateur est invité à fournir et vérifier une adresse e-mail après sa première étape de connexion.
