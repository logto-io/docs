...
- **Visite directe de l’URL de connexion** : L’utilisateur ouvre un favori ou partage l’URL `/sign-in` (contournant le bouton de connexion habituel).
...
- **Liens magiques invalides** : Un [jeton à usage unique (lien magique)](/end-user-flows/one-time-token) pour des actions telles qu’une invitation à une organisation ou une connexion sans mot de passe a expiré ou a déjà été utilisé.
...
1. Allez dans <CloudLink to="/sign-in-experience/sign-up-and-sign-in">Console > Connexion & compte > Inscription et connexion > Paramètres avancés</CloudLink>
...
1. Allez dans <CloudLink to="/sign-in-experience/content">Console > Connexion & compte > Contenu > Support</CloudLink>
2. Définissez votre adresse e-mail de support
3. Définissez l’URL de votre site web de support ou officiel
