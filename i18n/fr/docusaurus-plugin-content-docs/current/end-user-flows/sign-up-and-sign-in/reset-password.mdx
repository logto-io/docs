...
La fonctionnalité de récupération de mot de passe sera automatiquement activée pour vous lorsque vous aurez configuré un [connecteur Email](/connectors/email-connectors) ou un [connecteur SMS](/connectors/sms-connectors) valide. L'utilisateur peut réinitialiser son mot de passe en fournissant son adresse e-mail ou son numéro de téléphone enregistré.

## Flux de réinitialisation du mot de passe \{#password-reset-flow}
...
Vous pouvez implémenter votre propre flux de réinitialisation du mot de passe en utilisant la **Management API** et la **Account API** de Logto. Consultez les [paramètres du compte](/end-user-flows/account-settings/) pour plus de détails.
