...
<details>
  <summary> Comment déconnecter un utilisateur après une réinitialisation réussie du mot de passe ?</summary>
...
<details>
  <summary> Comment mettre en œuvre le flux de réinitialisation du mot de passe sur mon interface utilisateur personnalisée ?</summary>
