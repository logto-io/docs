...
<img src={resetPasswordImage} alt="Flux de réinitialisation du mot de passe" />
...
### Comment déconnecter un utilisateur après une réinitialisation de mot de passe réussie ? \{#how-to-sign-out-a-user-after-a-successful-password-reset}
...
### Comment implémenter le flux de réinitialisation de mot de passe sur mon interface utilisateur personnalisée ? \{#how-to-implement-the-password-reset-flow-on-my-custom-ui}
