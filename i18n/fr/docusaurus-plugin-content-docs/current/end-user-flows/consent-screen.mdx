...
En savoir plus sur la configuration de l'[application tierce](/integrate-logto/third-party-applications/) et la personnalisation de l'[écran de consentement](/integrate-logto/third-party-applications/consent-screen-branding/) dans Logto.
