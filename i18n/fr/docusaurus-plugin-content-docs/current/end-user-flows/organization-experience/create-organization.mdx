...
Vous pouvez éventuellement attribuer des rôles d’organisation spécifiques à l’utilisateur ([référence API](https://openapi.logto.io/operation/operation-assignorganizationrolestousers)).
