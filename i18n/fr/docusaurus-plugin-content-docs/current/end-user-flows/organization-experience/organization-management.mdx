...
Vous pouvez permettre aux utilisateurs admin et membre d'inviter d'autres personnes dans l'organisation. Consultez [cette documentation](/end-user-flows/organization-experience/invite-organization-members) pour plus de détails sur l'invitation de membres.
