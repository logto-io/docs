...
tags: [authentification, hugging-face, next-app-router, js, connexion sociale, connexion, login]
title: Comment construire une connexion Hugging Face avec Next.js (App Router)
...
import ConnectorGuide from '@site/i18n/fr/docusaurus-plugin-content-docs/current/integrations/social/hugging-face/_integration.mdx';
...
## Activer le connecteur Hugging Face dans l'Expérience de connexion \{#enable-connector-connector-in-sign-in-experience}
