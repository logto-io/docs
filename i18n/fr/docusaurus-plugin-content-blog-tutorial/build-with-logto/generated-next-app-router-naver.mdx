...
tags: [authentification, naver, next-app-router, js, connexion sociale, connexion, login]
title: Comment construire une connexion Naver avec Next.js (App Router)
...
import ConnectorGuide from '@site/i18n/fr/docusaurus-plugin-content-docs/current/integrations/social/naver/_integration.mdx';
...
## Activer le connecteur Naver dans l'Expérience de connexion \{#enable-connector-connector-in-sign-in-experience}
