---
slug: build-oidc-enterprise-sso-sign-in-with-ruby-and-logto
tags: [SSO providers, oidc-enterprise-sso, ruby, ruby, SAML authentication, enterprise login, SSO login]
title: How to build OIDC enterprise SSO with Ruby
sdk: Ruby
