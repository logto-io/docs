---
slug: build-google-workspace-enterprise-sso-sign-in-with-sveltekit-and-logto
tags: [SSO providers, google-workspace-enterprise-sso, sveltekit, js, SAML authentication, enterprise login, SSO login]
title: How to build Google Workspace enterprise SSO with SvelteKit
sdk: SvelteKit
