---
slug: build-okta-enterprise-sso-sign-in-with-next-auth-and-logto
tags: [SSO providers, okta-enterprise-sso, next-auth, js, SAML authentication, enterprise login, SSO login]
title: How to build Okta enterprise SSO with Auth.js (Next Auth)
