...
tags: [authentification, discord, next-app-router, js, connexion sociale, connexion, login]
title: Comment construire une connexion Discord avec Next.js (App Router)
...
import ConnectorGuide from '@site/i18n/fr/docusaurus-plugin-content-docs/current/integrations/social/discord/_integration.mdx';
...
## Activer le connecteur Discord dans l'Expérience de connexion \{#enable-connector-connector-in-sign-in-experience}
