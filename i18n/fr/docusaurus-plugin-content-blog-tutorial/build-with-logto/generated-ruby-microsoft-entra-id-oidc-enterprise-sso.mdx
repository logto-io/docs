---
slug: build-microsoft-entra-id-oidc-enterprise-sso-sign-in-with-ruby-and-logto
tags: [SSO providers, microsoft-entra-id-oidc-enterprise-sso, ruby, ruby, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID OIDC enterprise SSO with Ruby
sdk: Ruby
