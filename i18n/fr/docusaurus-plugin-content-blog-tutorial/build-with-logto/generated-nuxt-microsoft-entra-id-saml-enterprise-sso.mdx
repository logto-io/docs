---
slug: build-microsoft-entra-id-saml-enterprise-sso-sign-in-with-nuxt-and-logto
tags: [SSO providers, microsoft-entra-id-saml-enterprise-sso, nuxt, js, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID SAML enterprise SSO with Nuxt
sdk: Nuxt
