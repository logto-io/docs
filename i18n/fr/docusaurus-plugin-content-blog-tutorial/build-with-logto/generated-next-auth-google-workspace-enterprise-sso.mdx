---
slug: build-google-workspace-enterprise-sso-sign-in-with-next-auth-and-logto
tags: [SSO providers, google-workspace-enterprise-sso, next-auth, js, SAML authentication, enterprise login, SSO login]
title: How to build Google Workspace enterprise SSO with Auth.js (Next Auth)
