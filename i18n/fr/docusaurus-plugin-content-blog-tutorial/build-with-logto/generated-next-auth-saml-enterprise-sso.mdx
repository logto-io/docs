---
slug: build-saml-enterprise-sso-sign-in-with-next-auth-and-logto
tags: [SSO providers, saml-enterprise-sso, next-auth, js, SAML authentication, enterprise login, SSO login]
title: How to build SAML enterprise SSO with Auth.js (Next Auth)
