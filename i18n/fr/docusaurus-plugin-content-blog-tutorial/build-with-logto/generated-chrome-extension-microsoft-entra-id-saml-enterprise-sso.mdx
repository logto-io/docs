...
title: How to build Microsoft Entra ID SAML enterprise SSO with Extension Chrome
...
## Integrate Extension Chrome SDK \{#integrate-framework-sdk}

<IntegrateSdk />

## Add Microsoft Entra ID SAML enterprise SSO connector \{#add-connector-connector}

<AddSsoConnector framework="Extension Chrome" />
