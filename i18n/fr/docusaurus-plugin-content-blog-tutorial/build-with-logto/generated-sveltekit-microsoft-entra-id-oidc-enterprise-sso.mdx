---
slug: build-microsoft-entra-id-oidc-enterprise-sso-sign-in-with-sveltekit-and-logto
tags: [SSO providers, microsoft-entra-id-oidc-enterprise-sso, sveltekit, js, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID OIDC enterprise SSO with SvelteKit
sdk: SvelteKit
...
## Integrate SvelteKit SDK \{#integrate-framework-sdk}

<IntegrateSdk />

## Add Microsoft Entra ID OIDC enterprise SSO connector \{#add-connector-connector}

<AddSsoConnector framework="SvelteKit" />
