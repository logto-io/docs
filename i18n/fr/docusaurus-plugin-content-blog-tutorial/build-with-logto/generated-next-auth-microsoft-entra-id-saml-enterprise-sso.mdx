---
slug: build-microsoft-entra-id-saml-enterprise-sso-sign-in-with-next-auth-and-logto
tags: [SSO providers, microsoft-entra-id-saml-enterprise-sso, next-auth, js, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID SAML enterprise SSO with Auth.js (Next Auth)
