---
slug: build-microsoft-entra-id-oidc-enterprise-sso-sign-in-with-nuxt-and-logto
tags: [SSO providers, microsoft-entra-id-oidc-enterprise-sso, nuxt, js, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID OIDC enterprise SSO with Nuxt
sdk: Nuxt
