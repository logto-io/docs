---
slug: build-saml-enterprise-sso-sign-in-with-ruby-and-logto
tags: [SSO providers, saml-enterprise-sso, ruby, ruby, SAML authentication, enterprise login, SSO login]
title: How to build SAML enterprise SSO with Ruby
sdk: Ruby
