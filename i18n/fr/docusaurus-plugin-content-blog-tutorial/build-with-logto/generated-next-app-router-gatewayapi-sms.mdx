...
tags: [authentification, gatewayapi-sms, next-app-router, undefined, connexion sans mot de passe, connexion, login]
title: Comment construire une connexion sans mot de passe GatewayAPI SMS SMS avec Next.js (App Router)
...
## Ajouter le connecteur GatewayAPI SMS \{#add-connector-connector}
...
## Activer le connecteur GatewayAPI SMS dans l'expérience de connexion \{#enable-connector-connector-in-sign-in-experience}
