---
slug: build-oidc-enterprise-sso-sign-in-with-sveltekit-and-logto
tags: [SSO providers, oidc-enterprise-sso, sveltekit, js, SAML authentication, enterprise login, SSO login]
title: How to build OIDC enterprise SSO with SvelteKit
sdk: SvelteKit
