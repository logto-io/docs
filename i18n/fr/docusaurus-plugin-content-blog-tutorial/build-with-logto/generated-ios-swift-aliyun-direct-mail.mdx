...
tags: [authentification, aliyun-direct-mail, ios-swift, swift, connexion sans mot de passe, connexion, login]
title: Comment construire une connexion sans mot de passe Aliyun Direct Mail Email avec iOS (Swift)
sdk: iOS (Swift)
