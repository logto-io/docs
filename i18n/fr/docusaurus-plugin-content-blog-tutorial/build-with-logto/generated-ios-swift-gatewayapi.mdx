...
tags: [authentification, gatewayapi, ios-swift, swift, connexion sans mot de passe, connexion, login]
title: Comment construire une connexion sans mot de passe GatewayAPI SMS avec iOS (Swift)
sdk: iOS (Swift)
