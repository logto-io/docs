---
slug: build-microsoft-entra-id-saml-enterprise-sso-sign-in-with-sveltekit-and-logto
tags: [SSO providers, microsoft-entra-id-saml-enterprise-sso, sveltekit, js, SAML authentication, enterprise login, SSO login]
title: How to build Microsoft Entra ID SAML enterprise SSO with SvelteKit
sdk: SvelteKit
