...
tags: [authentification, wechat-native, vanilla-js, js, connexion sociale, connexion, login]
title: Comment construire une connexion WeChat (Native) avec Vanilla JS
sdk: Vanilla JS
...
## Intégrer le SDK Vanilla JS \{#integrate-framework-sdk}
