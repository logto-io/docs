---
slug: build-okta-enterprise-sso-sign-in-with-sveltekit-and-logto
tags: [SSO providers, okta-enterprise-sso, sveltekit, js, SAML authentication, enterprise login, SSO login]
title: How to build Okta enterprise SSO with SvelteKit
sdk: SvelteKit
