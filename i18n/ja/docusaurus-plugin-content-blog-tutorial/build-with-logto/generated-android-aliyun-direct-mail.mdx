...
tags: [認証 (Authentication), aliyun-direct-mail, android, kotlin/java, パスワードレスサインイン, サインイン, ログイン]
title: Aliyun Direct Mail Email パスワードレスサインインを Android (Kotlin / Java) で構築する方法
