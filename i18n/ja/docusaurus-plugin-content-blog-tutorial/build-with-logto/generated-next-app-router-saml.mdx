...
tags: [認証 (Authentication), saml, next-app-router, js, ソーシャルサインイン, サインイン, ログイン]
title: SAML サインインを Next.js (App Router) で構築する方法
...
import ConnectorGuide from '@site/i18n/ja/docusaurus-plugin-content-docs/current/integrations/social/saml/_integration.mdx';
...
## サインイン体験で SAML コネクターを有効にする \{#enable-connector-connector-in-sign-in-experience}
