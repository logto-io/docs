...
[組織 (Organization)](/organizations) 体験とは、ビジネスクライアントやその従業員が利用するユーザーインターフェースやフローを指します。特に [マルチテナントアプリケーション](https://auth.wiki/multi-tenancy) において重要です。Logto は、Logto Management API を利用してこの体験をアプリに素早く統合するためのガイドをいくつか提供しています。
  ...
  items={[
    {
      ...
      description:
        'Logto Management API を利用して、エンドユーザーが自分でプロダクト上に組織を作成できるようにします。',
      customProps: {
