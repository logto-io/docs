...
Logto ドキュメントへようこそ！Logto は、モダンなアプリや SaaS 製品向けに設計されたアイデンティティおよびアクセス管理 (IAM) ソリューションです。アプリケーションに安全でスケーラブル、かつカスタマイズ可能な認証 (Authentication)・認可 (Authorization) システムを提供します。
...
Logto の機能は 4 つの主要な柱の上に構築されており、製品やビジネスに簡単に統合できる機能の基盤となっています。
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      href: '/end-user-flows',
      description:
        '識別子サインイン、ソーシャルサインイン、パスキーサインイン、多要素認証 (MFA) など、Logto Console や API を通じて幅広いカスタマイズが可能な完全な認証 (Authentication) フローとユーザーインターフェースを提供します。',
      customProps: {
        icon: <ExperienceIcon />,
      },
    },
  ...
  items={[
    {
      ...
      href: '/logto-cloud',
      description:
        'クラウドサービスは Free、Pro、Enterprise プランを用意し、さまざまなニーズに対応します。Logto がホスティング・管理を行い、開発用テナントでは Logto のすべての機能をテストできます。',
      customProps: {
        icon: <CloudIcon />,
      },
    },
...
アイデンティティシステムが初めての方は、まず以下の基本概念をお読みください：
