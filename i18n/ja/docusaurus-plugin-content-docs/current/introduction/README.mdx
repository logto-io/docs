---
description: Logto を統合することで、アイデンティティおよびアクセス管理システムをすばやく立ち上げることができます。認証 (Authentication)、認可 (Authorization)、マルチテナント管理をすべて一つで実現。
---
...
Logto の機能は 4 つの重要な柱の上に構築されており、これらがプロダクトやビジネスに簡単に統合できる機能の基盤となっています。
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      href: '/end-user-flows',
      description:
        '認証 (Authentication) フローとユーザーインターフェースを一式提供し、Logto Console や API を通じて柔軟にカスタマイズできます。',
      customProps: {
        icon: <ExperienceIcon />,
      },
    },
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      href: '/logto-oss',
      description:
        '自社インフラ上で Logto をセルフホストできます。詳細は GitHub ページやオープンソースセクションをご覧ください。',
      customProps: {
        icon: <OpenSourceIcon />,
      },
    },
...
[Logto Discord](https://discord.com/invite/UEPaF3j5e6) サーバーに参加しましょう — 開発者やビジネスのための活発なコミュニティです。ディスカッションに参加し、最新情報を受け取り、フィードバックを共有できます。
