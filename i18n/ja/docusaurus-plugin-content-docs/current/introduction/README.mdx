---
description: Logto を統合して、アイデンティティおよびアクセス管理システムをすばやく立ち上げましょう。認証 (Authentication)、認可 (Authorization)、マルチテナント管理をすべて一つで実現できます。
---
...
Logto ドキュメントへようこそ！Logto は、モダンなアプリや SaaS プロダクト向けに設計されたアイデンティティおよびアクセス管理 (IAM) ソリューションです。アプリケーションに安全でスケーラブル、かつカスタマイズ可能な認証 (Authentication) と認可 (Authorization) システムを提供します。
  ...
  items={[
    {
      ...
      href: '/logto-cloud',
      description:
        'クラウドサービスは Free、Pro、Enterprise プランを用意し、さまざまなニーズに対応します。Logto がホスティング・管理し、開発用テナントでは Logto の全機能をテストできます。',
      customProps: {
        icon: <CloudIcon />,
      },
    },
    {
      ...
      href: '/logto-oss',
      description:
        'Logto を自身のインフラにセルフホストできます。詳細は GitHub ページやオープンソースセクションをご覧ください。',
      customProps: {
        icon: <OpenSourceIcon />,
      },
    },
...
[Logto Discord](https://discord.com/invite/UEPaF3j5e6) サーバーに参加しましょう — 開発者やビジネス向けの活発なコミュニティです。ディスカッションに参加し、最新情報を入手し、フィードバックを共有できます。
