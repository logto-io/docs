...
## あなたの Java Spring Boot アプリケーションを設定する \{#configure-your-java-spring-boot-application}

### 依存関係の追加 \{#implementation}
...
### OAuth2 クライアント設定 \{#scopes-and-claims}
...
### WebSecurityConfig を実装する \{#implement-the-websecurityconfig}
