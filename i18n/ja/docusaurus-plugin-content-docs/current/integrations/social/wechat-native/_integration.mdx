...
アプリに [Logto iOS SDK](/quick-starts/swift) を統合済みであることを前提とします。この場合、非常にシンプルで、WeChat SDK のドキュメントを読む必要すらありません：
...
アプリに [Logto Android SDK](/quick-starts/android) を統合済みであることを前提とします。この場合、非常にシンプルで、WeChat SDK のドキュメントを読む必要すらありません：
