...
sidebar_custom_props:
  description: Mailgun は、メールの送信、受信、追跡のためのメール配信サービスです。
---
...
- Mailgun アカウントから取得した API キー（メール送信の権限が必要です）。詳細は [Where Can I Find My API Key and SMTP Credentials?](https://help.mailgun.com/hc/en-us/articles/203380100-Where-Can-I-Find-My-API-Key-and-SMTP-Credentials-) を参照してください。
