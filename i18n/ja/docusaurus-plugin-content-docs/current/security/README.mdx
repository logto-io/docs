...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description:
        'サインイン体験に CAPTCHA（例：Google reCAPTCHA、Cloudflare Turnstile）を追加し、自動化されたボット攻撃を防止します。',
      customProps: {
        icon: <CheckboxIcon />,
      },
    },
...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description:
        'ユーザーが機密情報へアクセスしたり高リスク操作を行う際、アプリがステップアップ認証 (Authentication) を促せます。',
      customProps: {
        icon: <SecurityIcon />,
      },
    },
    ...
    },
    {
      ...
      description:
        'セントラルなログアウトを有効にし、セッションハイジャックや不正アクセスのリスクを低減します。',
      customProps: {
        icon: <SuspendIcon />,
      },
    },
