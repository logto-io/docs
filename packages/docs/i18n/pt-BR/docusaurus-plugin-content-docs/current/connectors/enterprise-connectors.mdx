...
## Conectores empresariais \{#enterprise-connectors}
...
### Conectores empresariais populares \{#popular-enterprise-connectors}
...
### Personalize seus conectores empresariais \{#customize-your-enterprise-connectors}
...
## Configurando conectores empresariais \{#configuring-enterprise-connectors}
...
## Habilitando SSO empresarial \{#enabling-enterprise-sso}
...
### Impacto nos usuários existentes após alterações no conector de SSO empresarial? \{#impact-on-existing-users-after-enterprise-sso-connector-changes}
