---
description: Logto を統合して、アイデンティティとアクセス管理システムを迅速に立ち上げましょう。認証 (Authentication)、認可 (Authorization)、マルチテナント管理をすべて一つにまとめて楽しめます。
---
...
Logto ドキュメントへようこそ！Logto は、モダンなアプリや SaaS 製品向けに設計されたアイデンティティとアクセス管理 (IAM) ソリューションです。アプリケーションに対して安全でスケーラブル、かつカスタマイズ可能な認証 (Authentication) と認可 (Authorization) システムを提供します。
  ...
  items={[
    {
      ...
      description:
        'リソースの設定と管理のためのウェブベースのインターフェースで、サインイン体験の迅速な設定と簡単なアイデンティティ管理を提供します。',
      customProps: {
    ...
    },
    {
      ...
      description:
        'Logto のバックエンドは、Logto Management API、Experience API、Account API を含むさまざまな認証 (Authentication) と認可 (Authorization) 機能を促進する API のスイートを提供します。',
      customProps: {
        icon: <LogtoApiIcon />,
      },
    },
    {
      ...
      href: '/quick-starts',
      description:
        'エンドツーエンドのチュートリアルと SDKs を探索して、お好みのフレームワークで迅速に開始しましょう。',
      customProps: {
        icon: <SdkIcon />,
      },
    },
  ...
  items={[
    {
      ...
      href: '/logto-cloud',
      description:
        '私たちのクラウドサービスには、さまざまな顧客ニーズに応えるための Free、Pro、Enterprise プランが含まれています。Logto によってホストおよび管理されています。また、Logto のすべての機能をテストできる dev テナントも提供しています。',
      customProps: {
        icon: <CloudIcon />,
      },
    },
    {
      ...
      href: '/logto-oss',
      description:
        '自分のインフラストラクチャ上で Logto をセルフホストします。詳細については、GitHub ページとオープンソースセクションを訪問してください。',
      customProps: {
        icon: <OpenSourceIcon />,
      },
    },
...
[Logto Discord](https://discord.com/invite/UEPaF3j5e6) サーバーに参加しましょう — 開発者とビジネスのための活気あるコミュニティです。ディスカッションに参加し、最新情報を入手し、フィードバックを共有しましょう。

<br />

アイデンティティシステムに不慣れな方は、以下の基本概念をお読みください：
