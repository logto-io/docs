...
Sobald die Passwort-Zurücksetzungsfunktion aktiviert ist, wird ein "Passwort vergessen"-Link unter dem Anmeldeformular angezeigt. Benutzer können auf den "Passwort vergessen"-Link klicken, um den Passwort-Zurücksetzungsprozess zu starten.
...
1. **Besuche die Anmeldeseite**: Der Benutzer besucht die Anmeldeseite.
2. **Klicke auf den Passwort vergessen-Link**: Der Benutzer klickt auf den "Passwort vergessen"-Link.
...
6. **Neues Passwort eingeben**: Der Benutzer wird aufgefordert, ein neues Passwort einzugeben, sobald der Verifizierungscode erfolgreich verifiziert wurde.
...
<img src="/img/assets/reset-password.png" alt="Passwort-Zurücksetzungsablauf" />
...
### Wie melde ich einen Benutzer nach einem erfolgreichen Zurücksetzen des Passworts ab? \{#how-to-sign-out-a-user-after-a-successful-password-reset}
...
Du kannst einen selbst gehosteten Passwort-Zurücksetzungspunkt erstellen und das Logto SDK nutzen, um eine Anmeldeanfrage mit [`first_screen`](/end-user-flows/authentication-parameters/first-screen) auf `reset-password` gesetzt zu initiieren. Dies wird den Benutzer nahtlos zur Passwort-Zurücksetzungsseite weiterleiten.
...
<Url href="https://blog.logto.io/design-your-password-policy">
  Gestalte deine Passwortrichtlinie
</Url>
