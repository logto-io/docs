...
### Utilisation de la Management API \{#using-management-api}
...
## Utiliser les PATs pour fournir des jetons d’accès \{#use-pats-to-grant-access-tokens}
...
### Exemple d’échange de jetons \{#example-token-exchange}
