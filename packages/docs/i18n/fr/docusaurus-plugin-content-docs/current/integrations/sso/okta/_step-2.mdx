...
<img src="/img/assets/okta_application_settings.webp" alt="Paramètres de l'application Okta" />
...
<img src="/img/assets/okta_assign_users.webp" alt="Assigner des utilisateurs dans Okta" />
