...
<img src="/img/assets/supabase-api-settings.webp" alt="Page des paramètres de l'API Supabase" />
...
<img
  ...
  alt="Créer une fonction pour obtenir l'ID utilisateur"
/>
...
<img src="/img/assets/service-role-secret.webp" alt="Secret du rôle de service" />
