...
<img src="/img/tutorial/sso-page.png" alt="SSO page" />
...
<img src="/img/tutorial/select-your-sso-provider.png" alt="Select your SSO provider" />

4. Configure the connection with your IdP in the "Connection" tab. Check the guides above for each connector types.

<img src="/img/tutorial/sso-connection-settings.png" alt="SSO connection" />
...
<img src="/img/tutorial/sso-experience-settings.png" alt="SSO experience" />
