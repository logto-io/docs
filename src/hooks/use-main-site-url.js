 ...
 */
var useMainSiteUrl = function () {
    var customFields = (0, useDocusaurusContext_1.default)().siteConfig.customFields;
    var mainSiteUrl = (customFields !== null && customFields !== void 0 ? customFields : {}).mainSiteUrl;
    var url = (0, react_1.useMemo)(function () { return (typeof mainSiteUrl === 'string' ? mainSiteUrl : undefined); }, [mainSiteUrl]);
    var getMainSiteLink = (0, react_1.useCallback)(function (pathname) { return (url ? new URL(pathname, url).href : pathname); }, [url]);
    return {
        /**
         * The main site URL.
         *
         ...
         */
        getMainSiteLink: getMainSiteLink,
    };
};
exports.default = useMainSiteUrl;
