...
const docsSidebar: SidebarConfig = [
  ...
  },
  {
    ...
    link: { type: 'doc', id: 'integrate-logto/README' },
  ...
  },
  {
    type: 'category',
    label: 'Sessions',
    link: { type: 'doc', id: 'sessions/README' },
    items: [{ type: 'autogenerated', dirName: 'sessions' }],
    customProps: { id: 'sessions' },
  },
  {
    type: 'category',
  ...
  },
  {
    type: 'category',
    label: 'Developers',
    link: { type: 'doc', id: 'developers/README' },
    items: [{ type: 'autogenerated', dirName: 'developers' }],
    customProps: { id: 'developers' },
  },
  {
    type: 'category',
    label: 'Secret Vault',
    link: { type: 'doc', id: 'secret-vault/README' },
    items: [{ type: 'autogenerated', dirName: 'secret-vault' }],
    customProps: { id: 'secret-vault' },
  },
  {
    type: 'category',
    label: 'Logto Cloud',
