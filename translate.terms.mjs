...
export const terms = Object.freeze({
  ...
  ru: {
    ...
    'Opaque tokens': 'Непрозрачные токены',
    'Access token': 'Токен доступа',
    'Access tokens': 'Токены доступа',
    'Refresh token': 'Токен обновления',
    'Refresh tokens': 'Токены обновления',
    'Organization token': 'Токен организации',
    'Organization tokens': 'Токены организации',
    'ID token': 'ID токен',
    'ID tokens': 'ID токены',
    Issuer: 'Эмитент',
    Issuers: 'Эмитенты',
    ...
    'Resource indicator': 'Индикатор ресурса',
    'Resource indicators': 'Индикаторы ресурсов',
    'Consent screen': 'Экран согласия',
    'Machine-to-machine': 'Машина-машина',
    Experience: 'Опыт',
    'API resource': 'Ресурс API',
    'API resources': 'Ресурсы API',
    'Role-based access control': 'Управление доступом на основе ролей (RBAC)',
    'User impersonation': 'Имперсонация пользователя',
    'Identity provider': 'Провайдер идентификации (IdP)',
    'Single sign-on': 'Единый вход (SSO)',
    'Enterprise SSO': 'Корпоративный единый вход (SSO)',
    'Multi-factor authentication': 'Многофакторная аутентификация (MFA)',
    'Authentication request': 'Запрос аутентификации',
    'Authorization request': 'Запрос авторизации',
    'Token request': 'Запрос токена',
...
export const patterns = Object.freeze({
  ...
  ru: {
    'Set up social login with {provider}': 'Настройка социального входа через {provider}',
    'Add authentication to your {framework} application':
      'Добавление аутентификации в ваше приложение на {framework}',
    'Set up email verification with {provider}':
      'Настройка проверки электронной почты через {provider}',
    'Set up SMS verification with {provider}': 'Настройка проверки SMS через {provider}',
    'Set up Single Sign-On with {provider}': 'Настройка единого входа (SSO) через {provider}',
  },
});
