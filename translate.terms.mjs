...
export const terms = Object.freeze({
  ...
  'zh-TW': {
    ...
    'Refresh tokens': '重新整理權杖',
    'Organization token': '組織權杖',
    'Organization tokens': '組織權杖',
    'ID token': 'ID 權杖',
    'ID tokens': 'ID 權杖',
    Issuer: '簽發者',
    Issuers: '簽發者',
    ...
    Connector: '連接器',
    Connectors: '連接器',
    'Resource indicator': '資源標示符',
    'Resource indicators': '資源標示符',
    'Consent screen': '使用者授權頁面',
    'Machine-to-machine': '機器對機器',
    Experience: '使用體驗',
    'API resource': 'API 資源',
    'API resources': 'API 資源',
    'Role-based access control': '基於角色的存取控制 (RBAC)',
    'User impersonation': '使用者模擬',
    'Identity provider': '身分提供者 (IdP)',
    'Single sign-on': '單一登入 (SSO)',
    'Enterprise SSO': '企業級單一登入 (SSO)',
    'Multi-factor authentication': '多重要素驗證 (MFA)',
    'Authentication request': '驗證請求',
    'Authorization request': '授權請求',
    'Token request': '權杖請求',
    'Authorization token': '授權權杖',
  },
  th: {
    Authentication: 'การยืนยันตัวตน',
    Authorization: 'การอนุญาต',
    'Opaque token': 'โทเค็นทึบ',
    'Opaque tokens': 'โทเค็นทึบ',
    'Access token': 'โทเค็นการเข้าถึง',
    'Access tokens': 'โทเค็นการเข้าถึง',
    'Refresh token': 'โทเค็นรีเฟรช',
    'Refresh tokens': 'โทเค็นรีเฟรช',
    'Organization token': 'โทเค็นองค์กร',
    'Organization tokens': 'โทเค็นองค์กร',
    'ID token': 'โทเค็น ID',
    'ID tokens': 'โทเค็น ID',
    Issuer: 'ผู้ออก',
    Issuers: 'ผู้ออก',
    ...
    Audience: 'ผู้รับ',
    Audiences: 'ผู้รับ',
    Subject: 'ผู้ถูกอ้างถึง',
    Subjects: 'ผู้ถูกอ้างถึง',
    Scope: 'ขอบเขต',
    Scopes: 'ขอบเขต',
    Permission: 'สิทธิ์',
    Permissions: 'สิทธิ์',
    ...
    'Resource indicator': 'ตัวบ่งชี้ทรัพยากร',
    'Resource indicators': 'ตัวบ่งชี้ทรัพยากร',
    'Consent screen': 'หน้าขอความยินยอม',
    'Machine-to-machine': 'เครื่องต่อเครื่อง',
    Experience: 'ประสบการณ์',
    'API resource': 'ทรัพยากร API',
    'API resources': 'ทรัพยากร API',
    'Role-based access control': 'การควบคุมการเข้าถึงตามบทบาท (RBAC)',
    'User impersonation': 'การสวมรอยผู้ใช้',
    'Identity provider': 'ผู้ให้บริการข้อมูลระบุตัวตน (IdP)',
    'Single sign-on': 'การลงชื่อเข้าใช้ครั้งเดียว (SSO)',
    'Enterprise SSO': 'SSO สำหรับองค์กร (SSO)',
    'Multi-factor authentication': 'การยืนยันตัวตนหลายปัจจัย (MFA)',
    'Authentication request': 'คำขอการยืนยันตัวตน',
    'Authorization request': 'คำขอการอนุญาต',
    'Token request': 'คำขอโทเค็น',
...
export const patterns = Object.freeze({
  ...
  'zh-TW': {
    'Set up social login with {provider}': '設定 {provider} 社交登入',
    'Add authentication to your {framework} application':
      '為你的 {framework} 應用程式新增驗證 (Authentication)',
    'Set up email verification with {provider}': '使用 {provider} 設定電子郵件驗證',
    'Set up SMS verification with {provider}': '使用 {provider} 設定簡訊驗證',
    'Set up Single Sign-On with {provider}': '設定 {provider} 單一登入 (SSO)',
  },
  th: {
    'Set up social login with {provider}': 'ตั้งค่าการเข้าสู่ระบบโซเชียลด้วย {provider}',
    'Add authentication to your {framework} application':
      'เพิ่มการยืนยันตัวตนให้กับแอป {framework} ของคุณ',
    'Set up email verification with {provider}': 'ตั้งค่าการยืนยันอีเมลด้วย {provider}',
    'Set up SMS verification with {provider}': 'ตั้งค่าการยืนยัน SMS ด้วย {provider}',
    'Set up Single Sign-On with {provider}': 'ตั้งค่า Single Sign-On (SSO) ด้วย {provider}',
  },
});
