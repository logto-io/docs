...
var getFonts = function () { return __awaiter(void 0, void 0, void 0, function () {
    var fonts;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Promise.all(fontsMetadata.map(function (_a) { return __awaiter(void 0, void 0, void 0, function () {
                    var font;
                    var filename = _a.filename, rest = __rest(_a, ["filename"]);
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, promises_1.default.readFile(node_path_1.default.join(__dirname, filename))];
                            case 1:
                                font = _b.sent();
                                return [2 /*return*/, __assign(__assign({}, rest), { data: font })];
                        }
                    });
                }); }))];
            case 1:
